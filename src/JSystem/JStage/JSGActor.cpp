...
s32 JStage::TActor::JSGFGetType() const { return 2; }
...
s32 JStage::TActor::JSGGetShape() const { return -1; }

void JStage::TActor::JSGSetShape(u32) { }

s32 JStage::TActor::JSGGetAnimation() const { return -1; }

void JStage::TActor::JSGSetAnimation(u32) { }

f32 JStage::TActor::JSGGetAnimationFrame() const { return 0.0f; }

void JStage::TActor::JSGSetAnimationFrame(f32) { }

f32 JStage::TActor::JSGGetAnimationFrameMax() const { return 0.0f; }