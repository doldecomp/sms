...
template <typename T> void *JSUConvertOffsetToPtr(const void *ptr, const void *offset)
{
	if (offset == NULL) {
		return NULL; 
	}
...
template void *JSUConvertOffsetToPtr<ResNTAB>(const void *ptr, const void *offset);
