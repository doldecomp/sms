...
{
	if (param_1 & 0x8) {
		param_2->unk4 = unk10->getCurrentFrameBuffer();
		param_2->unk8 = unk10->getRenderMode();
		...
		param_2->unkF0 = unk10->getFBClamp();
		param_2->unkF4 = unk10->getClearColor();
		param_2->unkF8 = unk10->getClearZ();
	}
}
