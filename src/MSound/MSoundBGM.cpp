...
void MSBgm::setTrackVolume(u8 param1, f32 param2, u32 param3, u8 param4)
{
	...
	if ((track)
		...
		// Using JAISound::setVolume  instead causes an  Static Error. Even
		// though that is in the Decompiled Ghidra Code. Function should be
		// something like JAISound::setVolume(param2,param3,param4); But due to
		// a "a nonstatic member reference must be relative to a specific
		// object" error with JAISound I can't
