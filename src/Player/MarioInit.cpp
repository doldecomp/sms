...
void TMario::setGamePad(TMarioGamePad* pad) { gamePad = pad; }
...
TMario::TMario()
    : TTakeActor("HitActor")
    , bodyAngleParamsFree("/Mario/BodyAngleFree.prm")
    , bodyAngleParamsWaterGun("/Mario/BodyAngleWaterGun.prm")
    , attackParamsFencePunch("/Mario/AttackFencePunch.prm")
    , attackParamsKickRoof("/Mario/AttackKickRoof.prm")
    , pullParamsBGBeak("/Mario/PullParamBGBeak.prm")
    , pullParamsBGTentacle("/Mario/PullParamBGTentacle.prm")
    , pullParamsBGFireWanWanBossTail("/Mario/PullParamBGFireWanWanBossTail.prm")
    , pullParamsFireWanWanTail("/Mario/PullParamFireWanWanTail.prm")
    , surfingParamsWaterRed("/Mario/SurfingWaterRed.prm")
    , surfingParamsGroundRed("/Mario/SurfingGroundRed.prm")
    , surfingParamsWaterYellow("/Mario/SurfingWaterYellow.prm")
    , surfingParamsGroundYellow("/Mario/SurfingGroundYellow.prm")
    , surfingParamsWaterGreen("/Mario/SurfingWaterGreen.prm")
    , surfingParamsGroundGreen("/Mario/SurfingGroundGreen.prm")
    , hoverParams("/Mario/HHover.prm")
    , divingParams("/Mario/Diving.prm")
    , slipParamsNormal("/Mario/SlipParamNormal.prm")
    , slipParamsOil("/Mario/SlipParamOil.prm")
    , slipParamsAll("/Mario/SlipParamAll.prm")
    , slipParamsAllSlider("/Mario/SlipParamAll_Slider.prm")
    , slipParams45("/Mario/SlipParam45.prm")
    , slipParamsWaterSlope("/Mario/SlipParamWaterSlope.prm")
    , slipParamsWaterGround("/Mario/SlipParamWaterGround.prm")
    , slipParamsYoshi("/Mario/SlipParamYoshi.prm")
    , upperBodyParams("/Mario/UpperBody.prm")
    , dmgParamsEnemyCommon("/Mario/DmgEnemyCommon.prm")
    , dmgParamsHamakuri("/Mario/DmgHamakuri.prm")
    , dmgParamsNamekuri("/Mario/DmgNamekuri.prm")
    , dmgParamsHinokuri("/Mario/DmgHinokuri.prm")
    , dmgParamsFire("/Mario/DmgFire.prm")
    , dmgParamsBGTentacle("/Mario/DmgBGTentacle.prm")
    , dmgParamsBossEel("/Mario/DmgBossEel.prm")
    , dmgParamsHanachanBoss("/Mario/DmgHanachanBoss.prm")
    , dmgParamsPoihana("/Mario/DmgPoihana.prm")
    , dmgParamsKiller("/Mario/DmgKiller.prm")
    , dmgParamsLampTrapIron("/Mario/DmgLampTrapIron.prm")
    , dmgParamsLampTrapSpike("/Mario/DmgLampTrapSpike.prm")
    , dmgParamsEnemyMario("/Mario/DmgEnemyMario.prm")
    , dmgParamsCannotBreath("/Mario/DmgCannotBreath.prm")
    , dmgParamsGraffitoFire("/Mario/DmgGraffitoFire.prm")
    , dmgParamsGraffitoPoison("/Mario/DmgGraffitoPoison.prm")
    , dmgParamsGraffitoElec("/Mario/DmgGraffitoElec.prm")
    , dmgParamsGraffitoLava("/Mario/DmgGraffitoLava.prm")
    , dmgParamsWaterSurface("/Mario/DmgGraffitoWaterSurface.prm")
    , dmgMapParams0("/Mario/DmgMapCode0.prm")
    , dmgMapParams1("/Mario/DmgMapCode1.prm")
    , dmgMapParams2("/Mario/DmgMapCode2.prm")
    , dmgMapParams3("/Mario/DmgMapCode3.prm")
    , dmgMapParams4("/Mario/DmgMapCode4.prm")
    , dmgMapParams5("/Mario/DmgMapCode5.prm")
    , dmgMapParams6("/Mario/DmgMapCode6.prm")
    , dmgMapParams7("/Mario/DmgMapCode7.prm")
    , dmgMapParams8("/Mario/DmgMapCode8.prm")
    , dmgMapParams9("/Mario/DmgMapCode9.prm")
    , optionParams("/Mario/Option.prm")
{
}
