...
static void __GXVerifCopy(void* dest, u8 clear)
{
	...
	ASSERTMSGLINE(0x576, clmpB || y0 + dy <= 528,
...
// TODO: match
u16 GXGetNumXfbLines(float, u16) { return 0; }

float GXGetYScaleFactor(u16, u16) { return 0; }
