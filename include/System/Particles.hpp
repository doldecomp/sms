...
enum E_SMS_EFFECT_ONETIME_NORMAL /* 0 */ {
	...
	PARTICLE_MS_M_WATRUN_B       = 0x35,
	PARTICLE_MS_M_WATRUN_C       = 0x36,
	...
	MAP_MAP_MS_OBJUP_TOUDAI_A           = 0x67,
	MAP_MAP_MS_OBJUP_HOTEL_A            = 0x68,
	MAP_MAP_MS_MARE_OBJUP_A             = 0x69,
	MAPOBJ_SANDSTEAM                    = 0x6A,
	PARTICLE_MS_EX_CUBE_DISA            = 0x6D,
	MAP_MAP_MS_M_FILEBLOCK              = 0x6E,
	MAP_POLLUTION_MS_THUNDER_S          = 0x6F,
	...
	COLUMSAND_JPA_MS_BOHA_CRASH_A       = 0x7E,
	PARTICLE_MS_DEADNAMEKLI_N           = 0x83,
	PARTICLE_MS_DEADNAMEKLI_O           = 0x84,
	COLUMWATER_JPA_MS_ENEHAMON_A        = 0x89,
	COLUMWATER_JPA_MS_ENEHAMON_B        = 0x8A,
	PARTICLE_MS_MOE_FIRE_OFF            = 0x8B,
	BGESO_JPA_MS_BOGE_ATTACK_A          = 0x8C,
	BGESO_JPA_MS_BOGE_ATTACK_B          = 0x8D,
	BGESO_JPA_MS_BOGE_ATTACK_C          = 0x8E,
	BGESO_JPA_MS_BOGE_ATTACK_D          = 0x8F,
	BGESO_JPA_MS_BOGE_CANON_A           = 0x93,
	BGESO_JPA_MS_BOGE_CANON_B           = 0x94,
	BGESO_JPA_MS_BOGE_HIT_A             = 0x97,
	BGESO_JPA_MS_BOGE_HIT_B             = 0x98,
	BGESO_JPA_MS_BOGE_HIT_C             = 0x99,
	BGESO_JPA_MS_BOGE_HITDOWN           = 0x9A,
	BGESO_JPA_MS_BOGE_JUMP              = 0x9B,
	BGESO_JPA_MS_BOGE_KIZETSU           = 0x9C,
	BGESO_JPA_MS_BOGE_KIZETSU_R         = 0x9D,
	BGESO_JPA_MS_BOGE_ODANHIT_A         = 0x9E,
	BGESO_JPA_MS_BOGE_ODANHIT_B         = 0x9F,
	BGESO_JPA_MS_BOGE_OSEN              = 0xA0,
	PARTICLE_MS_POPO_BOMB_A             = 0xA1,
	PARTICLE_MS_POPO_BOMB_B             = 0xA2,
	GATEKEEPER_JPA_MS_GKPA_DEAD         = 0xA7,
	GATEKEEPER_JPA_MS_GKPA_DEADSMOKE    = 0xA8,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_BLUR1  = 0xA9,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_DOWN   = 0xAA,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_SWING1 = 0xAB,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_SWING2 = 0xAC,
	PARTICLE_MS_SMB_KAFUN_OW            = 0xB2,
	PARTICLE_MS_SMB_KAFUN_OA            = 0xB3,
	PARTICLE_MS_SMB_AP_ROCK             = 0xB6,
	PARTICLE_MS_SMB_AP_SMOKE            = 0xB7,
	PARTICLE_MS_SMB_HD_ROCK             = 0xB8,
	PARTICLE_MS_SMB_HD_SMOKE            = 0xB9,
	PARTICLE_MS_GESO_OSENHIT_A          = 0xBC,
	PARTICLE_MS_GESO_OSENHIT_B          = 0xBD,
	PARTICLE_MS_POI_DEAD                = 0xC0,
	EXPLOSION_JPA_MS_BOMB_SMOKE         = 0xC4,
	EXPLOSION_JPA_MS_BOMB_BOMB          = 0xC5,
	EXPLOSION_JPA_MS_BOMB_HAHEN         = 0xC6,
	PARTICLE_MS_CHO_ASE                 = 0xC9,
	PARTICLE_MS_TAMA_FLOWER             = 0xCC,
	PARTICLE_MS_TLS_CHANGE              = 0xCD,
	PARTICLE_MS_GENE_DEAD               = 0xD0,
	BOSSEEL_JPA_MS_MEO_AWA_TOOTH        = 0xD3,
	BOSSEEL_JPA_MS_MEO_AWA_MOUTH        = 0xD4,
	BOSSEELTEARS_MS_MEO_TEAR_BOMB       = 0xD5,
	BOSSEELTEARS_MS_MEO_TEAR_AWAGET     = 0xD6,
	PARTICLE_MS_ENM_WALLHIT             = 0xE2,
	PARTICLE_MS_ENM_WALLHIT_O           = 0xE3,
	PARTICLE_MS_ENM_DISAP_A             = 0xE4,
	PARTICLE_MS_ENM_DISAP_A_W           = 0xE5,
	PARTICLE_MS_ENM_DISAP_B             = 0xE6,
	PARTICLE_MS_ENM_WATHIT              = 0xE7,
	SCENE_KAGEMARIO_JPA_MS_KGM_CHANGE   = 0xED,
	SCENE_MANTA_JPA_MS_MAN_DEAD         = 0xF8,
	SCENE_MANTA_JPA_MS_MAN_DIV1         = 0xF9,
	SCENE_MANTA_JPA_MS_MAN_DIV2         = 0xFA,
	SCENE_MANTA_JPA_MS_MAN_DIV3         = 0xFB,
	SCENE_MANTA_JPA_MS_MAN_DIV4         = 0xFC,
};
...
enum E_SMS_EFFECT_LOOP_NORMAL /* 1 */ {
	...
	PARTICLE_MS_M_HAMON_A                 = 0x107,
	PARTICLE_MS_M_HAMON_C                 = 0x108,
	PARTICLE_MS_M_HAMON_D                 = 0x109,
	PARTICLE_MS_M_MZBHAMON_A              = 0x10A,
	PARTICLE_MS_M_MZBHAMON_C              = 0x10B,
	...
	PARTICLE_MS_SHINE_PROMI               = 0x127,
	PARTICLE_MS_SHINE_SENKO               = 0x128,
	PARTICLE_MS_SHINE_KIRA                = 0x129,
	PARTICLE_MS_SHINE_BOW                 = 0x12A,
	MAP_POLLUTION_MS_M_TOKEOS             = 0x12B,
	PARTICLE_MS_TEPPANFIRE_A              = 0x12C,
	PARTICLE_MS_GENE_HIT                  = 0x12D,
	...
	GATEKEEPER_JPA_MS_GKPA_YODARE_S       = 0x141,
	GATEKEEPER_JPA_MS_GKPA_YODARE_L       = 0x142,
	OTHERS_MARINESNOW_MS_MARE_MARINSNOW   = 0x14B,
	MAP_MAP_MS_MONTE_YUGE                 = 0x156,
	MAPOBJ_ICEBLOCKA                      = 0x157,
	MAPOBJ_ICEBLOCKB                      = 0x158,
	MAP_MAP_MS_MARE_BLOCKUP               = 0x15B,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_WATHIT   = 0x15D,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_WATHIT_W = 0x15E,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_ASE      = 0x15F,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_BLUR2    = 0x160,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_JITA     = 0x161,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_TR_ROCK  = 0x162,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_TR_SMOKE = 0x163,
	SCENE_BOSSPAKKUN_JPA_MS_BOPA_TR_WEED  = 0x164,
	PARTICLE_MS_GESO_KISEKI               = 0x165,
	...
	BOSSEEL_JPA_MS_MEO_EYEBLUR            = 0x192,
	BOSSEEL_JPA_MS_MEO_SPIN_SMOKE         = 0x193,
	BOSSEEL_JPA_MS_MEO_SPIN_SMOKE_L       = 0x194,
	BOSSEEL_JPA_MS_MEO_SPIN_AWA           = 0x195,
	BOSSEEL_JPA_MS_MEO_SPIN_AWA_L         = 0x196,
	BOSSEEL_JPA_MS_MEO_AWA_BODY           = 0x197,
	BOSSEEL_JPA_MS_MEO_AWA_DEAD           = 0x198,
	BOSSEEL_JPA_MS_MEO_SUIKOMI            = 0x199,
	BOSSEEL_JPA_MS_MEO_TOOTH_WASH         = 0x19A,
	BOSSEEL_JPA_MS_MEO_TOOTH_KIRA         = 0x19B,
	BOSSEEL_JPA_MS_MEO_TOOTH_ALWAYS       = 0x19C,
	BOSSEELTEARS_MS_MEO_TEAR_AWA          = 0x19D,
	SCENE_KAGEMARIO_JPA_MS_KGM_MOVE_A     = 0x1AA,
	SCENE_KAGEMARIO_JPA_MS_KGM_MOVE_B     = 0x1AB,
	PARTICLE_MS_MAP_FIRE_A                = 0x1C4,
	PARTICLE_MS_MAP_FIRE_B                = 0x1C5,
	SCENE_MAPOBJ_MS_OBJ_HAMON_A           = 0x1C6,
	SCENE_MANTA_JPA_MS_MAN_HIT1_A         = 0x1C7,
	SCENE_MANTA_JPA_MS_MAN_HIT1_B         = 0x1C8,
	SCENE_MANTA_JPA_MS_MAN_HIT2_A         = 0x1C9,
	SCENE_MANTA_JPA_MS_MAN_HIT2_B         = 0x1CA,
	SCENE_MANTA_JPA_MS_MAN_HIT3_A1        = 0x1CB,
	SCENE_MANTA_JPA_MS_MAN_HIT3_A2        = 0x1CC,
	SCENE_MANTA_JPA_MS_MAN_HIT3_B         = 0x1CD,
	SCENE_MANTA_JPA_MS_MAN_HIT4_A1        = 0x1CE,
	SCENE_MANTA_JPA_MS_MAN_HIT4_A2        = 0x1CF,
	SCENE_MANTA_JPA_MS_MAN_HIT4_B         = 0x1D0,
	PARTICLE_MS_MPK_FIRE_A                = 0x1D1,
	PARTICLE_MS_MPK_FIRE_B                = 0x1D2,
};

// TODO: what is "type 2"?
enum /* 2 */
{
	PARTICLE_MS_M_TOBIKOMI_C        = 0x1D4,
	PARTICLE_MS_M_TOBIKOMI_S_C      = 0x1D5,
	PARTICLE_MS_MARI_RAKUBALL       = 0x1D8,
	PARTICLE_MS_MARI_RAKUHAMON      = 0x1D9,
	MAP_POLLUTION_MS_NEWFIRE_B      = 0x1DC,
	PARTICLE_MS_RAKU_INDAWA         = 0x1DA,
	PARTICLE_MS_RAKU_KIE            = 0x1DB,
	GATEKEEPER_JPA_MS_GKPA_KEMURI   = 0x1DF,
	GATEKEEPER_JPA_MS_GKPA_KEMURI_W = 0x1E0,
	MAP_MAP_MS_OBJUP_SLOPE_B        = 0x1E1,
	MAP_MAP_MS_OBJUP_MANIYA_B       = 0x1E2,
	MAP_MAP_MS_OBJUP_TOUDAI_B       = 0x1E3,
	MAP_MAP_MS_OBJUP_HOTEL_B        = 0x1E4,
	MAP_MAP_MS_MARE_OBJUP_B         = 0x1E5,
};

enum E_SMS_EFFECT_LOOP_INDIRECT /* 3 */ {
	PARTICLE_MS_M_HAMON_B        = 0x1E8,
	PARTICLE_MS_M_MZBHAMON_B     = 0x1E9,
	PARTICLE_MS_TEPPANFIRE_B     = 0x1F1,
	FIREWANWAN_JPA_MS_CAN_YUGAMI = 0x1F4,
	PARTICLE_MS_MAP_FIRE_C       = 0x1F5,
	SCENE_MAPOBJ_MS_OBJ_HAMON_B  = 0x1F6,
	PARTICLE_MS_NPC_HAMON_B      = 0x1F7,
	PARTICLE_MS_MPK_FIRE_C       = 0x1F8,
