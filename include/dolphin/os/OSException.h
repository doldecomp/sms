...
typedef enum {
	...
	OS_EXCEPTION_DSI = 0x2,
	OS_EXCEPTION_ISI = 0x3,
	OS_EXCEPTION_EXTERNAL_INTERRUPT,
	OS_EXCEPTION_ALIGNMENT = 0x5,
	OS_EXCEPTION_PROGRAM   = 0x6,
	...
	OS_EXCEPTION_MEMORY_PROTECTION = 0xf,
	// TODO: very fishy but matches?
	OS_EXCEPTION_MAX = OS_EXCEPTION_MEMORY_PROTECTION,
} OSException;
