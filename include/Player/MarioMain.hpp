...
public:
	...
	bool isRoofing() const
	{
		if ((mStatus & STATUS_TYPE_AND_ID_MASK)
		    ...
		    && (mStatus & STATUS_TYPE_AND_ID_MASK)
		           <= (STATUS_MOVE_ROOF & STATUS_TYPE_AND_ID_MASK))
			return true;
	...
	{
		if ((mStatus & STATUS_TYPE_AND_ID_MASK)
		        >= (STATUS_ASCEND & STATUS_TYPE_AND_ID_MASK)
		    && (STATUS_WIRE_WAIT & STATUS_TYPE_AND_ID_MASK)
		           >= (mStatus & STATUS_TYPE_AND_ID_MASK))
			return true;
...
public:
	...
	enum {
		...
		STATUS_FLAG_UNK8000000  = 0x8000000,
		...
		STATUS_SLIP      = STATUS_TYPE_RUNNING | 0x10,  // 0x50
		...
		STATUS_CATCH = STATUS_FLAG_UNK800000 | STATUS_FLAG_RUNNING
		               | STATUS_TYPE_RUNNING | 0x16, // 0x800456
		...
		STATUS_FORCE_JUMP
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x4, // 0x884
		STATUS_WALL_JUMP = STATUS_FLAG_UNK2000000 | STATUS_FLAG_JUMPING
		                   | STATUS_TYPE_JUMPING | 0x6, // 0x2000886
		STATUS_MISS_JUMP = STATUS_FLAG_UNK2000000 | STATUS_FLAG_JUMPING
		                   | STATUS_TYPE_JUMPING | 0x5, // 0x2000885
		STATUS_U_TURN_JUMP
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x7, // 0x887
		STATUS_BROAD_JUMP
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x8, // 0x888
		STATUS_ROTATE_BROAD_JUMP = STATUS_FLAG_UNK2000000 | STATUS_FLAG_JUMPING
		                           | STATUS_TYPE_JUMPING | 0x9, // 0x2000889
		...
		STATUS_ROCKET
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0xB, // 0x88B
		STATUS_LANDING
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0xC, // 0x88C
		STATUS_ROCKET_LANDING
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0xD, // 0x88D
		STATUS_SLIP_FALL = STATUS_FLAG_UNK2000000 | STATUS_FLAG_JUMPING
		                   | STATUS_TYPE_JUMPING | 0xE, // 0x200088E
		STATUS_TRAMPLE = STATUS_FLAG_UNK2000000 | STATUS_FLAG_JUMPING
		                 | STATUS_TYPE_JUMPING | 0x10, // 0x2000890
		STATUS_DIVE = STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x11, // 0x891
		STATUS_WIRE_JUMP
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x12, // 0x892
		STATUS_WIRE_ROLL_JUMP
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x13, // 0x893
		STATUS_PULL_JUMP
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x14, // 0x894
		...
		STATUS_CATCH_STOP
		= STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING | 0x26, // 0x8A6
		STATUS_WALL_SLIDE
		...
		STATUS_FIRE_JUMP = STATUS_FLAG_UNK20000 | STATUS_FLAG_JUMPING
		                   | STATUS_TYPE_JUMPING | 0x34, // 0x208B4
		STATUS_FIRE_LAND = STATUS_FLAG_UNK20000 | STATUS_FLAG_JUMPING
		                   | STATUS_TYPE_JUMPING | 0x35, // 0x208B5
		STATUS_LAND_SAFE_DOWN = STATUS_FLAG_UNK20000 | STATUS_FLAG_JUMPING
		                        | STATUS_TYPE_JUMPING | 0x36, // 0x208B6
		STATUS_FIRE_DOWN = STATUS_FLAG_UNK20000 | STATUS_FLAG_JUMPING
		                   | STATUS_TYPE_JUMPING | 0x37, // 0x208B7
		STATUS_THROWN_DOWN = STATUS_FLAG_UNK20000 | STATUS_FLAG_JUMPING
		                     | STATUS_TYPE_JUMPING | 0x38, // 0x208B8
		STATUS_FALL_DEAD = STATUS_FLAG_UNK20000 | STATUS_FLAG_JUMPING
		                   | STATUS_TYPE_JUMPING | 0x39, // 0x208B9
		STATUS_WIRE_HANG_LAND_SAFE_DOWN
		= STATUS_FLAG_UNK20000 | STATUS_FLAG_JUMPING | STATUS_TYPE_JUMPING
		  | 0x3A, // 0x208BA
		...
		STATUS_SQUAT_STANDUP   = 0xC008222,
		STATUS_THROWN_END      = 0xC000223,
		...
		STATUS_BAR_WAIT = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK8000000
		                  | STATUS_FLAG_UNK100000 | STATUS_FLAG_UNK200
		                  | STATUS_TYPE_SPECIAL | 0x0, // 0x18100340
		STATUS_BAR_HANG = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK100000
		                  | STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL
		                  | 0x1, // 0x10100341
		STATUS_BAR_CLIMB = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK100000
		                   | STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL
		                   | 0x3, // 0x10100343
		STATUS_KICK_ROOF_ROLL_UP = STATUS_FLAG_UNK200000 | STATUS_FLAG_UNK200
		                           | STATUS_TYPE_SPECIAL | 0x5, // 0x200345
		STATUS_KICK_ROOF_ROLL_DOWN = STATUS_FLAG_UNK200000 | STATUS_FLAG_UNK200
		                             | STATUS_TYPE_SPECIAL | 0x6, // 0x200346
		STATUS_KICK_ROOF = STATUS_FLAG_UNK200000 | STATUS_FLAG_UNK200
		                   | STATUS_TYPE_SPECIAL | 0x7, // 0x200347
		STATUS_HANG_ROOF = STATUS_FLAG_UNK8000000 | STATUS_FLAG_UNK200000
		                   | STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL
		                   | 0x8, // 0x8200348
		STATUS_WAIT_ROOF = STATUS_FLAG_UNK200000 | STATUS_FLAG_UNK200
		                   | STATUS_TYPE_SPECIAL | 0x9, // 0x200349
		STATUS_MOVE_ROOF = STATUS_FLAG_UNK200000 | STATUS_FLAG_RUNNING
		                   | STATUS_TYPE_SPECIAL | 0xA, // 0x20054A
		STATUS_HANGING = STATUS_FLAG_UNK20000000 | STATUS_FLAG_UNK10000000
		                 | STATUS_FLAG_UNK8000000 | STATUS_FLAG_UNK200
		                 | STATUS_TYPE_SPECIAL | 0xB, // 0x3800034B
		STATUS_ASCEND = STATUS_FLAG_UNK20000000 | STATUS_FLAG_UNK10000000
		                | STATUS_FLAG_RUNNING | STATUS_TYPE_SPECIAL
		                | 0xC, // 0x3000054C
		STATUS_DESCEND = STATUS_FLAG_UNK20000000 | STATUS_FLAG_UNK10000000
		                 | STATUS_FLAG_RUNNING | STATUS_TYPE_SPECIAL
		                 | 0xE, // 0x3000054E
		STATUS_HANG_JUMPING = STATUS_FLAG_UNK20000000 | STATUS_FLAG_UNK10000000
		                      | STATUS_FLAG_RUNNING | STATUS_TYPE_SPECIAL
		                      | 0xF, // 0x3000054F
		STATUS_WIRE_WAIT
		= STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL | 0x10, // 0x350
		STATUS_WIRE_S_WAIT
		= STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL | 0x11, // 0x351
		STATUS_WIRE_WAIT_TO_S_WAIT_L
		= STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL | 0x12, // 0x352
		STATUS_WIRE_WAIT_TO_S_WAIT_R
		= STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL | 0x13, // 0x353
		STATUS_WIRE_WAIT_TO_HANG = STATUS_FLAG_UNK10000000 | STATUS_FLAG_RUNNING
		                           | STATUS_TYPE_SPECIAL | 0x14, // 0x10000554
		STATUS_WIRE_S_WAIT_TO_HANG = STATUS_FLAG_UNK10000000
		                             | STATUS_FLAG_RUNNING | STATUS_TYPE_SPECIAL
		                             | 0x15, // 0x10000555
		STATUS_WIRE_RETURN = STATUS_FLAG_UNK10000000 | STATUS_FLAG_RUNNING
		                     | STATUS_TYPE_SPECIAL | 0x16, // 0x10000556
		STATUS_WIRE_HANGING = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK200
		                      | STATUS_TYPE_SPECIAL | 0x17, // 0x10000357
		STATUS_WIRE_ROLLING = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK200
		                      | STATUS_TYPE_SPECIAL | 0x18, // 0x10000358
		STATUS_WIRE_S_WAIT_TO_WAIT_R
		= STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL | 0x1B, // 0x35B
		STATUS_WIRE_S_WAIT_TO_WAIT_L
		= STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL | 0x1C, // 0x35C
		STATUS_PULLING
		...
		STATUS_FENCE_PUNCH = STATUS_FLAG_UNK20000000 | STATUS_FLAG_UNK10000000
		                     | STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL
		                     | 0x2A, // 0x3000036A
		STATUS_FENCE_CATCH = STATUS_FLAG_UNK20000000 | STATUS_FLAG_UNK10000000
		                     | STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL
		                     | 0x2B, // 0x3000036B
		STATUS_FENCE_JUMP_CATCH = STATUS_FLAG_UNK20000000
		                          | STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK200
		                          | STATUS_TYPE_SPECIAL | 0x2C, // 0x3000036C
		STATUS_TAKEN = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK20000
		               | STATUS_FLAG_UNK200 | STATUS_TYPE_SPECIAL
		               | 0x30, // 0x10020370

		// Actions
		STATUS_TAKE = STATUS_FLAG_UNK200 | STATUS_TYPE_ACTION | 0x3, // 0x383
		STATUS_TAKE_POSE
		= STATUS_FLAG_UNK200 | STATUS_TYPE_ACTION | 0x4, // 0x384
		STATUS_CATCH_LOST
		= STATUS_FLAG_UNK200 | STATUS_TYPE_ACTION | 0x6, // 0x386
		STATUS_PUTTING = STATUS_FLAG_UNK80000000 | STATUS_FLAG_UNK200
		                 | STATUS_TYPE_ACTION | 0x7, // 0x80000387
		STATUS_PITCHING = STATUS_FLAG_UNK80000000 | STATUS_FLAG_RUNNING
		                  | STATUS_TYPE_ACTION | 0x8, // 0x80000588

		// Autodemo
		STATUS_WIN_DEMO
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x02,
		STATUS_READ_BILLBOARD = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK1000
		                        | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x08,
		STATUS_BOTTLE_IN
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x10,
		STATUS_ELEC_DOWN = STATUS_FLAG_UNK20000 | STATUS_FLAG_UNK1000
		                   | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x13,
		STATUS_DOOR_OPEN_R
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x20,
		STATUS_DOOR_OPEN_L
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x21,
		STATUS_SINK_LOSER = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK1000
		                    | STATUS_TYPE_DEMO | 0x23,
		STATUS_DOWN_LOSER = STATUS_FLAG_UNK10000000 | STATUS_FLAG_UNK1000
		                    | STATUS_FLAG_JUMPING | STATUS_TYPE_DEMO | 0x2A,
		STATUS_WARP_OUT
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x37,
		STATUS_WARP_IN
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x36,
		STATUS_ELECTRIC_DAMAGE
		= STATUS_FLAG_UNK20000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x38,
		STATUS_FOOT_DOWN
		= STATUS_FLAG_UNK20000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x3C,
		STATUS_NOMOTION
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x3E,
		STATUS_DISAPPEAR
		= STATUS_FLAG_UNK1000 | STATUS_FLAG_UNK200 | STATUS_TYPE_DEMO | 0x3F,
