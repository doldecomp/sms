...
public:
	...
	bool isRoofing() const
	{
		if ((mStatus & MARIO_STATUS_TYPE_AND_ID_MASK)
		        >= (MARIO_STATUS_KICK_ROOF & MARIO_STATUS_TYPE_AND_ID_MASK)
		    && (mStatus & MARIO_STATUS_TYPE_AND_ID_MASK)
		           <= (MARIO_STATUS_MOVE_ROOF & MARIO_STATUS_TYPE_AND_ID_MASK))
			return true;
	...
	{
		if ((mStatus & MARIO_STATUS_TYPE_AND_ID_MASK)
		        >= (MARIO_STATUS_FENCE_MOVE & MARIO_STATUS_TYPE_AND_ID_MASK)
		    && (MARIO_STATUS_FENCE_JUMP_CATCH & MARIO_STATUS_TYPE_AND_ID_MASK)
		           >= (mStatus & MARIO_STATUS_TYPE_AND_ID_MASK))
			return true;
	...
	const JGeometry::TVec3<f32>& Position() const { return unk29C; }
