...
struct J3DMaterialBlock_v21 : public JUTDataBlockHeader {
	...
	/* 0x18 */ PTR32(void) mpCullMode;
	/* 0x1C */ PTR32(void) mpMatColor;
	/* 0x20 */ PTR32(void) mpColorChanNum;
	/* 0x24 */ PTR32(void) mpColorChanInfo;
	/* 0x28 */ PTR32(void) mpTexGenNum;
	/* 0x2C */ PTR32(void) mpTexCoordInfo;
	/* 0x30 */ PTR32(void) mpTexCoord2Info;
	/* 0x34 */ PTR32(void) mpTexMtxInfo;
	/* 0x38 */ PTR32(void) field_0x44;
	/* 0x3C */ PTR32(void) mpTexNo;
	/* 0x40 */ PTR32(void) mpTevOrderInfo;
	/* 0x44 */ PTR32(void) mpTevColor;
	/* 0x48 */ PTR32(void) mpTevKColor;
	/* 0x4C */ PTR32(void) mpTevStageNum;
	/* 0x50 */ PTR32(void) mpTevStageInfo;
	/* 0x54 */ PTR32(void) mpTevSwapModeInfo;
	/* 0x58 */ PTR32(void) mpTevSwapModeTableInfo;
