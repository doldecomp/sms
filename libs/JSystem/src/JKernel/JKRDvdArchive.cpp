...
bool JKRDvdArchive::open(s32 entryNum)
{
	...
	mDirectories = (SDIDirEntry*)((intptr_t)&mArcInfoBlock->num_nodes
	                              + mArcInfoBlock->node_offset);
	mFileEntries = (SDIFileEntry*)((intptr_t)&mArcInfoBlock->num_nodes
	                               + mArcInfoBlock->file_entry_offset);
	mStrTable    = (char*)((intptr_t)&mArcInfoBlock->num_nodes
