...
- Local changes have added 4,352 exactly matching code bytes and 42 matching functions/helpers across nine batches; 72 verified game objects are linked from source.
