...
- Local changes have added 19,356 exactly matching code bytes and 114 matching functions/helpers across twenty-one batches; 73 verified game objects are linked from source.
