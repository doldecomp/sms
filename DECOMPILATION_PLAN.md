...
- Local changes have added 16,992 exactly matching code bytes and 100 matching functions/helpers across nineteen batches; 73 verified game objects are linked from source.
