...
- Local changes have added 2,668 exactly matching code bytes and 32 matching functions/helpers across seven batches; 72 verified game objects are linked from source.
