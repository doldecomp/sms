...
- Local changes have added 11,640 exactly matching code bytes and 64 matching functions/helpers across sixteen batches; 73 verified game objects are linked from source.
