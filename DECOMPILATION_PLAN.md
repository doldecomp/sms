...
- Local changes have added 4,164 exactly matching code bytes and 41 matching functions/helpers across eight batches; 72 verified game objects are linked from source.
