...
- Local changes have added 16,856 exactly matching code bytes and 99 matching functions/helpers across eighteen batches; 73 verified game objects are linked from source.
