...
/* 8008ADF4 00087D34  80 42 00 8C */	lwz r2, lbl_804134EC-_SDA2_BASE_(r2)
...
/* 8008AE14 00087D54  B0 62 00 00 */	sth r3, $$24090-_SDA2_BASE_(r2)
...
/* 8008AE2C 00087D6C  90 62 04 2C */	stw r3, $$23234-_SDA2_BASE_(r2)
...
/* 8008AE3C 00087D7C  80 62 04 2C */	lwz r3, $$23234-_SDA2_BASE_(r2)
...
/* 8008AE4C 00087D8C  80 42 00 A0 */	lwz r2, $$23488-_SDA2_BASE_(r2)
/* 8008AE50 00087D90  88 42 00 00 */	lbz r2, $$24090-_SDA2_BASE_(r2)
...
/* 8008AE64 00087DA4  88 42 00 0C */	lbz r2, $$24252-_SDA2_BASE_(r2)
...
/* 8008AE7C 00087DBC  98 62 00 9C */	stb r3, $$23328-_SDA2_BASE_(r2)
...
/* 8008AE8C 00087DCC  80 62 00 88 */	lwz r3, $$26100-_SDA2_BASE_(r2)
/* 8008AE90 00087DD0  7C 6F F1 20 */	mtcrf 0xff, r3
/* 8008AE94 00087DD4  80 62 00 0C */	lwz r3, $$24252-_SDA2_BASE_(r2)
/* 8008AE98 00087DD8  80 42 00 08 */	lwz r2, $$24251-_SDA2_BASE_(r2)
...
/* 8008AEC8 00087E08  90 02 00 00 */	stw r0, $$24090-_SDA2_BASE_(r2)
/* 8008AECC 00087E0C  90 22 00 04 */	stw r1, $$24250-_SDA2_BASE_(r2)
/* 8008AED0 00087E10  7C 11 42 A6 */	mfspr r0, 0x111
/* 8008AED4 00087E14  90 02 00 08 */	stw r0, $$24251-_SDA2_BASE_(r2)
/* 8008AED8 00087E18  B0 62 02 F8 */	sth r3, $$23356-_SDA2_BASE_(r2)
/* 8008AEDC 00087E1C  B0 62 02 FA */	sth r3, lbl_8041375A-_SDA2_BASE_(r2)
/* 8008AEE0 00087E20  7C 12 42 A6 */	mfspr r0, 0x112
/* 8008AEE4 00087E24  90 02 00 0C */	stw r0, $$24252-_SDA2_BASE_(r2)
/* 8008AEE8 00087E28  BC 82 00 10 */	stmw r4, lbl_80413470-_SDA2_BASE_(r2)
...
/* 8008AF00 00087E40  BF 62 00 80 */	stmw r27, $$26099-_SDA2_BASE_(r2)
...
/* 8008AF14 00087E54  98 62 00 0C */	stb r3, $$24252-_SDA2_BASE_(r2)
/* 8008AF18 00087E58  3C 40 80 3E */	lis r2, gTRKState@h
/* 8008AF1C 00087E5C  60 42 AB 88 */	ori r2, r2, gTRKState@l
/* 8008AF20 00087E60  80 02 00 8C */	lwz r0, lbl_804134EC-_SDA2_BASE_(r2)
/* 8008AF24 00087E64  7C 00 04 AC */	sync 0
/* 8008AF28 00087E68  7C 00 01 24 */	mtmsr r0
/* 8008AF2C 00087E6C  7C 00 04 AC */	sync 0
/* 8008AF30 00087E70  80 02 00 80 */	lwz r0, $$26099-_SDA2_BASE_(r2)
/* 8008AF34 00087E74  7C 08 03 A6 */	mtlr r0
/* 8008AF38 00087E78  80 02 00 84 */	lwz r0, lbl_804134E4-_SDA2_BASE_(r2)
/* 8008AF3C 00087E7C  7C 09 03 A6 */	mtctr r0
/* 8008AF40 00087E80  80 02 00 88 */	lwz r0, $$26100-_SDA2_BASE_(r2)
/* 8008AF44 00087E84  7C 01 03 A6 */	mtxer r0
/* 8008AF48 00087E88  80 02 00 94 */	lwz r0, $$23326-_SDA2_BASE_(r2)
/* 8008AF4C 00087E8C  7C 12 03 A6 */	mtdsisr r0
/* 8008AF50 00087E90  80 02 00 90 */	lwz r0, $$23208-_SDA2_BASE_(r2)
/* 8008AF54 00087E94  7C 13 03 A6 */	mtdar r0
/* 8008AF58 00087E98  B8 62 00 0C */	lmw r3, $$24252-_SDA2_BASE_(r2)
/* 8008AF5C 00087E9C  80 02 00 00 */	lwz r0, $$24090-_SDA2_BASE_(r2)
/* 8008AF60 00087EA0  80 22 00 04 */	lwz r1, $$24250-_SDA2_BASE_(r2)
/* 8008AF64 00087EA4  80 42 00 08 */	lwz r2, $$24251-_SDA2_BASE_(r2)
...
/* 8008AF74 00087EB4  B0 62 00 08 */	sth r3, $$24251-_SDA2_BASE_(r2)
/* 8008AF78 00087EB8  7C 7A 02 A6 */	mfspr r3, 0x1a
/* 8008AF7C 00087EBC  90 62 00 00 */	stw r3, $$24090-_SDA2_BASE_(r2)
/* 8008AF80 00087EC0  A0 62 00 08 */	lhz r3, $$24251-_SDA2_BASE_(r2)
...
/* 8008AFF0 00087F30  98 62 00 0D */	stb r3, lbl_8041346D-_SDA2_BASE_(r2)
...
/* 8008B110 00088050  80 42 00 A0 */	lwz r2, $$23488-_SDA2_BASE_(r2)
/* 8008B114 00088054  88 42 00 00 */	lbz r2, $$24090-_SDA2_BASE_(r2)
...
/* 8008B12C 0008806C  98 62 00 9C */	stb r3, $$23328-_SDA2_BASE_(r2)
...
/* 8008B140 00088080  98 62 00 0C */	stb r3, $$24252-_SDA2_BASE_(r2)
...
/* 8008B150 00088090  BB 62 00 80 */	lmw r27, $$26099-_SDA2_BASE_(r2)
...
/* 8008B168 000880A8  B8 62 00 0C */	lmw r3, $$24252-_SDA2_BASE_(r2)
/* 8008B16C 000880AC  80 02 00 00 */	lwz r0, $$24090-_SDA2_BASE_(r2)
/* 8008B170 000880B0  80 22 00 04 */	lwz r1, $$24250-_SDA2_BASE_(r2)
/* 8008B174 000880B4  80 42 00 08 */	lwz r2, $$24251-_SDA2_BASE_(r2)
...
/* 8008B184 000880C4  80 02 00 8C */	lwz r0, lbl_804134EC-_SDA2_BASE_(r2)
/* 8008B188 000880C8  7C 00 04 AC */	sync 0
/* 8008B18C 000880CC  7C 00 01 24 */	mtmsr r0
/* 8008B190 000880D0  7C 00 04 AC */	sync 0
/* 8008B194 000880D4  80 02 00 80 */	lwz r0, $$26099-_SDA2_BASE_(r2)
/* 8008B198 000880D8  7C 08 03 A6 */	mtlr r0
/* 8008B19C 000880DC  80 02 00 84 */	lwz r0, lbl_804134E4-_SDA2_BASE_(r2)
/* 8008B1A0 000880E0  7C 09 03 A6 */	mtctr r0
/* 8008B1A4 000880E4  80 02 00 88 */	lwz r0, $$26100-_SDA2_BASE_(r2)
/* 8008B1A8 000880E8  7C 01 03 A6 */	mtxer r0
/* 8008B1AC 000880EC  80 02 00 94 */	lwz r0, $$23326-_SDA2_BASE_(r2)
/* 8008B1B0 000880F0  7C 12 03 A6 */	mtdsisr r0
/* 8008B1B4 000880F4  80 02 00 90 */	lwz r0, $$23208-_SDA2_BASE_(r2)
/* 8008B1B8 000880F8  7C 13 03 A6 */	mtdar r0
/* 8008B1BC 000880FC  B8 62 00 0C */	lmw r3, $$24252-_SDA2_BASE_(r2)
/* 8008B1C0 00088100  80 02 00 00 */	lwz r0, $$24090-_SDA2_BASE_(r2)
/* 8008B1C4 00088104  80 22 00 04 */	lwz r1, $$24250-_SDA2_BASE_(r2)
/* 8008B1C8 00088108  80 42 00 08 */	lwz r2, $$24251-_SDA2_BASE_(r2)
