...
/* 800B5CF8 000B2C38  80 6D 95 E4 */	lwz r3, BarnacleEnabled-_SDA_BASE_(r13)
...
/* 800B5D20 000B2C60  90 0D 95 E0 */	stw r0, Enabled-_SDA_BASE_(r13)
...
/* 800B5D38 000B2C78  90 0D 95 E0 */	stw r0, Enabled-_SDA_BASE_(r13)
/* 800B5D3C 000B2C7C  38 00 00 01 */	li r0, 1
/* 800B5D40 000B2C80  90 6D 95 D8 */	stw r3, Chan-_SDA_BASE_(r13)
/* 800B5D44 000B2C84  38 60 00 00 */	li r3, 0
/* 800B5D48 000B2C88  90 0D 95 DC */	stw r0, Dev-_SDA_BASE_(r13)
lbl_800B5D4C:
...
/* 800B5D7C 000B2CBC  80 AD 95 E0 */	lwz r5, Enabled-_SDA_BASE_(r13)
...
lbl_800B5D94:
/* 800B5D94 000B2CD4  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
/* 800B5D98 000B2CD8  38 A0 00 00 */	li r5, 0
/* 800B5D9C 000B2CDC  80 8D 95 DC */	lwz r4, Dev-_SDA_BASE_(r13)
...
lbl_800B5DF4:
/* 800B5DF4 000B2D34  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
/* 800B5DF8 000B2D38  38 A0 00 03 */	li r5, 3
/* 800B5DFC 000B2D3C  80 8D 95 DC */	lwz r4, Dev-_SDA_BASE_(r13)
...
/* 800B5E1C 000B2D5C  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
/* 800B5E30 000B2D70  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
/* 800B5E34 000B2D74  4B FF EA C9 */	bl EXISync
/* 800B5E38 000B2D78  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
/* 800B5E50 000B2D90  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
/* 800B5E54 000B2D94  4B FF EA A9 */	bl EXISync
/* 800B5E58 000B2D98  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
lbl_800B5E90:
/* 800B5E90 000B2DD0  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
/* 800B5E94 000B2DD4  38 A0 00 03 */	li r5, 3
/* 800B5E98 000B2DD8  80 8D 95 DC */	lwz r4, Dev-_SDA_BASE_(r13)
...
lbl_800B5EB0:
/* 800B5EB0 000B2DF0  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
/* 800B5EC8 000B2E08  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
lbl_800B5EF8:
/* 800B5EF8 000B2E38  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
/* 800B5F10 000B2E50  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
lbl_800B5F34:
/* 800B5F34 000B2E74  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
...
lbl_800B5F44:
/* 800B5F44 000B2E84  80 6D 95 D8 */	lwz r3, Chan-_SDA_BASE_(r13)
