...
/* 801F4BD8 001F1B18  C0 02 D1 28 */	lfs f0, "@2674"@sda21(r2)
...
/* 801F4C4C 001F1B8C  C0 02 D1 2C */	lfs f0, "@2693"@sda21(r2)
...
lbl_801F4C60:
/* 801F4C60 001F1BA0  C0 02 D1 30 */	lfs f0, "@2694"@sda21(r2)
...
/* 801F4C78 001F1BB8  C0 02 D1 34 */	lfs f0, "@2695"@sda21(r2)
/* 801F4C7C 001F1BBC  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 801F4C80 001F1BC0  41 80 00 10 */	blt lbl_801F4C90
/* 801F4C84 001F1BC4  C0 02 D1 38 */	lfs f0, "@2696"@sda21(r2)
...
/* 801F4CF8 001F1C38  C8 22 D1 40 */	lfd f1, "@2708"@sda21(r2)
...
/* 801F4D1C 001F1C5C  3C 60 80 40 */	lis r3, "@2650"@ha
...
/* 801F4D2C 001F1C6C  3B E3 8A 58 */	addi r31, r3, "@2650"@l
/* 801F4D30 001F1C70  88 0D 97 CC */	lbz r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
/* 801F4D34 001F1C74  7C 00 07 75 */	extsb. r0, r0
/* 801F4D38 001F1C78  40 82 00 28 */	bne lbl_801F4D60
/* 801F4D3C 001F1C7C  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
/* 801F4D40 001F1C80  4B E1 9E F5 */	bl initiate__10JSUPtrListFv
/* 801F4D44 001F1C84  3C 60 80 0E */	lis r3, "__dt__15JSUList<5MSBgm>Fv"@ha
/* 801F4D48 001F1C88  38 83 6A 44 */	addi r4, r3, "__dt__15JSUList<5MSBgm>Fv"@l
/* 801F4D4C 001F1C8C  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
...
/* 801F4D5C 001F1C9C  98 0D 97 CC */	stb r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
lbl_801F4D60:
/* 801F4D60 001F1CA0  88 0D 97 CD */	lbz r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
/* 801F4D64 001F1CA4  7C 00 07 75 */	extsb. r0, r0
/* 801F4D68 001F1CA8  40 82 00 28 */	bne lbl_801F4D90
/* 801F4D6C 001F1CAC  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
/* 801F4D70 001F1CB0  4B E1 9E C5 */	bl initiate__10JSUPtrListFv
/* 801F4D74 001F1CB4  3C 60 80 0E */	lis r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@ha
/* 801F4D78 001F1CB8  38 83 69 EC */	addi r4, r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@l
/* 801F4D7C 001F1CBC  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
...
/* 801F4D8C 001F1CCC  98 0D 97 CD */	stb r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
lbl_801F4D90:
/* 801F4D90 001F1CD0  88 0D 97 CE */	lbz r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
/* 801F4D94 001F1CD4  7C 00 07 75 */	extsb. r0, r0
/* 801F4D98 001F1CD8  40 82 00 28 */	bne lbl_801F4DC0
/* 801F4D9C 001F1CDC  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
/* 801F4DA0 001F1CE0  4B E1 9E 95 */	bl initiate__10JSUPtrListFv
/* 801F4DA4 001F1CE4  3C 60 80 0E */	lis r3, "__dt__21JSUList<10MSSetSound>Fv"@ha
/* 801F4DA8 001F1CE8  38 83 69 94 */	addi r4, r3, "__dt__21JSUList<10MSSetSound>Fv"@l
/* 801F4DAC 001F1CEC  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
...
/* 801F4DBC 001F1CFC  98 0D 97 CE */	stb r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
lbl_801F4DC0:
/* 801F4DC0 001F1D00  88 0D 8F 8C */	lbz r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
/* 801F4DC4 001F1D04  7C 00 07 75 */	extsb. r0, r0
/* 801F4DC8 001F1D08  40 82 00 28 */	bne lbl_801F4DF0
/* 801F4DCC 001F1D0C  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
/* 801F4DD0 001F1D10  4B E1 9E 65 */	bl initiate__10JSUPtrListFv
/* 801F4DD4 001F1D14  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@ha
/* 801F4DD8 001F1D18  38 83 A8 0C */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@l
/* 801F4DDC 001F1D1C  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
...
/* 801F4DEC 001F1D2C  98 0D 8F 8C */	stb r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
lbl_801F4DF0:
/* 801F4DF0 001F1D30  88 0D 8F 8D */	lbz r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
/* 801F4DF4 001F1D34  7C 00 07 75 */	extsb. r0, r0
/* 801F4DF8 001F1D38  40 82 00 28 */	bne lbl_801F4E20
/* 801F4DFC 001F1D3C  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
/* 801F4E00 001F1D40  4B E1 9E 35 */	bl initiate__10JSUPtrListFv
/* 801F4E04 001F1D44  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@ha
/* 801F4E08 001F1D48  38 83 A7 B4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@l
/* 801F4E0C 001F1D4C  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
...
/* 801F4E1C 001F1D5C  98 0D 8F 8D */	stb r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
lbl_801F4E20:
/* 801F4E20 001F1D60  88 0D 8F 8E */	lbz r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
/* 801F4E24 001F1D64  7C 00 07 75 */	extsb. r0, r0
/* 801F4E28 001F1D68  40 82 00 28 */	bne lbl_801F4E50
/* 801F4E2C 001F1D6C  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
/* 801F4E30 001F1D70  4B E1 9E 05 */	bl initiate__10JSUPtrListFv
/* 801F4E34 001F1D74  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@ha
/* 801F4E38 001F1D78  38 83 A7 5C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@l
/* 801F4E3C 001F1D7C  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
...
/* 801F4E4C 001F1D8C  98 0D 8F 8E */	stb r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
lbl_801F4E50:
/* 801F4E50 001F1D90  88 0D 8F 8F */	lbz r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
/* 801F4E54 001F1D94  7C 00 07 75 */	extsb. r0, r0
/* 801F4E58 001F1D98  40 82 00 28 */	bne lbl_801F4E80
/* 801F4E5C 001F1D9C  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
/* 801F4E60 001F1DA0  4B E1 9D D5 */	bl initiate__10JSUPtrListFv
/* 801F4E64 001F1DA4  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@ha
/* 801F4E68 001F1DA8  38 83 A7 04 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@l
/* 801F4E6C 001F1DAC  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
...
/* 801F4E7C 001F1DBC  98 0D 8F 8F */	stb r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
lbl_801F4E80:
/* 801F4E80 001F1DC0  88 0D 8F 90 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
/* 801F4E84 001F1DC4  7C 00 07 75 */	extsb. r0, r0
/* 801F4E88 001F1DC8  40 82 00 28 */	bne lbl_801F4EB0
/* 801F4E8C 001F1DCC  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
/* 801F4E90 001F1DD0  4B E1 9D A5 */	bl initiate__10JSUPtrListFv
/* 801F4E94 001F1DD4  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@ha
/* 801F4E98 001F1DD8  38 83 A6 AC */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@l
/* 801F4E9C 001F1DDC  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
...
/* 801F4EAC 001F1DEC  98 0D 8F 90 */	stb r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
lbl_801F4EB0:
/* 801F4EB0 001F1DF0  88 0D 8F 91 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
/* 801F4EB4 001F1DF4  7C 00 07 75 */	extsb. r0, r0
/* 801F4EB8 001F1DF8  40 82 00 28 */	bne lbl_801F4EE0
/* 801F4EBC 001F1DFC  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
/* 801F4EC0 001F1E00  4B E1 9D 75 */	bl initiate__10JSUPtrListFv
/* 801F4EC4 001F1E04  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@ha
/* 801F4EC8 001F1E08  38 83 A6 54 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@l
/* 801F4ECC 001F1E0C  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
...
/* 801F4EDC 001F1E1C  98 0D 8F 91 */	stb r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
lbl_801F4EE0:
/* 801F4EE0 001F1E20  88 0D 8F 92 */	lbz r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
/* 801F4EE4 001F1E24  7C 00 07 75 */	extsb. r0, r0
/* 801F4EE8 001F1E28  40 82 00 28 */	bne lbl_801F4F10
/* 801F4EEC 001F1E2C  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
/* 801F4EF0 001F1E30  4B E1 9D 45 */	bl initiate__10JSUPtrListFv
/* 801F4EF4 001F1E34  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@ha
/* 801F4EF8 001F1E38  38 83 A5 FC */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@l
/* 801F4EFC 001F1E3C  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
...
/* 801F4F0C 001F1E4C  98 0D 8F 92 */	stb r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
lbl_801F4F10:
/* 801F4F10 001F1E50  88 0D 8F 93 */	lbz r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
/* 801F4F14 001F1E54  7C 00 07 75 */	extsb. r0, r0
/* 801F4F18 001F1E58  40 82 00 28 */	bne lbl_801F4F40
/* 801F4F1C 001F1E5C  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
/* 801F4F20 001F1E60  4B E1 9D 15 */	bl initiate__10JSUPtrListFv
/* 801F4F24 001F1E64  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@ha
/* 801F4F28 001F1E68  38 83 A5 A4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@l
/* 801F4F2C 001F1E6C  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
...
/* 801F4F3C 001F1E7C  98 0D 8F 93 */	stb r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
lbl_801F4F40:
/* 801F4F40 001F1E80  88 0D 8F 94 */	lbz r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
/* 801F4F44 001F1E84  7C 00 07 75 */	extsb. r0, r0
/* 801F4F48 001F1E88  40 82 00 28 */	bne lbl_801F4F70
/* 801F4F4C 001F1E8C  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
/* 801F4F50 001F1E90  4B E1 9C E5 */	bl initiate__10JSUPtrListFv
/* 801F4F54 001F1E94  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@ha
/* 801F4F58 001F1E98  38 83 A5 4C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@l
/* 801F4F5C 001F1E9C  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
...
/* 801F4F6C 001F1EAC  98 0D 8F 94 */	stb r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
lbl_801F4F70:
/* 801F4F70 001F1EB0  88 0D 8F 95 */	lbz r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
/* 801F4F74 001F1EB4  7C 00 07 75 */	extsb. r0, r0
/* 801F4F78 001F1EB8  40 82 00 28 */	bne lbl_801F4FA0
/* 801F4F7C 001F1EBC  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
/* 801F4F80 001F1EC0  4B E1 9C B5 */	bl initiate__10JSUPtrListFv
/* 801F4F84 001F1EC4  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@ha
/* 801F4F88 001F1EC8  38 83 A4 F4 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@l
/* 801F4F8C 001F1ECC  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
...
/* 801F4F9C 001F1EDC  98 0D 8F 95 */	stb r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
lbl_801F4FA0:
/* 801F4FA0 001F1EE0  88 0D 8F 96 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
/* 801F4FA4 001F1EE4  7C 00 07 75 */	extsb. r0, r0
/* 801F4FA8 001F1EE8  40 82 00 28 */	bne lbl_801F4FD0
/* 801F4FAC 001F1EEC  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
/* 801F4FB0 001F1EF0  4B E1 9C 85 */	bl initiate__10JSUPtrListFv
/* 801F4FB4 001F1EF4  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@ha
/* 801F4FB8 001F1EF8  38 83 A4 9C */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@l
/* 801F4FBC 001F1EFC  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
...
/* 801F4FCC 001F1F0C  98 0D 8F 96 */	stb r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
lbl_801F4FD0:
/* 801F4FD0 001F1F10  88 0D 8F 97 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
/* 801F4FD4 001F1F14  7C 00 07 75 */	extsb. r0, r0
/* 801F4FD8 001F1F18  40 82 00 28 */	bne lbl_801F5000
/* 801F4FDC 001F1F1C  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
/* 801F4FE0 001F1F20  4B E1 9C 55 */	bl initiate__10JSUPtrListFv
/* 801F4FE4 001F1F24  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@ha
/* 801F4FE8 001F1F28  38 83 A4 44 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@l
/* 801F4FEC 001F1F2C  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
...
/* 801F4FFC 001F1F3C  98 0D 8F 97 */	stb r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
lbl_801F5000:
