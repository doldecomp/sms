...
/* 801E0F90 001DDED0  3C 60 80 3F */	lis r3, "@2700"@ha
...
/* 801E0FA0 001DDEE0  3B E3 7A C8 */	addi r31, r3, "@2700"@l
/* 801E0FA4 001DDEE4  88 0D 97 CC */	lbz r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
/* 801E0FA8 001DDEE8  7C 00 07 75 */	extsb. r0, r0
/* 801E0FAC 001DDEEC  40 82 00 28 */	bne lbl_801E0FD4
/* 801E0FB0 001DDEF0  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
/* 801E0FB4 001DDEF4  4B E2 DC 81 */	bl initiate__10JSUPtrListFv
/* 801E0FB8 001DDEF8  3C 60 80 0E */	lis r3, "__dt__15JSUList<5MSBgm>Fv"@ha
/* 801E0FBC 001DDEFC  38 83 6A 44 */	addi r4, r3, "__dt__15JSUList<5MSBgm>Fv"@l
/* 801E0FC0 001DDF00  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
...
/* 801E0FD0 001DDF10  98 0D 97 CC */	stb r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
lbl_801E0FD4:
/* 801E0FD4 001DDF14  88 0D 97 CD */	lbz r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
/* 801E0FD8 001DDF18  7C 00 07 75 */	extsb. r0, r0
/* 801E0FDC 001DDF1C  40 82 00 28 */	bne lbl_801E1004
/* 801E0FE0 001DDF20  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
/* 801E0FE4 001DDF24  4B E2 DC 51 */	bl initiate__10JSUPtrListFv
/* 801E0FE8 001DDF28  3C 60 80 0E */	lis r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@ha
/* 801E0FEC 001DDF2C  38 83 69 EC */	addi r4, r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@l
/* 801E0FF0 001DDF30  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
...
/* 801E1000 001DDF40  98 0D 97 CD */	stb r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
lbl_801E1004:
/* 801E1004 001DDF44  88 0D 97 CE */	lbz r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
/* 801E1008 001DDF48  7C 00 07 75 */	extsb. r0, r0
/* 801E100C 001DDF4C  40 82 00 28 */	bne lbl_801E1034
/* 801E1010 001DDF50  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
/* 801E1014 001DDF54  4B E2 DC 21 */	bl initiate__10JSUPtrListFv
/* 801E1018 001DDF58  3C 60 80 0E */	lis r3, "__dt__21JSUList<10MSSetSound>Fv"@ha
/* 801E101C 001DDF5C  38 83 69 94 */	addi r4, r3, "__dt__21JSUList<10MSSetSound>Fv"@l
/* 801E1020 001DDF60  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
...
/* 801E1030 001DDF70  98 0D 97 CE */	stb r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
lbl_801E1034:
/* 801E1034 001DDF74  88 0D 8F 8C */	lbz r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
/* 801E1038 001DDF78  7C 00 07 75 */	extsb. r0, r0
/* 801E103C 001DDF7C  40 82 00 28 */	bne lbl_801E1064
/* 801E1040 001DDF80  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
/* 801E1044 001DDF84  4B E2 DB F1 */	bl initiate__10JSUPtrListFv
/* 801E1048 001DDF88  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@ha
/* 801E104C 001DDF8C  38 83 A8 0C */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@l
/* 801E1050 001DDF90  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
...
/* 801E1060 001DDFA0  98 0D 8F 8C */	stb r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
lbl_801E1064:
/* 801E1064 001DDFA4  88 0D 8F 8D */	lbz r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
/* 801E1068 001DDFA8  7C 00 07 75 */	extsb. r0, r0
/* 801E106C 001DDFAC  40 82 00 28 */	bne lbl_801E1094
/* 801E1070 001DDFB0  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
/* 801E1074 001DDFB4  4B E2 DB C1 */	bl initiate__10JSUPtrListFv
/* 801E1078 001DDFB8  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@ha
/* 801E107C 001DDFBC  38 83 A7 B4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@l
/* 801E1080 001DDFC0  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
...
/* 801E1090 001DDFD0  98 0D 8F 8D */	stb r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
lbl_801E1094:
/* 801E1094 001DDFD4  88 0D 8F 8E */	lbz r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
/* 801E1098 001DDFD8  7C 00 07 75 */	extsb. r0, r0
/* 801E109C 001DDFDC  40 82 00 28 */	bne lbl_801E10C4
/* 801E10A0 001DDFE0  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
/* 801E10A4 001DDFE4  4B E2 DB 91 */	bl initiate__10JSUPtrListFv
/* 801E10A8 001DDFE8  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@ha
/* 801E10AC 001DDFEC  38 83 A7 5C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@l
/* 801E10B0 001DDFF0  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
...
/* 801E10C0 001DE000  98 0D 8F 8E */	stb r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
lbl_801E10C4:
/* 801E10C4 001DE004  88 0D 8F 8F */	lbz r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
/* 801E10C8 001DE008  7C 00 07 75 */	extsb. r0, r0
/* 801E10CC 001DE00C  40 82 00 28 */	bne lbl_801E10F4
/* 801E10D0 001DE010  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
/* 801E10D4 001DE014  4B E2 DB 61 */	bl initiate__10JSUPtrListFv
/* 801E10D8 001DE018  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@ha
/* 801E10DC 001DE01C  38 83 A7 04 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@l
/* 801E10E0 001DE020  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
...
/* 801E10F0 001DE030  98 0D 8F 8F */	stb r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
lbl_801E10F4:
/* 801E10F4 001DE034  88 0D 8F 90 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
/* 801E10F8 001DE038  7C 00 07 75 */	extsb. r0, r0
/* 801E10FC 001DE03C  40 82 00 28 */	bne lbl_801E1124
/* 801E1100 001DE040  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
/* 801E1104 001DE044  4B E2 DB 31 */	bl initiate__10JSUPtrListFv
/* 801E1108 001DE048  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@ha
/* 801E110C 001DE04C  38 83 A6 AC */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@l
/* 801E1110 001DE050  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
...
/* 801E1120 001DE060  98 0D 8F 90 */	stb r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
lbl_801E1124:
/* 801E1124 001DE064  88 0D 8F 91 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
/* 801E1128 001DE068  7C 00 07 75 */	extsb. r0, r0
/* 801E112C 001DE06C  40 82 00 28 */	bne lbl_801E1154
/* 801E1130 001DE070  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
/* 801E1134 001DE074  4B E2 DB 01 */	bl initiate__10JSUPtrListFv
/* 801E1138 001DE078  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@ha
/* 801E113C 001DE07C  38 83 A6 54 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@l
/* 801E1140 001DE080  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
...
/* 801E1150 001DE090  98 0D 8F 91 */	stb r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
lbl_801E1154:
/* 801E1154 001DE094  88 0D 8F 92 */	lbz r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
/* 801E1158 001DE098  7C 00 07 75 */	extsb. r0, r0
/* 801E115C 001DE09C  40 82 00 28 */	bne lbl_801E1184
/* 801E1160 001DE0A0  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
/* 801E1164 001DE0A4  4B E2 DA D1 */	bl initiate__10JSUPtrListFv
/* 801E1168 001DE0A8  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@ha
/* 801E116C 001DE0AC  38 83 A5 FC */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@l
/* 801E1170 001DE0B0  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
...
/* 801E1180 001DE0C0  98 0D 8F 92 */	stb r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
lbl_801E1184:
/* 801E1184 001DE0C4  88 0D 8F 93 */	lbz r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
/* 801E1188 001DE0C8  7C 00 07 75 */	extsb. r0, r0
/* 801E118C 001DE0CC  40 82 00 28 */	bne lbl_801E11B4
/* 801E1190 001DE0D0  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
/* 801E1194 001DE0D4  4B E2 DA A1 */	bl initiate__10JSUPtrListFv
/* 801E1198 001DE0D8  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@ha
/* 801E119C 001DE0DC  38 83 A5 A4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@l
/* 801E11A0 001DE0E0  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
...
/* 801E11B0 001DE0F0  98 0D 8F 93 */	stb r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
lbl_801E11B4:
/* 801E11B4 001DE0F4  88 0D 8F 94 */	lbz r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
/* 801E11B8 001DE0F8  7C 00 07 75 */	extsb. r0, r0
/* 801E11BC 001DE0FC  40 82 00 28 */	bne lbl_801E11E4
/* 801E11C0 001DE100  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
/* 801E11C4 001DE104  4B E2 DA 71 */	bl initiate__10JSUPtrListFv
/* 801E11C8 001DE108  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@ha
/* 801E11CC 001DE10C  38 83 A5 4C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@l
/* 801E11D0 001DE110  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
...
/* 801E11E0 001DE120  98 0D 8F 94 */	stb r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
lbl_801E11E4:
/* 801E11E4 001DE124  88 0D 8F 95 */	lbz r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
/* 801E11E8 001DE128  7C 00 07 75 */	extsb. r0, r0
/* 801E11EC 001DE12C  40 82 00 28 */	bne lbl_801E1214
/* 801E11F0 001DE130  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
/* 801E11F4 001DE134  4B E2 DA 41 */	bl initiate__10JSUPtrListFv
/* 801E11F8 001DE138  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@ha
/* 801E11FC 001DE13C  38 83 A4 F4 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@l
/* 801E1200 001DE140  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
...
/* 801E1210 001DE150  98 0D 8F 95 */	stb r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
lbl_801E1214:
/* 801E1214 001DE154  88 0D 8F 96 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
/* 801E1218 001DE158  7C 00 07 75 */	extsb. r0, r0
/* 801E121C 001DE15C  40 82 00 28 */	bne lbl_801E1244
/* 801E1220 001DE160  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
/* 801E1224 001DE164  4B E2 DA 11 */	bl initiate__10JSUPtrListFv
/* 801E1228 001DE168  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@ha
/* 801E122C 001DE16C  38 83 A4 9C */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@l
/* 801E1230 001DE170  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
...
/* 801E1240 001DE180  98 0D 8F 96 */	stb r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
lbl_801E1244:
/* 801E1244 001DE184  88 0D 8F 97 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
/* 801E1248 001DE188  7C 00 07 75 */	extsb. r0, r0
/* 801E124C 001DE18C  40 82 00 28 */	bne lbl_801E1274
/* 801E1250 001DE190  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
/* 801E1254 001DE194  4B E2 D9 E1 */	bl initiate__10JSUPtrListFv
/* 801E1258 001DE198  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@ha
/* 801E125C 001DE19C  38 83 A4 44 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@l
/* 801E1260 001DE1A0  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
...
/* 801E1270 001DE1B0  98 0D 8F 97 */	stb r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
lbl_801E1274:
...
__vt__9TMapEvent:
  ...
  .4byte isFinishedAll__9TMapEventCFv
  .4byte 0
