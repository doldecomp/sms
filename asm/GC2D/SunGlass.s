...
/* 8023D4E0 0023A420  80 6D 97 E8 */	lwz r3, gpMarDirector-_SDA_BASE_(r13)
...
/* 8023D574 0023A4B4  80 6D A8 C8 */	lwz r3, gpSunMgr-_SDA_BASE_(r13)
...
/* 8023D5C0 0023A500  C0 02 DA 20 */	lfs f0, $$21842-_SDA2_BASE_(r2)
/* 8023D5C4 0023A504  38 C0 00 00 */	li r6, 0
/* 8023D5C8 0023A508  C0 22 DA 24 */	lfs f1, $$21843-_SDA2_BASE_(r2)
/* 8023D5CC 0023A50C  38 E0 00 00 */	li r7, 0
/* 8023D5D0 0023A510  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 8023D5D4 0023A514  C0 02 DA 28 */	lfs f0, $$21844-_SDA2_BASE_(r2)
/* 8023D5D8 0023A518  D0 21 00 20 */	stfs f1, 0x20(r1)
/* 8023D5DC 0023A51C  80 6D 98 54 */	lwz r3, gpEmitterManager4D2-_SDA_BASE_(r13)
...
/* 8023D618 0023A558  80 6D 97 E8 */	lwz r3, gpMarDirector-_SDA_BASE_(r13)
...
/* 8023D654 0023A594  80 8D 97 E8 */	lwz r4, gpMarDirector-_SDA_BASE_(r13)
...
/* 8023D664 0023A5A4  80 6D 97 D0 */	lwz r3, smInstance__12TFlagManager-_SDA_BASE_(r13)
...
/* 8023D674 0023A5B4  C8 62 DA 38 */	lfd f3, $$21865-_SDA2_BASE_(r2)
/* 8023D678 0023A5B8  90 01 00 34 */	stw r0, 0x34(r1)
/* 8023D67C 0023A5BC  3C 80 43 30 */	lis r4, 0x4330
/* 8023D680 0023A5C0  C0 02 DA 30 */	lfs f0, $$21863-_SDA2_BASE_(r2)
...
/* 8023D698 0023A5D8  C0 22 DA 2C */	lfs f1, $$21862-_SDA2_BASE_(r2)
...
/* 8023D724 0023A664  C8 42 DA 38 */	lfd f2, $$21865-_SDA2_BASE_(r2)
/* 8023D728 0023A668  91 01 00 30 */	stw r8, 0x30(r1)
/* 8023D72C 0023A66C  C8 22 DA 40 */	lfd f1, $$21890-_SDA2_BASE_(r2)
...
/* 8023D84C 0023A78C  C0 22 DA 28 */	lfs f1, $$21844-_SDA2_BASE_(r2)
...
/* 8023DA1C 0023A95C  80 0D 97 D0 */	lwz r0, smInstance__12TFlagManager-_SDA_BASE_(r13)
...
/* 8023DA30 0023A970  80 6D 97 E8 */	lwz r3, gpMarDirector-_SDA_BASE_(r13)
...
/* 8023DA44 0023A984  80 6D 97 D0 */	lwz r3, smInstance__12TFlagManager-_SDA_BASE_(r13)
...
/* 8023DA54 0023A994  C8 62 DA 38 */	lfd f3, $$21865-_SDA2_BASE_(r2)
/* 8023DA58 0023A998  90 01 00 54 */	stw r0, 0x54(r1)
/* 8023DA5C 0023A99C  3C 80 43 30 */	lis r4, 0x4330
/* 8023DA60 0023A9A0  C0 02 DA 30 */	lfs f0, $$21863-_SDA2_BASE_(r2)
...
/* 8023DA78 0023A9B8  C0 22 DA 2C */	lfs f1, $$21862-_SDA2_BASE_(r2)
...
/* 8023DAC8 0023AA08  80 6D 97 E8 */	lwz r3, gpMarDirector-_SDA_BASE_(r13)
...
/* 8023DAD8 0023AA18  80 6D 97 D0 */	lwz r3, smInstance__12TFlagManager-_SDA_BASE_(r13)
...
/* 8023DAE8 0023AA28  C8 62 DA 38 */	lfd f3, $$21865-_SDA2_BASE_(r2)
/* 8023DAEC 0023AA2C  90 01 00 44 */	stw r0, 0x44(r1)
/* 8023DAF0 0023AA30  3C 80 43 30 */	lis r4, 0x4330
/* 8023DAF4 0023AA34  C0 02 DA 30 */	lfs f0, $$21863-_SDA2_BASE_(r2)
...
/* 8023DB0C 0023AA4C  C0 22 DA 2C */	lfs f1, $$21862-_SDA2_BASE_(r2)
