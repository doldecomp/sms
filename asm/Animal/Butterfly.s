...
lbl_8036F4BC:
/* 8036F4BC 0036C3FC  C0 02 0B 6C */	lfs f0, $$22490-_SDA2_BASE_(r2)
/* 8036F4C0 0036C400  38 C1 00 B8 */	addi r6, r1, 0xb8
/* 8036F4C4 0036C404  C0 22 0B 68 */	lfs f1, $$22489-_SDA2_BASE_(r2)
...
/* 8036F4D8 0036C418  38 62 0B 70 */	addi r3, r2, $$22491-_SDA2_BASE_
...
/* 8036F508 0036C448  38 82 0B 78 */	addi r4, r2, $$22492-_SDA2_BASE_
...
lbl_8036F518:
/* 8036F518 0036C458  C0 02 0B 6C */	lfs f0, $$22490-_SDA2_BASE_(r2)
/* 8036F51C 0036C45C  38 C1 00 DC */	addi r6, r1, 0xdc
/* 8036F520 0036C460  C0 22 0B 68 */	lfs f1, $$22489-_SDA2_BASE_(r2)
...
/* 8036F608 0036C548  C0 02 0B 94 */	lfs f0, $$22592-_SDA2_BASE_(r2)
/* 8036F60C 0036C54C  80 7D 01 50 */	lwz r3, 0x150(r29)
/* 8036F610 0036C550  D0 03 00 6C */	stfs f0, 0x6c(r3)
/* 8036F614 0036C554  C0 02 0B 98 */	lfs f0, $$22593-_SDA2_BASE_(r2)
...
/* 8036F6E0 0036C620  88 0D A1 10 */	lbz r0, init$localstatic1$theNerve__31TNerveWaitForever$$010TLiveActor$$1Fv-_SDA_BASE_(r13)
...
/* 8036F6F8 0036C638  90 0D A1 14 */	stw r0, instance$localstatic0$theNerve__31TNerveWaitForever$$010TLiveActor$$1Fv-_SDA_BASE_(r13)
...
/* 8036F704 0036C644  90 0D A1 14 */	stw r0, instance$localstatic0$theNerve__31TNerveWaitForever$$010TLiveActor$$1Fv-_SDA_BASE_(r13)
...
/* 8036F714 0036C654  38 6D A1 14 */	addi r3, r13, instance$localstatic0$theNerve__31TNerveWaitForever$$010TLiveActor$$1Fv-_SDA_BASE_
/* 8036F718 0036C658  4B D1 30 11 */	bl __register_global_object
/* 8036F71C 0036C65C  38 00 00 01 */	li r0, 1
/* 8036F720 0036C660  98 0D A1 10 */	stb r0, init$localstatic1$theNerve__31TNerveWaitForever$$010TLiveActor$$1Fv-_SDA_BASE_(r13)
lbl_8036F724:
/* 8036F724 0036C664  81 1F 00 8C */	lwz r8, 0x8c(r31)
/* 8036F728 0036C668  38 E0 00 00 */	li r7, 0
/* 8036F72C 0036C66C  38 0D A1 14 */	addi r0, r13, instance$localstatic0$theNerve__31TNerveWaitForever$$010TLiveActor$$1Fv-_SDA_BASE_
...
/* 8036F754 0036C694  C0 22 0B 6C */	lfs f1, $$22490-_SDA2_BASE_(r2)
...
/* 8036F840 0036C780  80 6D 97 98 */	lwz r3, gpMarioParticleManager-_SDA_BASE_(r13)
...
/* 8036F8E0 0036C820  80 6D 9A 18 */	lwz r3, gpItemManager-_SDA_BASE_(r13)
...
/* 8036F924 0036C864  C0 22 0B 6C */	lfs f1, $$22490-_SDA2_BASE_(r2)
/* 8036F928 0036C868  D0 3E 00 AC */	stfs f1, 0xac(r30)
/* 8036F92C 0036C86C  C0 02 0B 9C */	lfs f0, $$22616-_SDA2_BASE_(r2)
...
/* 8036F98C 0036C8CC  C0 22 0B 6C */	lfs f1, $$22490-_SDA2_BASE_(r2)
/* 8036F990 0036C8D0  C0 62 0B A0 */	lfs f3, $$22710-_SDA2_BASE_(r2)
...
/* 8036F9D0 0036C910  80 8D 8E E0 */	lwz r4, instance__Q26JDrama11TNameRefGen-_SDA_BASE_(r13)
...
.global cButterflyMdlNames__9$$2unnamed$$2
