...
/* 8034B41C 0034835C  4B FF FF 51 */	bl "set<f>__Q29JGeometry8TVec3<f>Ffff"
...
/* 8034B44C 0034838C  4B D8 54 65 */	bl "sqrt__Q29JGeometry8TUtil<f>Ff"
...
/* 8034B478 003483B8  C0 02 03 58 */	lfs f0, "@1944"@sda21(r2)
...
/* 8034B490 003483D0  C0 42 03 5C */	lfs f2, "@1945"@sda21(r2)
/* 8034B494 003483D4  C0 02 03 60 */	lfs f0, "@1946"@sda21(r2)
...
/* 8034B518 00348458  4B FF FE 55 */	bl "set<f>__Q29JGeometry8TVec3<f>Ffff"
...
/* 8034B548 00348488  4B D8 53 69 */	bl "sqrt__Q29JGeometry8TUtil<f>Ff"
...
/* 8034B574 003484B4  C0 02 03 58 */	lfs f0, "@1944"@sda21(r2)
...
/* 8034B58C 003484CC  C0 42 03 5C */	lfs f2, "@1945"@sda21(r2)
/* 8034B590 003484D0  C0 02 03 60 */	lfs f0, "@1946"@sda21(r2)
...
/* 8034B5E8 00348528  C0 82 03 64 */	lfs f4, "@2126"@sda21(r2)
...
/* 8034B608 00348548  C0 02 03 68 */	lfs f0, "@2127"@sda21(r2)
...
/* 8034B61C 0034855C  C0 02 03 58 */	lfs f0, "@1944"@sda21(r2)
...
/* 8034B634 00348574  C0 62 03 5C */	lfs f3, "@1945"@sda21(r2)
/* 8034B638 00348578  C0 02 03 60 */	lfs f0, "@1946"@sda21(r2)
...
/* 8034B660 003485A0  C8 42 03 80 */	lfd f2, "@2133"@sda21(r2)
/* 8034B664 003485A4  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 8034B668 003485A8  C0 02 03 6C */	lfs f0, "@2128"@sda21(r2)
/* 8034B66C 003485AC  90 01 01 34 */	stw r0, 0x134(r1)
/* 8034B670 003485B0  3C 00 43 30 */	lis r0, 0x4330
/* 8034B674 003485B4  C0 62 03 70 */	lfs f3, "@2129"@sda21(r2)
...
lbl_8034B694:
/* 8034B694 003485D4  C0 62 03 74 */	lfs f3, "@2130"@sda21(r2)
...
/* 8034B6AC 003485EC  C0 42 03 78 */	lfs f2, "@2131"@sda21(r2)
...
/* 8034B6BC 003485FC  C0 02 03 58 */	lfs f0, "@1944"@sda21(r2)
...
/* 8034B6D4 00348614  C0 22 03 5C */	lfs f1, "@1945"@sda21(r2)
...
/* 8034B700 00348640  4B FF FC 6D */	bl "set<f>__Q29JGeometry8TVec3<f>Ffff"
...
/* 8034B730 00348670  4B D8 51 81 */	bl "sqrt__Q29JGeometry8TUtil<f>Ff"
...
/* 8034B764 003486A4  C0 02 03 58 */	lfs f0, "@1944"@sda21(r2)
...
/* 8034B77C 003486BC  C0 42 03 5C */	lfs f2, "@1945"@sda21(r2)
/* 8034B780 003486C0  C0 02 03 60 */	lfs f0, "@1946"@sda21(r2)
...
/* 8034B834 00348774  3C A0 80 3A */	lis r5, "@1490"@ha
...
/* 8034B86C 003487AC  3B E5 50 C8 */	addi r31, r5, "@1490"@l
