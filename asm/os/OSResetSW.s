...
/* 80091A24 0008E964  90 8D 93 6C */	stw r4, lbl_80409E2C@sda21(r13)
...
/* 80091A34 0008E974  90 6D 93 68 */	stw r3, HoldDown@sda21(r13)
...
/* 80091A58 0008E998  80 CD 93 6C */	lwz r6, lbl_80409E2C@sda21(r13)
/* 80091A5C 0008E99C  6F C5 80 00 */	xoris r5, r30, 0x8000
/* 80091A60 0008E9A0  80 0D 93 68 */	lwz r0, HoldDown@sda21(r13)
...
/* 80091AA4 0008E9E4  90 0D 93 54 */	stw r0, Down@sda21(r13)
/* 80091AA8 0008E9E8  38 60 02 00 */	li r3, 0x200
/* 80091AAC 0008E9EC  90 0D 93 58 */	stw r0, LastState@sda21(r13)
/* 80091AB0 0008E9F0  4B FF EA E5 */	bl __OSMaskInterrupts
/* 80091AB4 0008E9F4  81 8D 93 50 */	lwz r12, ResetCallback@sda21(r13)
...
/* 80091AC8 0008EA08  90 0D 93 50 */	stw r0, ResetCallback@sda21(r13)
...
/* 80091B2C 0008EA6C  80 0D 93 54 */	lwz r0, Down@sda21(r13)
/* 80091B30 0008EA70  2C 00 00 00 */	cmpwi r0, 0
/* 80091B34 0008EA74  40 82 00 40 */	bne lbl_80091B74
/* 80091B38 0008EA78  80 0D 93 60 */	lwz r0, HoldUp@sda21(r13)
/* 80091B3C 0008EA7C  38 C0 00 00 */	li r6, 0
/* 80091B40 0008EA80  80 AD 93 64 */	lwz r5, lbl_80409E24@sda21(r13)
...
/* 80091B50 0008EA90  90 ED 93 54 */	stw r7, Down@sda21(r13)
...
lbl_80091B64:
/* 80091B64 0008EAA4  90 8D 93 6C */	stw r4, lbl_80409E2C@sda21(r13)
/* 80091B68 0008EAA8  7C FD 3B 78 */	mr r29, r7
/* 80091B6C 0008EAAC  90 6D 93 68 */	stw r3, HoldDown@sda21(r13)
/* 80091B70 0008EAB0  48 00 01 48 */	b lbl_80091CB8
lbl_80091B74:
/* 80091B74 0008EAB4  80 0D 93 60 */	lwz r0, HoldUp@sda21(r13)
/* 80091B78 0008EAB8  39 20 00 00 */	li r9, 0
/* 80091B7C 0008EABC  80 AD 93 64 */	lwz r5, lbl_80409E24@sda21(r13)
...
/* 80091B98 0008EAD8  80 AD 93 6C */	lwz r5, lbl_80409E2C@sda21(r13)
...
/* 80091BA8 0008EAE8  80 0D 93 68 */	lwz r0, HoldDown@sda21(r13)
...
lbl_80091C04:
/* 80091C04 0008EB44  80 0D 93 54 */	lwz r0, Down@sda21(r13)
/* 80091C08 0008EB48  2C 00 00 00 */	cmpwi r0, 0
/* 80091C0C 0008EB4C  41 82 00 34 */	beq lbl_80091C40
/* 80091C10 0008EB50  80 AD 93 58 */	lwz r5, LastState@sda21(r13)
/* 80091C14 0008EB54  38 00 00 00 */	li r0, 0
/* 80091C18 0008EB58  90 0D 93 54 */	stw r0, Down@sda21(r13)
...
/* 80091C28 0008EB68  90 8D 93 64 */	stw r4, lbl_80409E24@sda21(r13)
/* 80091C2C 0008EB6C  90 6D 93 60 */	stw r3, HoldUp@sda21(r13)
/* 80091C30 0008EB70  48 00 00 88 */	b lbl_80091CB8
lbl_80091C34:
/* 80091C34 0008EB74  90 0D 93 64 */	stw r0, lbl_80409E24@sda21(r13)
/* 80091C38 0008EB78  90 0D 93 60 */	stw r0, HoldUp@sda21(r13)
/* 80091C3C 0008EB7C  48 00 00 7C */	b lbl_80091CB8
lbl_80091C40:
/* 80091C40 0008EB80  80 CD 93 60 */	lwz r6, HoldUp@sda21(r13)
/* 80091C44 0008EB84  39 00 00 00 */	li r8, 0
/* 80091C48 0008EB88  80 ED 93 64 */	lwz r7, lbl_80409E24@sda21(r13)
...
/* 80091CAC 0008EBEC  90 0D 93 64 */	stw r0, lbl_80409E24@sda21(r13)
/* 80091CB0 0008EBF0  3B A0 00 00 */	li r29, 0
/* 80091CB4 0008EBF4  90 0D 93 60 */	stw r0, HoldUp@sda21(r13)
lbl_80091CB8:
/* 80091CB8 0008EBF8  3C A0 80 00 */	lis r5, 0x800030E3@ha
/* 80091CBC 0008EBFC  93 AD 93 58 */	stw r29, LastState@sda21(r13)
...
/* 80091CD4 0008EC14  81 2D 92 EC */	lwz r9, lbl_80409DAC@sda21(r13)
/* 80091CD8 0008EC18  81 0D 92 E8 */	lwz r8, __OSStartTime@sda21(r13)
