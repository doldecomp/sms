...
/* 800BDDA0 000BACE0  C0 22 8C 04 */	lfs f1, "@55"@sda21(r2)
...
/* 800BDE08 000BAD48  C0 22 8C 04 */	lfs f1, "@55"@sda21(r2)
...
/* 800BDE60 000BADA0  C0 22 8C 04 */	lfs f1, "@55"@sda21(r2)
...
/* 800BDF60 000BAEA0  C0 22 8C 04 */	lfs f1, "@55"@sda21(r2)
...
/* 800BDF70 000BAEB0  C8 82 8C 10 */	lfd f4, "@74"@sda21(r2)
...
/* 800BDF80 000BAEC0  C0 C2 8C 08 */	lfs f6, "@71"@sda21(r2)
...
/* 800BDFB4 000BAEF4  C0 22 8C 04 */	lfs f1, "@55"@sda21(r2)
/* 800BDFB8 000BAEF8  93 A1 00 BC */	stw r29, 0xbc(r1)
/* 800BDFBC 000BAEFC  C8 82 8C 10 */	lfd f4, "@74"@sda21(r2)
...
/* 800BDFCC 000BAF0C  C0 C2 8C 0C */	lfs f6, "@72"@sda21(r2)
...
/* 800BE368 000BB2A8  80 62 8B F0 */	lwz r3, "@22"@sda21(r2)
...
/* 800BE394 000BB2D4  80 02 8B F8 */	lwz r0, "@25"@sda21(r2)
...
/* 800BE3B0 000BB2F0  80 02 8B FC */	lwz r0, "@28"@sda21(r2)
...
/* 800BE3CC 000BB30C  80 02 8C 00 */	lwz r0, "@31"@sda21(r2)
