...
/* 800832A8 000801E8  80 0D 92 90 */	lwz r0, __aborting@sda21(r13)
...
lbl_800832C0:
/* 800832C0 00080200  80 6D 92 94 */	lwz r3, atexit_curr_func@sda21(r13)
/* 800832C4 00080204  38 63 FF FF */	addi r3, r3, -1
/* 800832C8 00080208  54 60 10 3A */	slwi r0, r3, 2
/* 800832CC 0008020C  90 6D 92 94 */	stw r3, atexit_curr_func@sda21(r13)
...
lbl_800832E0:
/* 800832E0 00080220  80 0D 92 94 */	lwz r0, atexit_curr_func@sda21(r13)
...
/* 80083318 00080258  81 8D 92 9C */	lwz r12, __stdio_exit@sda21(r13)
...
/* 80083330 00080270  90 0D 92 9C */	stw r0, __stdio_exit@sda21(r13)
lbl_80083334:
...
lbl_80083340:
/* 80083340 00080280  80 6D 92 98 */	lwz r3, __atexit_curr_func@sda21(r13)
/* 80083344 00080284  38 63 FF FF */	addi r3, r3, -1
/* 80083348 00080288  54 60 10 3A */	slwi r0, r3, 2
/* 8008334C 0008028C  90 6D 92 98 */	stw r3, __atexit_curr_func@sda21(r13)
...
lbl_80083360:
/* 80083360 000802A0  80 0D 92 98 */	lwz r0, __atexit_curr_func@sda21(r13)
...
/* 80083370 000802B0  81 8D 92 A0 */	lwz r12, __console_exit@sda21(r13)
...
/* 80083388 000802C8  90 0D 92 A0 */	stw r0, __console_exit@sda21(r13)
lbl_8008338C:
