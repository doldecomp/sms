...
/* 800CF4D8 000CC418  C0 02 8E 90 */	lfs f0, "@1767"@sda21(r2)
...
/* 800CF594 000CC4D4  C3 E2 8E 94 */	lfs f31, "@1790"@sda21(r2)
...
/* 800CF63C 000CC57C  C3 82 8E 98 */	lfs f28, "@1841"@sda21(r2)
...
lbl_800CF660:
/* 800CF660 000CC5A0  C3 A2 8E 94 */	lfs f29, "@1790"@sda21(r2)
/* 800CF664 000CC5A4  3B C0 00 00 */	li r30, 0
/* 800CF668 000CC5A8  C3 C2 8E 90 */	lfs f30, "@1767"@sda21(r2)
...
/* 800CF8B0 000CC7F0  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800CF950 000CC890  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
lbl_800CF954:
...
/* 800CFC08 000CCB48  C3 E2 8E 94 */	lfs f31, "@1790"@sda21(r2)
...
/* 800CFDEC 000CCD2C  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0020 000CCF60  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0150 000CD090  C3 E2 8E 94 */	lfs f31, "@1790"@sda21(r2)
lbl_800D0154:
...
/* 800D0198 000CD0D8  C0 02 8E 98 */	lfs f0, "@1841"@sda21(r2)
...
lbl_800D01AC:
/* 800D01AC 000CD0EC  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D01C0 000CD100  C0 0D 83 38 */	lfs f0, mPowerThreshold__9RumbleMgr@sda21(r13)
/* 800D01C4 000CD104  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D01C8 000CD108  40 81 00 0C */	ble lbl_800D01D4
/* 800D01CC 000CD10C  A0 0D 83 34 */	lhz r0, mMotorTimerPeriod__9RumbleMgr@sda21(r13)
...
/* 800D01E0 000CD120  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0244 000CD184  80 0D 83 30 */	lwz r0, mMotorCountLimit__9RumbleMgr@sda21(r13)
...
/* 800D0290 000CD1D0  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D03E8 000CD328  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0440 000CD380  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0490 000CD3D0  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D061C 000CD55C  C0 42 8E 98 */	lfs f2, "@1841"@sda21(r2)
...
/* 800D0634 000CD574  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0668 000CD5A8  80 8D 98 DC */	lwz r4, gpMarioPos@sda21(r13)
...
/* 800D06EC 000CD62C  48 00 01 C5 */	bl "sqrt__Q29JGeometry8TUtil<f>Ff"
/* 800D06F0 000CD630  C0 02 8E A0 */	lfs f0, "@2245"@sda21(r2)
/* 800D06F4 000CD634  C0 62 8E 9C */	lfs f3, "@2244"@sda21(r2)
/* 800D06F8 000CD638  EC 41 00 28 */	fsubs f2, f1, f0
/* 800D06FC 000CD63C  C0 22 8E 98 */	lfs f1, "@1841"@sda21(r2)
/* 800D0700 000CD640  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
lbl_800D0730:
/* 800D0730 000CD670  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0788 000CD6C8  C0 82 8E 94 */	lfs f4, "@1790"@sda21(r2)
/* 800D078C 000CD6CC  C0 62 8E 98 */	lfs f3, "@1841"@sda21(r2)
...
lbl_800D07C8:
/* 800D07C8 000CD708  C0 C2 8E 98 */	lfs f6, "@1841"@sda21(r2)
lbl_800D07CC:
...
/* 800D0834 000CD774  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D0854 000CD794  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
/* 800D0858 000CD798  D0 1F 00 00 */	stfs f0, 0(r31)
/* 800D085C 000CD79C  48 00 00 2C */	b lbl_800D0888
lbl_800D0860:
/* 800D0860 000CD7A0  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
.global "sqrt__Q29JGeometry8TUtil<f>Ff"
"sqrt__Q29JGeometry8TUtil<f>Ff":
/* 800D08B0 000CD7F0  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
...
/* 800D08C4 000CD804  C0 62 8E 90 */	lfs f3, "@1767"@sda21(r2)
/* 800D08C8 000CD808  C0 02 8E A4 */	lfs f0, "@2249"@sda21(r2)
...
/* 800D08E8 000CD828  C0 02 8E 94 */	lfs f0, "@1790"@sda21(r2)
