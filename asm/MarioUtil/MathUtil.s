...
/* 800C5870 000C27B0  C0 02 8C E8 */	lfs f0, $$21608-_SDA2_BASE_(r2)
...
/* 800C5890 000C27D0  C8 42 8C F0 */	lfd f2, $$21611-_SDA2_BASE_(r2)
...
/* 800C5934 000C2874  C0 02 8C E8 */	lfs f0, $$21608-_SDA2_BASE_(r2)
...
/* 800C5974 000C28B4  C8 82 8C F0 */	lfd f4, $$21611-_SDA2_BASE_(r2)
/* 800C5978 000C28B8  90 01 00 2C */	stw r0, 0x2c(r1)
/* 800C597C 000C28BC  3C 00 43 30 */	lis r0, 0x4330
/* 800C5980 000C28C0  C0 C2 8C F8 */	lfs f6, $$21627-_SDA2_BASE_(r2)
...
/* 800C5A00 000C2940  C0 42 8C FC */	lfs f2, $$21638-_SDA2_BASE_(r2)
...
/* 800C5A6C 000C29AC  C8 22 8C F0 */	lfd f1, $$21611-_SDA2_BASE_(r2)
/* 800C5A70 000C29B0  7C 00 07 34 */	extsh r0, r0
/* 800C5A74 000C29B4  C0 42 8D 00 */	lfs f2, $$21639-_SDA2_BASE_(r2)
...
/* 800C5B58 000C2A98  C0 02 8C E8 */	lfs f0, $$21608-_SDA2_BASE_(r2)
...
/* 800C5B70 000C2AB0  C3 A2 8D 04 */	lfs f29, $$21673-_SDA2_BASE_(r2)
/* 800C5B74 000C2AB4  48 00 00 88 */	b lbl_800C5BFC
lbl_800C5B78:
/* 800C5B78 000C2AB8  C3 A2 8D 08 */	lfs f29, $$21674-_SDA2_BASE_(r2)
...
/* 800C5B98 000C2AD8  C8 42 8C F0 */	lfd f2, $$21611-_SDA2_BASE_(r2)
/* 800C5B9C 000C2ADC  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C5BA0 000C2AE0  C0 02 8D 00 */	lfs f0, $$21639-_SDA2_BASE_(r2)
...
/* 800C5BD0 000C2B10  C8 62 8C F0 */	lfd f3, $$21611-_SDA2_BASE_(r2)
/* 800C5BD4 000C2B14  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C5BD8 000C2B18  C0 22 8D 00 */	lfs f1, $$21639-_SDA2_BASE_(r2)
/* 800C5BDC 000C2B1C  90 01 00 44 */	stw r0, 0x44(r1)
/* 800C5BE0 000C2B20  3C 00 43 30 */	lis r0, 0x4330
/* 800C5BE4 000C2B24  C0 02 8D 0C */	lfs f0, $$21675-_SDA2_BASE_(r2)
...
lbl_800C5BFC:
/* 800C5BFC 000C2B3C  C0 02 8D 0C */	lfs f0, $$21675-_SDA2_BASE_(r2)
...
/* 800C5C14 000C2B54  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C5CC0 000C2C00  C1 42 8C FC */	lfs f10, $$21638-_SDA2_BASE_(r2)
/* 800C5CC4 000C2C04  80 CD 8D EC */	lwz r6, jmaSinShift-_SDA_BASE_(r13)
/* 800C5CC8 000C2C08  ED 2A 01 32 */	fmuls f9, f10, f4
/* 800C5CCC 000C2C0C  81 2D 8D F4 */	lwz r9, jmaCosTable-_SDA_BASE_(r13)
/* 800C5CD0 000C2C10  EC AA 01 72 */	fmuls f5, f10, f5
/* 800C5CD4 000C2C14  80 ED 8D F0 */	lwz r7, jmaSinTable-_SDA_BASE_(r13)
...
/* 800C5DE8 000C2D28  80 ED 8D EC */	lwz r7, jmaSinShift-_SDA_BASE_(r13)
/* 800C5DEC 000C2D2C  54 84 04 3E */	clrlwi r4, r4, 0x10
/* 800C5DF0 000C2D30  54 A0 04 3E */	clrlwi r0, r5, 0x10
/* 800C5DF4 000C2D34  80 AD 8D F0 */	lwz r5, jmaSinTable-_SDA_BASE_(r13)
/* 800C5DF8 000C2D38  7C 84 3E 30 */	sraw r4, r4, r7
/* 800C5DFC 000C2D3C  7C 00 3E 30 */	sraw r0, r0, r7
/* 800C5E00 000C2D40  81 2D 8D F4 */	lwz r9, jmaCosTable-_SDA_BASE_(r13)
...
/* 800C5E9C 000C2DDC  C0 02 8C FC */	lfs f0, $$21638-_SDA2_BASE_(r2)
/* 800C5EA0 000C2DE0  80 CD 8D EC */	lwz r6, jmaSinShift-_SDA_BASE_(r13)
/* 800C5EA4 000C2DE4  EC 80 00 72 */	fmuls f4, f0, f1
/* 800C5EA8 000C2DE8  81 2D 8D F4 */	lwz r9, jmaCosTable-_SDA_BASE_(r13)
/* 800C5EAC 000C2DEC  EC 20 00 B2 */	fmuls f1, f0, f2
/* 800C5EB0 000C2DF0  80 ED 8D F0 */	lwz r7, jmaSinTable-_SDA_BASE_(r13)
...
/* 800C5F78 000C2EB8  C0 02 8C E8 */	lfs f0, $$21608-_SDA2_BASE_(r2)
...
/* 800C5FA4 000C2EE4  C0 82 8C E8 */	lfs f4, $$21608-_SDA2_BASE_(r2)
...
/* 800C5FB4 000C2EF4  C0 02 8D 14 */	lfs f0, $$21797-_SDA2_BASE_(r2)
...
/* 800C6010 000C2F50  C0 42 8C F8 */	lfs f2, $$21627-_SDA2_BASE_(r2)
...
lbl_800C603C:
/* 800C603C 000C2F7C  C0 22 8C F8 */	lfs f1, $$21627-_SDA2_BASE_(r2)
...
/* 800C6074 000C2FB4  C0 02 8C E8 */	lfs f0, $$21608-_SDA2_BASE_(r2)
...
/* 800C6084 000C2FC4  C8 82 8D 20 */	lfd f4, $$21799-_SDA2_BASE_(r2)
/* 800C6088 000C2FC8  C8 02 8D 28 */	lfd f0, $$21800-_SDA2_BASE_(r2)
...
/* 800C60B8 000C2FF8  C8 42 8C F0 */	lfd f2, $$21611-_SDA2_BASE_(r2)
/* 800C60BC 000C2FFC  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C60C0 000C3000  C0 02 8D 00 */	lfs f0, $$21639-_SDA2_BASE_(r2)
...
lbl_800C60E4:
/* 800C60E4 000C3024  C0 42 8C E8 */	lfs f2, $$21608-_SDA2_BASE_(r2)
...
/* 800C6100 000C3040  C0 02 8D 04 */	lfs f0, $$21673-_SDA2_BASE_(r2)
/* 800C6104 000C3044  D0 01 00 3C */	stfs f0, 0x3c(r1)
/* 800C6108 000C3048  48 00 00 90 */	b lbl_800C6198
lbl_800C610C:
/* 800C610C 000C304C  C0 02 8D 08 */	lfs f0, $$21674-_SDA2_BASE_(r2)
...
/* 800C612C 000C306C  C8 42 8C F0 */	lfd f2, $$21611-_SDA2_BASE_(r2)
/* 800C6130 000C3070  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C6134 000C3074  C0 02 8D 00 */	lfs f0, $$21639-_SDA2_BASE_(r2)
...
/* 800C6168 000C30A8  C8 62 8C F0 */	lfd f3, $$21611-_SDA2_BASE_(r2)
/* 800C616C 000C30AC  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C6170 000C30B0  C0 22 8D 00 */	lfs f1, $$21639-_SDA2_BASE_(r2)
/* 800C6174 000C30B4  90 01 00 4C */	stw r0, 0x4c(r1)
/* 800C6178 000C30B8  3C 00 43 30 */	lis r0, 0x4330
/* 800C617C 000C30BC  C0 02 8D 0C */	lfs f0, $$21675-_SDA2_BASE_(r2)
...
/* 800C61C8 000C3108  C0 02 8C E8 */	lfs f0, $$21608-_SDA2_BASE_(r2)
...
/* 800C620C 000C314C  C0 62 8D 30 */	lfs f3, $$21884-_SDA2_BASE_(r2)
/* 800C6210 000C3150  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C6254 000C3194  C0 42 8D 30 */	lfs f2, $$21884-_SDA2_BASE_(r2)
/* 800C6258 000C3198  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C62A4 000C31E4  C0 42 8D 30 */	lfs f2, $$21884-_SDA2_BASE_(r2)
/* 800C62A8 000C31E8  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C62E8 000C3228  C0 62 8D 30 */	lfs f3, $$21884-_SDA2_BASE_(r2)
/* 800C62EC 000C322C  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C6350 000C3290  C0 42 8D 30 */	lfs f2, $$21884-_SDA2_BASE_(r2)
/* 800C6354 000C3294  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C6398 000C32D8  C0 42 8D 30 */	lfs f2, $$21884-_SDA2_BASE_(r2)
/* 800C639C 000C32DC  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C63EC 000C332C  C0 42 8D 30 */	lfs f2, $$21884-_SDA2_BASE_(r2)
/* 800C63F0 000C3330  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
...
/* 800C6434 000C3374  C0 42 8D 30 */	lfs f2, $$21884-_SDA2_BASE_(r2)
/* 800C6438 000C3378  C0 02 8D 10 */	lfs f0, $$21676-_SDA2_BASE_(r2)
