...
.global "SMSCalcJumpVelocityXZ__FRCQ29JGeometry8TVec3<f>RCQ29JGeometry8TVec3<f>ffPQ29JGeometry8TVec3<f>"
"SMSCalcJumpVelocityXZ__FRCQ29JGeometry8TVec3<f>RCQ29JGeometry8TVec3<f>ffPQ29JGeometry8TVec3<f>":
...
/* 800C5870 000C27B0  C0 02 8C E8 */	lfs f0, "@1608"@sda21(r2)
...
/* 800C5890 000C27D0  C8 42 8C F0 */	lfd f2, "@1611"@sda21(r2)
...
.global "SMSCalcJumpVelocityY__FRCQ29JGeometry8TVec3<f>RCQ29JGeometry8TVec3<f>fffPQ29JGeometry8TVec3<f>"
"SMSCalcJumpVelocityY__FRCQ29JGeometry8TVec3<f>RCQ29JGeometry8TVec3<f>fffPQ29JGeometry8TVec3<f>":
...
/* 800C5934 000C2874  C0 02 8C E8 */	lfs f0, "@1608"@sda21(r2)
...
/* 800C5974 000C28B4  C8 82 8C F0 */	lfd f4, "@1611"@sda21(r2)
/* 800C5978 000C28B8  90 01 00 2C */	stw r0, 0x2c(r1)
/* 800C597C 000C28BC  3C 00 43 30 */	lis r0, 0x4330
/* 800C5980 000C28C0  C0 C2 8C F8 */	lfs f6, "@1627"@sda21(r2)
...
.global "SMS_GoRotate__FRCQ29JGeometry8TVec3<f>RCQ29JGeometry8TVec3<f>fPf"
"SMS_GoRotate__FRCQ29JGeometry8TVec3<f>RCQ29JGeometry8TVec3<f>fPf":
...
/* 800C5A00 000C2940  C0 42 8C FC */	lfs f2, "@1638"@sda21(r2)
...
/* 800C5A6C 000C29AC  C8 22 8C F0 */	lfd f1, "@1611"@sda21(r2)
/* 800C5A70 000C29B0  7C 00 07 34 */	extsh r0, r0
/* 800C5A74 000C29B4  C0 42 8D 00 */	lfs f2, "@1639"@sda21(r2)
...
.global "MsIsInSight__FRCQ29JGeometry8TVec3<f>fRCQ29JGeometry8TVec3<f>fff"
"MsIsInSight__FRCQ29JGeometry8TVec3<f>fRCQ29JGeometry8TVec3<f>fff":
...
/* 800C5B58 000C2A98  C0 02 8C E8 */	lfs f0, "@1608"@sda21(r2)
...
/* 800C5B70 000C2AB0  C3 A2 8D 04 */	lfs f29, "@1673"@sda21(r2)
/* 800C5B74 000C2AB4  48 00 00 88 */	b lbl_800C5BFC
lbl_800C5B78:
/* 800C5B78 000C2AB8  C3 A2 8D 08 */	lfs f29, "@1674"@sda21(r2)
...
/* 800C5B98 000C2AD8  C8 42 8C F0 */	lfd f2, "@1611"@sda21(r2)
/* 800C5B9C 000C2ADC  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C5BA0 000C2AE0  C0 02 8D 00 */	lfs f0, "@1639"@sda21(r2)
...
/* 800C5BD0 000C2B10  C8 62 8C F0 */	lfd f3, "@1611"@sda21(r2)
/* 800C5BD4 000C2B14  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C5BD8 000C2B18  C0 22 8D 00 */	lfs f1, "@1639"@sda21(r2)
/* 800C5BDC 000C2B1C  90 01 00 44 */	stw r0, 0x44(r1)
/* 800C5BE0 000C2B20  3C 00 43 30 */	lis r0, 0x4330
/* 800C5BE4 000C2B24  C0 02 8D 0C */	lfs f0, "@1675"@sda21(r2)
...
lbl_800C5BFC:
/* 800C5BFC 000C2B3C  C0 02 8D 0C */	lfs f0, "@1675"@sda21(r2)
...
/* 800C5C0C 000C2B4C  48 00 00 45 */	bl "MsWrap<f>__Ffff"
/* 800C5C10 000C2B50  EC 3D 08 28 */	fsubs f1, f29, f1
/* 800C5C14 000C2B54  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C5CC0 000C2C00  C1 42 8C FC */	lfs f10, "@1638"@sda21(r2)
...
/* 800C5E9C 000C2DDC  C0 02 8C FC */	lfs f0, "@1638"@sda21(r2)
...
/* 800C5F78 000C2EB8  C0 02 8C E8 */	lfs f0, "@1608"@sda21(r2)
...
.global "MsGetRotFromZaxis__FRCQ29JGeometry8TVec3<f>"
"MsGetRotFromZaxis__FRCQ29JGeometry8TVec3<f>":
...
/* 800C5FA4 000C2EE4  C0 82 8C E8 */	lfs f4, "@1608"@sda21(r2)
...
/* 800C5FB4 000C2EF4  C0 02 8D 14 */	lfs f0, "@1797"@sda21(r2)
...
lbl_800C600C:
/* 800C600C 000C2F4C  4B FA 6D 65 */	bl "inv_sqrt__Q29JGeometry8TUtil<f>Ff"
/* 800C6010 000C2F50  C0 42 8C F8 */	lfs f2, "@1627"@sda21(r2)
...
lbl_800C603C:
/* 800C603C 000C2F7C  C0 22 8C F8 */	lfs f1, "@1627"@sda21(r2)
...
/* 800C6074 000C2FB4  C0 02 8C E8 */	lfs f0, "@1608"@sda21(r2)
...
/* 800C6084 000C2FC4  C8 82 8D 20 */	lfd f4, "@1799"@sda21(r2)
/* 800C6088 000C2FC8  C8 02 8D 28 */	lfd f0, "@1800"@sda21(r2)
...
/* 800C60B8 000C2FF8  C8 42 8C F0 */	lfd f2, "@1611"@sda21(r2)
/* 800C60BC 000C2FFC  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C60C0 000C3000  C0 02 8D 00 */	lfs f0, "@1639"@sda21(r2)
...
lbl_800C60E4:
/* 800C60E4 000C3024  C0 42 8C E8 */	lfs f2, "@1608"@sda21(r2)
...
/* 800C6100 000C3040  C0 02 8D 04 */	lfs f0, "@1673"@sda21(r2)
/* 800C6104 000C3044  D0 01 00 3C */	stfs f0, 0x3c(r1)
/* 800C6108 000C3048  48 00 00 90 */	b lbl_800C6198
lbl_800C610C:
/* 800C610C 000C304C  C0 02 8D 08 */	lfs f0, "@1674"@sda21(r2)
...
/* 800C612C 000C306C  C8 42 8C F0 */	lfd f2, "@1611"@sda21(r2)
/* 800C6130 000C3070  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C6134 000C3074  C0 02 8D 00 */	lfs f0, "@1639"@sda21(r2)
...
/* 800C6168 000C30A8  C8 62 8C F0 */	lfd f3, "@1611"@sda21(r2)
/* 800C616C 000C30AC  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C6170 000C30B0  C0 22 8D 00 */	lfs f1, "@1639"@sda21(r2)
/* 800C6174 000C30B4  90 01 00 4C */	stw r0, 0x4c(r1)
/* 800C6178 000C30B8  3C 00 43 30 */	lis r0, 0x4330
/* 800C617C 000C30BC  C0 02 8D 0C */	lfs f0, "@1675"@sda21(r2)
...
/* 800C61C8 000C3108  C0 02 8C E8 */	lfs f0, "@1608"@sda21(r2)
/* 800C61CC 000C310C  3C 60 80 3B */	lis r3, "@1431"@ha
/* 800C61D0 000C3110  38 63 21 88 */	addi r3, r3, "@1431"@l
...
/* 800C620C 000C314C  C0 62 8D 30 */	lfs f3, "@1884"@sda21(r2)
/* 800C6210 000C3150  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C6254 000C3194  C0 42 8D 30 */	lfs f2, "@1884"@sda21(r2)
/* 800C6258 000C3198  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C62A4 000C31E4  C0 42 8D 30 */	lfs f2, "@1884"@sda21(r2)
/* 800C62A8 000C31E8  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C62E8 000C3228  C0 62 8D 30 */	lfs f3, "@1884"@sda21(r2)
/* 800C62EC 000C322C  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C6350 000C3290  C0 42 8D 30 */	lfs f2, "@1884"@sda21(r2)
/* 800C6354 000C3294  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C6398 000C32D8  C0 42 8D 30 */	lfs f2, "@1884"@sda21(r2)
/* 800C639C 000C32DC  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C63EC 000C332C  C0 42 8D 30 */	lfs f2, "@1884"@sda21(r2)
/* 800C63F0 000C3330  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
...
/* 800C6434 000C3374  C0 42 8D 30 */	lfs f2, "@1884"@sda21(r2)
/* 800C6438 000C3378  C0 02 8D 10 */	lfs f0, "@1676"@sda21(r2)
