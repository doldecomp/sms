...
/* 8017C270 001791B0  80 6D 99 F4 */	lwz r3, MSGMSound-_SDA_BASE_(r13)
...
/* 8017C2E8 00179228  80 8D 8F B0 */	lwz r4, random__8JAIConst-_SDA_BASE_(r13)
/* 8017C2EC 0017922C  38 03 66 0D */	addi r0, r3, 0x0019660D@l
/* 8017C2F0 00179230  C8 62 AA 10 */	lfd f3, $$21987-_SDA2_BASE_(r2)
/* 8017C2F4 00179234  7C 64 01 D6 */	mullw r3, r4, r0
/* 8017C2F8 00179238  C0 02 A9 F8 */	lfs f0, $$21981-_SDA2_BASE_(r2)
...
/* 8017C30C 0017924C  90 0D 8F B0 */	stw r0, random__8JAIConst-_SDA_BASE_(r13)
/* 8017C310 00179250  54 83 86 3E */	rlwinm r3, r4, 0x10, 0x18, 0x1f
/* 8017C314 00179254  38 03 00 01 */	addi r0, r3, 1
/* 8017C318 00179258  80 6D 8F B0 */	lwz r3, random__8JAIConst-_SDA_BASE_(r13)
...
/* 8017C3B0 001792F0  C3 E2 A9 F8 */	lfs f31, $$21981-_SDA2_BASE_(r2)
/* 8017C3B4 001792F4  83 7D 00 04 */	lwz r27, 4(r29)
/* 8017C3B8 001792F8  80 6D 99 F4 */	lwz r3, MSGMSound-_SDA_BASE_(r13)
...
/* 8017C3C8 00179308  80 6D 99 F4 */	lwz r3, MSGMSound-_SDA_BASE_(r13)
/* 8017C3CC 0017930C  C0 3B 00 04 */	lfs f1, 4(r27)
/* 8017C3D0 00179310  83 A3 00 AC */	lwz r29, 0xac(r3)
/* 8017C3D4 00179314  C0 42 A9 FC */	lfs f2, $$21982-_SDA2_BASE_(r2)
...
/* 8017C3F0 00179330  C0 42 A9 FC */	lfs f2, $$21982-_SDA2_BASE_(r2)
...
/* 8017C408 00179348  C0 42 A9 FC */	lfs f2, $$21982-_SDA2_BASE_(r2)
...
lbl_8017C424:
/* 8017C424 00179364  C0 22 AA 00 */	lfs f1, $$21983-_SDA2_BASE_(r2)
lbl_8017C428:
/* 8017C428 00179368  C0 02 AA 00 */	lfs f0, $$21983-_SDA2_BASE_(r2)
...
/* 8017C43C 0017937C  C0 42 AA 04 */	lfs f2, $$21984-_SDA2_BASE_(r2)
/* 8017C440 00179380  54 00 28 34 */	slwi r0, r0, 5
/* 8017C444 00179384  C0 62 AA 08 */	lfs f3, $$21985-_SDA2_BASE_(r2)
...
/* 8017C540 00179480  80 6D 99 F4 */	lwz r3, MSGMSound-_SDA_BASE_(r13)
...
/* 8017C5B8 001794F8  80 6D 99 F4 */	lwz r3, MSGMSound-_SDA_BASE_(r13)
...
/* 8017C62C 0017956C  80 8D 8F A0 */	lwz r4, basic__8JAIBasic-_SDA_BASE_(r13)
...
/* 8017C6C8 00179608  88 0D 97 CC */	lbz r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
/* 8017C6CC 0017960C  7C 00 07 75 */	extsb. r0, r0
/* 8017C6D0 00179610  40 82 00 28 */	bne lbl_8017C6F8
/* 8017C6D4 00179614  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
...
/* 8017C6E4 00179624  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
...
/* 8017C6F4 00179634  98 0D 97 CC */	stb r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
lbl_8017C6F8:
/* 8017C6F8 00179638  88 0D 97 CD */	lbz r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
/* 8017C6FC 0017963C  7C 00 07 75 */	extsb. r0, r0
/* 8017C700 00179640  40 82 00 28 */	bne lbl_8017C728
/* 8017C704 00179644  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
...
/* 8017C714 00179654  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
...
/* 8017C724 00179664  98 0D 97 CD */	stb r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
lbl_8017C728:
/* 8017C728 00179668  88 0D 97 CE */	lbz r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
/* 8017C72C 0017966C  7C 00 07 75 */	extsb. r0, r0
/* 8017C730 00179670  40 82 00 28 */	bne lbl_8017C758
/* 8017C734 00179674  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
...
/* 8017C744 00179684  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
...
/* 8017C754 00179694  98 0D 97 CE */	stb r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
lbl_8017C758:
/* 8017C758 00179698  88 0D 8F 8C */	lbz r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
/* 8017C75C 0017969C  7C 00 07 75 */	extsb. r0, r0
/* 8017C760 001796A0  40 82 00 28 */	bne lbl_8017C788
/* 8017C764 001796A4  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
...
/* 8017C774 001796B4  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
...
/* 8017C784 001796C4  98 0D 8F 8C */	stb r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
lbl_8017C788:
/* 8017C788 001796C8  88 0D 8F 8D */	lbz r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
/* 8017C78C 001796CC  7C 00 07 75 */	extsb. r0, r0
/* 8017C790 001796D0  40 82 00 28 */	bne lbl_8017C7B8
/* 8017C794 001796D4  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
...
/* 8017C7A4 001796E4  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
...
/* 8017C7B4 001796F4  98 0D 8F 8D */	stb r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
lbl_8017C7B8:
/* 8017C7B8 001796F8  88 0D 8F 8E */	lbz r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
/* 8017C7BC 001796FC  7C 00 07 75 */	extsb. r0, r0
/* 8017C7C0 00179700  40 82 00 28 */	bne lbl_8017C7E8
/* 8017C7C4 00179704  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
...
/* 8017C7D4 00179714  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
...
/* 8017C7E4 00179724  98 0D 8F 8E */	stb r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
lbl_8017C7E8:
/* 8017C7E8 00179728  88 0D 8F 8F */	lbz r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
/* 8017C7EC 0017972C  7C 00 07 75 */	extsb. r0, r0
/* 8017C7F0 00179730  40 82 00 28 */	bne lbl_8017C818
/* 8017C7F4 00179734  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
...
/* 8017C804 00179744  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
...
/* 8017C814 00179754  98 0D 8F 8F */	stb r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
lbl_8017C818:
/* 8017C818 00179758  88 0D 8F 90 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
/* 8017C81C 0017975C  7C 00 07 75 */	extsb. r0, r0
/* 8017C820 00179760  40 82 00 28 */	bne lbl_8017C848
/* 8017C824 00179764  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
...
/* 8017C834 00179774  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
...
/* 8017C844 00179784  98 0D 8F 90 */	stb r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
lbl_8017C848:
/* 8017C848 00179788  88 0D 8F 91 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
/* 8017C84C 0017978C  7C 00 07 75 */	extsb. r0, r0
/* 8017C850 00179790  40 82 00 28 */	bne lbl_8017C878
/* 8017C854 00179794  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
...
/* 8017C864 001797A4  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
...
/* 8017C874 001797B4  98 0D 8F 91 */	stb r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
lbl_8017C878:
/* 8017C878 001797B8  88 0D 8F 92 */	lbz r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
/* 8017C87C 001797BC  7C 00 07 75 */	extsb. r0, r0
/* 8017C880 001797C0  40 82 00 28 */	bne lbl_8017C8A8
/* 8017C884 001797C4  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
...
/* 8017C894 001797D4  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
...
/* 8017C8A4 001797E4  98 0D 8F 92 */	stb r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
lbl_8017C8A8:
/* 8017C8A8 001797E8  88 0D 8F 93 */	lbz r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
/* 8017C8AC 001797EC  7C 00 07 75 */	extsb. r0, r0
/* 8017C8B0 001797F0  40 82 00 28 */	bne lbl_8017C8D8
/* 8017C8B4 001797F4  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
...
/* 8017C8C4 00179804  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
...
/* 8017C8D4 00179814  98 0D 8F 93 */	stb r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
lbl_8017C8D8:
/* 8017C8D8 00179818  88 0D 8F 94 */	lbz r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
/* 8017C8DC 0017981C  7C 00 07 75 */	extsb. r0, r0
/* 8017C8E0 00179820  40 82 00 28 */	bne lbl_8017C908
/* 8017C8E4 00179824  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
...
/* 8017C8F4 00179834  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
...
/* 8017C904 00179844  98 0D 8F 94 */	stb r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
lbl_8017C908:
/* 8017C908 00179848  88 0D 8F 95 */	lbz r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
/* 8017C90C 0017984C  7C 00 07 75 */	extsb. r0, r0
/* 8017C910 00179850  40 82 00 28 */	bne lbl_8017C938
/* 8017C914 00179854  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
...
/* 8017C924 00179864  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
...
/* 8017C934 00179874  98 0D 8F 95 */	stb r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
lbl_8017C938:
/* 8017C938 00179878  88 0D 8F 96 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
/* 8017C93C 0017987C  7C 00 07 75 */	extsb. r0, r0
/* 8017C940 00179880  40 82 00 28 */	bne lbl_8017C968
/* 8017C944 00179884  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
...
/* 8017C954 00179894  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
...
/* 8017C964 001798A4  98 0D 8F 96 */	stb r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
lbl_8017C968:
/* 8017C968 001798A8  88 0D 8F 97 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
/* 8017C96C 001798AC  7C 00 07 75 */	extsb. r0, r0
/* 8017C970 001798B0  40 82 00 28 */	bne lbl_8017C998
/* 8017C974 001798B4  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
...
/* 8017C984 001798C4  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
...
/* 8017C994 001798D4  98 0D 8F 97 */	stb r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
lbl_8017C998:
