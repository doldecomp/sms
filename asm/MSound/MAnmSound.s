...
/* 8017C2F0 00179230  C8 62 AA 10 */	lfd f3, "@1987"@sda21(r2)
/* 8017C2F4 00179234  7C 64 01 D6 */	mullw r3, r4, r0
/* 8017C2F8 00179238  C0 02 A9 F8 */	lfs f0, "@1981"@sda21(r2)
...
/* 8017C3B0 001792F0  C3 E2 A9 F8 */	lfs f31, "@1981"@sda21(r2)
...
/* 8017C3D4 00179314  C0 42 A9 FC */	lfs f2, "@1982"@sda21(r2)
...
/* 8017C3F0 00179330  C0 42 A9 FC */	lfs f2, "@1982"@sda21(r2)
...
/* 8017C408 00179348  C0 42 A9 FC */	lfs f2, "@1982"@sda21(r2)
...
lbl_8017C424:
/* 8017C424 00179364  C0 22 AA 00 */	lfs f1, "@1983"@sda21(r2)
lbl_8017C428:
/* 8017C428 00179368  C0 02 AA 00 */	lfs f0, "@1983"@sda21(r2)
...
/* 8017C43C 0017937C  C0 42 AA 04 */	lfs f2, "@1984"@sda21(r2)
/* 8017C440 00179380  54 00 28 34 */	slwi r0, r0, 5
/* 8017C444 00179384  C0 62 AA 08 */	lfs f3, "@1985"@sda21(r2)
...
/* 8017C6B4 001795F4  3C 60 80 3F */	lis r3, "@2044"@ha
...
/* 8017C6C4 00179604  3B E3 44 D0 */	addi r31, r3, "@2044"@l
/* 8017C6C8 00179608  88 0D 97 CC */	lbz r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
/* 8017C6CC 0017960C  7C 00 07 75 */	extsb. r0, r0
/* 8017C6D0 00179610  40 82 00 28 */	bne lbl_8017C6F8
/* 8017C6D4 00179614  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
/* 8017C6D8 00179618  4B E9 25 5D */	bl initiate__10JSUPtrListFv
/* 8017C6DC 0017961C  3C 60 80 0E */	lis r3, "__dt__15JSUList<5MSBgm>Fv"@ha
/* 8017C6E0 00179620  38 83 6A 44 */	addi r4, r3, "__dt__15JSUList<5MSBgm>Fv"@l
/* 8017C6E4 00179624  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
...
/* 8017C6F4 00179634  98 0D 97 CC */	stb r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
lbl_8017C6F8:
/* 8017C6F8 00179638  88 0D 97 CD */	lbz r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
/* 8017C6FC 0017963C  7C 00 07 75 */	extsb. r0, r0
/* 8017C700 00179640  40 82 00 28 */	bne lbl_8017C728
/* 8017C704 00179644  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
/* 8017C708 00179648  4B E9 25 2D */	bl initiate__10JSUPtrListFv
/* 8017C70C 0017964C  3C 60 80 0E */	lis r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@ha
/* 8017C710 00179650  38 83 69 EC */	addi r4, r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@l
/* 8017C714 00179654  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
...
/* 8017C724 00179664  98 0D 97 CD */	stb r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
lbl_8017C728:
/* 8017C728 00179668  88 0D 97 CE */	lbz r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
/* 8017C72C 0017966C  7C 00 07 75 */	extsb. r0, r0
/* 8017C730 00179670  40 82 00 28 */	bne lbl_8017C758
/* 8017C734 00179674  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
/* 8017C738 00179678  4B E9 24 FD */	bl initiate__10JSUPtrListFv
/* 8017C73C 0017967C  3C 60 80 0E */	lis r3, "__dt__21JSUList<10MSSetSound>Fv"@ha
/* 8017C740 00179680  38 83 69 94 */	addi r4, r3, "__dt__21JSUList<10MSSetSound>Fv"@l
/* 8017C744 00179684  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
...
/* 8017C754 00179694  98 0D 97 CE */	stb r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
lbl_8017C758:
/* 8017C758 00179698  88 0D 8F 8C */	lbz r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
/* 8017C75C 0017969C  7C 00 07 75 */	extsb. r0, r0
/* 8017C760 001796A0  40 82 00 28 */	bne lbl_8017C788
/* 8017C764 001796A4  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
/* 8017C768 001796A8  4B E9 24 CD */	bl initiate__10JSUPtrListFv
/* 8017C76C 001796AC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@ha
/* 8017C770 001796B0  38 83 A8 0C */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@l
/* 8017C774 001796B4  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
...
/* 8017C784 001796C4  98 0D 8F 8C */	stb r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
lbl_8017C788:
/* 8017C788 001796C8  88 0D 8F 8D */	lbz r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
/* 8017C78C 001796CC  7C 00 07 75 */	extsb. r0, r0
/* 8017C790 001796D0  40 82 00 28 */	bne lbl_8017C7B8
/* 8017C794 001796D4  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
/* 8017C798 001796D8  4B E9 24 9D */	bl initiate__10JSUPtrListFv
/* 8017C79C 001796DC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@ha
/* 8017C7A0 001796E0  38 83 A7 B4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@l
/* 8017C7A4 001796E4  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
...
/* 8017C7B4 001796F4  98 0D 8F 8D */	stb r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
lbl_8017C7B8:
/* 8017C7B8 001796F8  88 0D 8F 8E */	lbz r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
/* 8017C7BC 001796FC  7C 00 07 75 */	extsb. r0, r0
/* 8017C7C0 00179700  40 82 00 28 */	bne lbl_8017C7E8
/* 8017C7C4 00179704  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
/* 8017C7C8 00179708  4B E9 24 6D */	bl initiate__10JSUPtrListFv
/* 8017C7CC 0017970C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@ha
/* 8017C7D0 00179710  38 83 A7 5C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@l
/* 8017C7D4 00179714  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
...
/* 8017C7E4 00179724  98 0D 8F 8E */	stb r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
lbl_8017C7E8:
/* 8017C7E8 00179728  88 0D 8F 8F */	lbz r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
/* 8017C7EC 0017972C  7C 00 07 75 */	extsb. r0, r0
/* 8017C7F0 00179730  40 82 00 28 */	bne lbl_8017C818
/* 8017C7F4 00179734  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
/* 8017C7F8 00179738  4B E9 24 3D */	bl initiate__10JSUPtrListFv
/* 8017C7FC 0017973C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@ha
/* 8017C800 00179740  38 83 A7 04 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@l
/* 8017C804 00179744  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
...
/* 8017C814 00179754  98 0D 8F 8F */	stb r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
lbl_8017C818:
/* 8017C818 00179758  88 0D 8F 90 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
/* 8017C81C 0017975C  7C 00 07 75 */	extsb. r0, r0
/* 8017C820 00179760  40 82 00 28 */	bne lbl_8017C848
/* 8017C824 00179764  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
/* 8017C828 00179768  4B E9 24 0D */	bl initiate__10JSUPtrListFv
/* 8017C82C 0017976C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@ha
/* 8017C830 00179770  38 83 A6 AC */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@l
/* 8017C834 00179774  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
...
/* 8017C844 00179784  98 0D 8F 90 */	stb r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
lbl_8017C848:
/* 8017C848 00179788  88 0D 8F 91 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
/* 8017C84C 0017978C  7C 00 07 75 */	extsb. r0, r0
/* 8017C850 00179790  40 82 00 28 */	bne lbl_8017C878
/* 8017C854 00179794  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
/* 8017C858 00179798  4B E9 23 DD */	bl initiate__10JSUPtrListFv
/* 8017C85C 0017979C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@ha
/* 8017C860 001797A0  38 83 A6 54 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@l
/* 8017C864 001797A4  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
...
/* 8017C874 001797B4  98 0D 8F 91 */	stb r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
lbl_8017C878:
/* 8017C878 001797B8  88 0D 8F 92 */	lbz r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
/* 8017C87C 001797BC  7C 00 07 75 */	extsb. r0, r0
/* 8017C880 001797C0  40 82 00 28 */	bne lbl_8017C8A8
/* 8017C884 001797C4  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
/* 8017C888 001797C8  4B E9 23 AD */	bl initiate__10JSUPtrListFv
/* 8017C88C 001797CC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@ha
/* 8017C890 001797D0  38 83 A5 FC */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@l
/* 8017C894 001797D4  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
...
/* 8017C8A4 001797E4  98 0D 8F 92 */	stb r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
lbl_8017C8A8:
/* 8017C8A8 001797E8  88 0D 8F 93 */	lbz r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
/* 8017C8AC 001797EC  7C 00 07 75 */	extsb. r0, r0
/* 8017C8B0 001797F0  40 82 00 28 */	bne lbl_8017C8D8
/* 8017C8B4 001797F4  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
/* 8017C8B8 001797F8  4B E9 23 7D */	bl initiate__10JSUPtrListFv
/* 8017C8BC 001797FC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@ha
/* 8017C8C0 00179800  38 83 A5 A4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@l
/* 8017C8C4 00179804  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
...
/* 8017C8D4 00179814  98 0D 8F 93 */	stb r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
lbl_8017C8D8:
/* 8017C8D8 00179818  88 0D 8F 94 */	lbz r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
/* 8017C8DC 0017981C  7C 00 07 75 */	extsb. r0, r0
/* 8017C8E0 00179820  40 82 00 28 */	bne lbl_8017C908
/* 8017C8E4 00179824  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
/* 8017C8E8 00179828  4B E9 23 4D */	bl initiate__10JSUPtrListFv
/* 8017C8EC 0017982C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@ha
/* 8017C8F0 00179830  38 83 A5 4C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@l
/* 8017C8F4 00179834  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
...
/* 8017C904 00179844  98 0D 8F 94 */	stb r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
lbl_8017C908:
/* 8017C908 00179848  88 0D 8F 95 */	lbz r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
/* 8017C90C 0017984C  7C 00 07 75 */	extsb. r0, r0
/* 8017C910 00179850  40 82 00 28 */	bne lbl_8017C938
/* 8017C914 00179854  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
/* 8017C918 00179858  4B E9 23 1D */	bl initiate__10JSUPtrListFv
/* 8017C91C 0017985C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@ha
/* 8017C920 00179860  38 83 A4 F4 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@l
/* 8017C924 00179864  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
...
/* 8017C934 00179874  98 0D 8F 95 */	stb r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
lbl_8017C938:
/* 8017C938 00179878  88 0D 8F 96 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
/* 8017C93C 0017987C  7C 00 07 75 */	extsb. r0, r0
/* 8017C940 00179880  40 82 00 28 */	bne lbl_8017C968
/* 8017C944 00179884  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
/* 8017C948 00179888  4B E9 22 ED */	bl initiate__10JSUPtrListFv
/* 8017C94C 0017988C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@ha
/* 8017C950 00179890  38 83 A4 9C */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@l
/* 8017C954 00179894  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
...
/* 8017C964 001798A4  98 0D 8F 96 */	stb r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
lbl_8017C968:
/* 8017C968 001798A8  88 0D 8F 97 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
/* 8017C96C 001798AC  7C 00 07 75 */	extsb. r0, r0
/* 8017C970 001798B0  40 82 00 28 */	bne lbl_8017C998
/* 8017C974 001798B4  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
/* 8017C978 001798B8  4B E9 22 BD */	bl initiate__10JSUPtrListFv
/* 8017C97C 001798BC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@ha
/* 8017C980 001798C0  38 83 A4 44 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@l
/* 8017C984 001798C4  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
...
/* 8017C994 001798D4  98 0D 8F 97 */	stb r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
lbl_8017C998:
