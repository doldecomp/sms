...
/* 800AB358 000A8298  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
lbl_800AB424:
/* 800AB424 000A8364  C0 42 8B 50 */	lfs f2, $$245-_SDA2_BASE_(r2)
...
/* 800AB478 000A83B8  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB55C:
/* 800AB55C 000A849C  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AB580 000A84C0  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AB598 000A84D8  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AB5B4 000A84F4  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB5C4:
/* 800AB5C4 000A8504  80 ED 82 C8 */	lwz r7, gx-_SDA_BASE_(r13)
...
/* 800AB5E8 000A8528  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AB600 000A8540  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AB61C 000A855C  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB62C:
/* 800AB62C 000A856C  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AB650 000A8590  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AB668 000A85A8  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AB684 000A85C4  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB694:
/* 800AB694 000A85D4  80 ED 82 C8 */	lwz r7, gx-_SDA_BASE_(r13)
...
/* 800AB6B8 000A85F8  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AB6D0 000A8610  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AB6EC 000A862C  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
/* 800AB6F0 000A8630  80 03 01 2C */	lwz r0, 0x12c(r3)
/* 800AB6F4 000A8634  90 04 80 00 */	stw r0, -0x8000(r4)
lbl_800AB6F8:
/* 800AB6F8 000A8638  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB730:
/* 800AB730 000A8670  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AB74C 000A868C  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB768:
/* 800AB768 000A86A8  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AB784 000A86C4  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB7A0:
/* 800AB7A0 000A86E0  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AB7BC 000A86FC  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB7D8:
/* 800AB7D8 000A8718  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AB7F4 000A8734  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AB810 000A8750  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AB834 000A8774  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
/* 800AB838 000A8778  B0 03 00 02 */	sth r0, 2(r3)
/* 800AB83C 000A877C  4E 80 00 20 */	blr 

.global GXSetNumIndStages
GXSetNumIndStages:
/* 800AB840 000A8780  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AB858 000A8798  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
__GXUpdateBPMask:
/* 800AB918 000A8858  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AB9D0 000A8910  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AB9E8 000A8928  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
