...
/* 800A5764 000A26A4  80 82 8A D0 */	lwz r4, $$2121@sda21(r2)
/* 800A5768 000A26A8  80 62 8A D4 */	lwz r3, $$2122@sda21(r2)
/* 800A576C 000A26AC  80 02 8A D8 */	lwz r0, $$2123@sda21(r2)
...
/* 800A59C0 000A2900  C0 22 8A DC */	lfs f1, $$2177@sda21(r2)
/* 800A59C4 000A2904  38 61 00 2C */	addi r3, r1, 0x2c
/* 800A59C8 000A2908  C0 02 8A E0 */	lfs f0, $$2178@sda21(r2)
...
/* 800A5A48 000A2988  C0 22 8A E0 */	lfs f1, $$2178@sda21(r2)
/* 800A5A4C 000A298C  90 01 00 64 */	stw r0, 0x64(r1)
/* 800A5A50 000A2990  C8 82 8A E8 */	lfd f4, $$2181@sda21(r2)
...
/* 800A5A60 000A29A0  C0 C2 8A DC */	lfs f6, $$2177@sda21(r2)
...
/* 800A5E04 000A2D44  C0 42 8A DC */	lfs f2, $$2177@sda21(r2)
...
/* 800A5E1C 000A2D5C  C0 22 8A E0 */	lfs f1, $$2178@sda21(r2)
/* 800A5E20 000A2D60  C0 62 8A E4 */	lfs f3, $$2179@sda21(r2)
...
/* 800A5EF8 000A2E38  C8 42 8A E8 */	lfd f2, $$2181@sda21(r2)
