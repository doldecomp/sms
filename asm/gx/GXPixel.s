...
lbl_800AC470:
/* 800AC470 000A93B0  C0 62 8B 58 */	lfs f3, $$2125-_SDA2_BASE_(r2)
/* 800AC474 000A93B4  C0 82 8B 5C */	lfs f4, $$2126-_SDA2_BASE_(r2)
...
lbl_800AC49C:
/* 800AC49C 000A93DC  C0 22 8B 5C */	lfs f1, $$2126-_SDA2_BASE_(r2)
/* 800AC4A0 000A93E0  38 60 00 00 */	li r3, 0
/* 800AC4A4 000A93E4  C8 02 8B 60 */	lfd f0, $$2127-_SDA2_BASE_(r2)
...
/* 800AC4BC 000A93FC  C8 02 8B 70 */	lfd f0, $$2129-_SDA2_BASE_(r2)
/* 800AC4C0 000A9400  C0 42 8B 68 */	lfs f2, $$2128-_SDA2_BASE_(r2)
/* 800AC4C4 000A9404  C0 22 8B 58 */	lfs f1, $$2125-_SDA2_BASE_(r2)
...
/* 800AC4E8 000A9428  C0 02 8B 78 */	lfs f0, $$2130-_SDA2_BASE_(r2)
/* 800AC4EC 000A942C  38 00 00 01 */	li r0, 1
/* 800AC4F0 000A9430  C8 42 8B 80 */	lfd f2, $$2132-_SDA2_BASE_(r2)
...
/* 800AC554 000A9494  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AC6B8 000A95F8  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
lbl_800AC708:
/* 800AC708 000A9648  81 0D 82 C8 */	lwz r8, gx-_SDA_BASE_(r13)
...
/* 800AC734 000A9674  81 2D 82 C8 */	lwz r9, gx-_SDA_BASE_(r13)
...
/* 800AC75C 000A969C  81 2D 82 C8 */	lwz r9, gx-_SDA_BASE_(r13)
...
/* 800AC77C 000A96BC  81 0D 82 C8 */	lwz r8, gx-_SDA_BASE_(r13)
...
/* 800AC794 000A96D4  80 ED 82 C8 */	lwz r7, gx-_SDA_BASE_(r13)
...
/* 800AC7AC 000A96EC  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AC7C4 000A9704  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AC7E0 000A9720  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
GXSetColorUpdate:
/* 800AC7F4 000A9734  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AC820 000A9760  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
GXSetAlphaUpdate:
/* 800AC834 000A9774  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AC860 000A97A0  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
.global GXSetZMode
GXSetZMode:
/* 800AC874 000A97B4  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AC89C 000A97DC  80 ED 82 C8 */	lwz r7, gx-_SDA_BASE_(r13)
...
/* 800AC8BC 000A97FC  80 CD 82 C8 */	lwz r6, gx-_SDA_BASE_(r13)
...
/* 800AC8D8 000A9818  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
GXSetZCompLoc:
/* 800AC8EC 000A982C  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AC918 000A9858  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
GXSetPixelFmt:
/* 800AC92C 000A986C  80 ED 82 C8 */	lwz r7, gx-_SDA_BASE_(r13)
...
/* 800AC95C 000A989C  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AC974 000A98B4  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
lbl_800AC9A8:
/* 800AC9A8 000A98E8  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AC9C4 000A9904  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AC9E0 000A9920  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800ACA04 000A9944  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800ACA20 000A9960  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
/* 800ACA24 000A9964  80 03 01 D4 */	lwz r0, 0x1d4(r3)
/* 800ACA28 000A9968  90 04 80 00 */	stw r0, -0x8000(r4)
lbl_800ACA2C:
/* 800ACA2C 000A996C  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
.global GXSetDither
GXSetDither:
/* 800ACA3C 000A997C  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800ACA68 000A99A8  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
GXSetDstAlpha:
/* 800ACA7C 000A99BC  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800ACAA0 000A99E0  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800ACABC 000A99FC  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800ACAD4 000A9A14  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800ACB30 000A9A70  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800ACB48 000A9A88  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
