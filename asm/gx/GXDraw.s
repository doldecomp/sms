...
/* 800ACC08 000A9B48  C8 62 8B A0 */	lfd f3, $$2364-_SDA2_BASE_(r2)
/* 800ACC0C 000A9B4C  C0 82 8B 90 */	lfs f4, $$2358-_SDA2_BASE_(r2)
/* 800ACC10 000A9B50  EC 42 18 28 */	fsubs f2, f2, f3
/* 800ACC14 000A9B54  C0 22 8B A8 */	lfs f1, $$2405-_SDA2_BASE_(r2)
...
/* 800ACCBC 000A9BFC  CB 42 8B 98 */	lfd f26, $$2362-_SDA2_BASE_(r2)
/* 800ACCC0 000A9C00  38 17 00 01 */	addi r0, r23, 1
/* 800ACCC4 000A9C04  C3 82 8B 8C */	lfs f28, $$2357-_SDA2_BASE_(r2)
/* 800ACCC8 000A9C08  CB C2 8B A0 */	lfd f30, $$2364-_SDA2_BASE_(r2)
...
/* 800ACF40 000A9E80  C3 E2 8B AC */	lfs f31, $$2493-_SDA2_BASE_(r2)
...
/* 800ACFA0 000A9EE0  C3 E2 8B AC */	lfs f31, $$2493-_SDA2_BASE_(r2)
...
/* 800AD020 000A9F60  C3 C2 8B AC */	lfs f30, $$2493-_SDA2_BASE_(r2)
...
/* 800AD090 000A9FD0  C1 A2 8B AC */	lfs f13, $$2493-_SDA2_BASE_(r2)
...
/* 800AD24C 000AA18C  C0 02 8B 94 */	lfs f0, $$2360-_SDA2_BASE_(r2)
/* 800AD250 000AA190  D0 01 00 08 */	stfs f0, 8(r1)
/* 800AD254 000AA194  C0 42 8B 88 */	lfs f2, $$2133-_SDA2_BASE_(r2)
/* 800AD258 000AA198  C0 22 8B 8C */	lfs f1, $$2357-_SDA2_BASE_(r2)
...
/* 800AD280 000AA1C0  C0 02 8B 8C */	lfs f0, $$2357-_SDA2_BASE_(r2)
/* 800AD284 000AA1C4  D0 01 00 08 */	stfs f0, 8(r1)
/* 800AD288 000AA1C8  C0 22 8B 88 */	lfs f1, $$2133-_SDA2_BASE_(r2)
/* 800AD28C 000AA1CC  C0 42 8B 94 */	lfs f2, $$2360-_SDA2_BASE_(r2)
