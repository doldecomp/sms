...
GXInitLightDistAttn:
/* 800A9980 000A68C0  C0 02 8B 00 */	lfs f0, $$2121-_SDA2_BASE_(r2)
...
lbl_800A9990:
/* 800A9990 000A68D0  C0 02 8B 00 */	lfs f0, $$2121-_SDA2_BASE_(r2)
...
/* 800A99A0 000A68E0  C0 02 8B 04 */	lfs f0, $$2127-_SDA2_BASE_(r2)
...
lbl_800A99DC:
/* 800A99DC 000A691C  C0 A2 8B 04 */	lfs f5, $$2127-_SDA2_BASE_(r2)
/* 800A99E0 000A6920  EC 02 00 72 */	fmuls f0, f2, f1
/* 800A99E4 000A6924  C0 82 8B 00 */	lfs f4, $$2121-_SDA2_BASE_(r2)
...
lbl_800A99F4:
/* 800A99F4 000A6934  C0 A2 8B 04 */	lfs f5, $$2127-_SDA2_BASE_(r2)
/* 800A99F8 000A6938  EC 82 00 72 */	fmuls f4, f2, f1
/* 800A99FC 000A693C  C0 62 8B 08 */	lfs f3, $$2148-_SDA2_BASE_(r2)
...
/* 800A9A1C 000A695C  C0 A2 8B 04 */	lfs f5, $$2127-_SDA2_BASE_(r2)
/* 800A9A20 000A6960  C0 62 8B 00 */	lfs f3, $$2121-_SDA2_BASE_(r2)
...
lbl_800A9A34:
/* 800A9A34 000A6974  C0 62 8B 00 */	lfs f3, $$2121-_SDA2_BASE_(r2)
/* 800A9A38 000A6978  C0 A2 8B 04 */	lfs f5, $$2127-_SDA2_BASE_(r2)
...
/* 800A9A6C 000A69AC  C0 A2 8B 04 */	lfs f5, $$2127-_SDA2_BASE_(r2)
/* 800A9A70 000A69B0  EC C0 00 32 */	fmuls f6, f0, f0
/* 800A9A74 000A69B4  C0 82 8B 00 */	lfs f4, $$2121-_SDA2_BASE_(r2)
...
/* 800A9A98 000A69D8  C8 E2 8B 10 */	lfd f7, $$2165-_SDA2_BASE_(r2)
/* 800A9A9C 000A69DC  C8 C2 8B 18 */	lfd f6, $$2166-_SDA2_BASE_(r2)
...
lbl_800A9AEC:
/* 800A9AEC 000A6A2C  C0 82 8B 04 */	lfs f4, $$2127-_SDA2_BASE_(r2)
...
/* 800A9B10 000A6A50  C0 82 8B 20 */	lfs f4, $$2167-_SDA2_BASE_(r2)
...
/* 800A9C34 000A6B74  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
lbl_800A9D08:
/* 800A9D08 000A6C48  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800A9D3C:
/* 800A9D3C 000A6C7C  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800A9D70:
/* 800A9D70 000A6CB0  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800A9D88:
/* 800A9D88 000A6CC8  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800A9E08 000A6D48  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800A9E2C 000A6D6C  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800A9E70:
/* 800A9E70 000A6DB0  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800A9EA4:
/* 800A9EA4 000A6DE4  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800A9ED8:
/* 800A9ED8 000A6E18  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800A9EF0:
/* 800A9EF0 000A6E30  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800A9F70 000A6EB0  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800A9F94 000A6ED4  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
GXSetNumChans:
/* 800A9FA4 000A6EE4  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800A9FD4 000A6F14  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AA12C 000A706C  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
.global $$2121
$$2121:
	.incbin "baserom.dol", 0x3E4800, 0x4
.global $$2127
$$2127:
