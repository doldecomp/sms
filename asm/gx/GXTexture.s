...
/* 800AA4E0 000A7420  C8 22 8B 30 */	lfd f1, $$2166-_SDA2_BASE_(r2)
/* 800AA4E4 000A7424  54 63 06 1E */	rlwinm r3, r3, 0, 0x18, 0xf
/* 800AA4E8 000A7428  C8 01 00 38 */	lfd f0, 0x38(r1)
/* 800AA4EC 000A742C  C0 42 8B 28 */	lfs f2, $$2164-_SDA2_BASE_(r2)
...
/* 800AA6B8 000A75F8  C0 02 8B 38 */	lfs f0, $$2192-_SDA2_BASE_(r2)
...
lbl_800AA6CC:
/* 800AA6CC 000A760C  C0 02 8B 3C */	lfs f0, $$2193-_SDA2_BASE_(r2)
...
/* 800AA6DC 000A761C  C0 62 8B 40 */	lfs f3, $$2194-_SDA2_BASE_(r2)
lbl_800AA6E0:
/* 800AA6E0 000A7620  C0 02 8B 44 */	lfs f0, $$2195-_SDA2_BASE_(r2)
...
/* 800AA730 000A7670  38 AD 82 E0 */	addi r5, r13, GX2HWFiltConv-_SDA_BASE_
...
/* 800AA7B0 000A76F0  C0 02 8B 48 */	lfs f0, $$2196-_SDA2_BASE_(r2)
...
lbl_800AA7C4:
/* 800AA7C4 000A7704  C0 02 8B 4C */	lfs f0, $$2197-_SDA2_BASE_(r2)
...
lbl_800AA7D4:
/* 800AA7D4 000A7714  C0 62 8B 28 */	lfs f3, $$2164-_SDA2_BASE_(r2)
/* 800AA7D8 000A7718  C0 02 8B 48 */	lfs f0, $$2196-_SDA2_BASE_(r2)
...
lbl_800AA7FC:
/* 800AA7FC 000A773C  C0 02 8B 4C */	lfs f0, $$2197-_SDA2_BASE_(r2)
...
/* 800AA81C 000A775C  C0 02 8B 28 */	lfs f0, $$2164-_SDA2_BASE_(r2)
...
/* 800AA8DC 000A781C  38 ED 80 48 */	addi r7, r13, GXTexImage0Ids-_SDA_BASE_
...
/* 800AA900 000A7840  38 AD 80 58 */	addi r5, r13, GXTexImage2Ids-_SDA_BASE_
...
/* 800AA910 000A7850  38 6D 80 38 */	addi r3, r13, GXTexMode0Ids-_SDA_BASE_
/* 800AA914 000A7854  7C 03 E8 AE */	lbzx r0, r3, r29
/* 800AA918 000A7858  38 6D 80 40 */	addi r3, r13, GXTexMode1Ids-_SDA_BASE_
...
/* 800AA928 000A7868  38 CD 80 50 */	addi r6, r13, GXTexImage1Ids-_SDA_BASE_
/* 800AA92C 000A786C  7C 03 E8 AE */	lbzx r0, r3, r29
/* 800AA930 000A7870  38 6D 80 60 */	addi r3, r13, GXTexImage3Ids-_SDA_BASE_
...
/* 800AA9E8 000A7928  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AA9FC 000A793C  38 8D 80 68 */	addi r4, r13, GXTexTlutIds-_SDA_BASE_
...
lbl_800AAA20:
/* 800AAA20 000A7960  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AAA38 000A7978  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AAA48 000A7988  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AAA58 000A7998  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AAA9C 000A79DC  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AAB38 000A7A78  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AAD68 000A7CA8  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AAD7C 000A7CBC  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AAD90 000A7CD0  80 ED 82 C8 */	lwz r7, gx-_SDA_BASE_(r13)
...
/* 800AADBC 000A7CFC  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AADEC 000A7D2C  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AAE04 000A7D44  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AAE2C 000A7D6C  80 0D 82 C8 */	lwz r0, gx-_SDA_BASE_(r13)
...
/* 800AAE58 000A7D98  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AAE70 000A7DB0  80 ED 82 C8 */	lwz r7, gx-_SDA_BASE_(r13)
...
.global __SetSURegs
__SetSURegs:
/* 800AAEB0 000A7DF0  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AAEE4 000A7E24  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AAEFC 000A7E3C  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AAF3C 000A7E7C  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AAF54 000A7E94  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800AAF8C 000A7ECC  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AAFDC:
/* 800AAFDC 000A7F1C  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AAFF0:
/* 800AAFF0 000A7F30  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB004:
/* 800AB004 000A7F44  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB018:
/* 800AB018 000A7F58  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB028:
/* 800AB028 000A7F68  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AB064:
/* 800AB064 000A7FA4  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
