...
GXSetGPMetric:
/* 800ADBF8 000AAB38  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800ADC7C:
/* 800ADC7C 000AABBC  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
/* 800ADCEC 000AAC2C  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
...
lbl_800ADD00:
/* 800ADD00 000AAC40  80 AD 95 5C */	lwz r5, __cpReg-_SDA_BASE_(r13)
/* 800ADD04 000AAC44  38 00 00 00 */	li r0, 0
/* 800ADD08 000AAC48  B0 05 00 06 */	sth r0, 6(r5)
lbl_800ADD0C:
/* 800ADD0C 000AAC4C  80 AD 82 C8 */	lwz r5, gx-_SDA_BASE_(r13)
/* 800ADD10 000AAC50  90 65 04 E4 */	stw r3, 0x4e4(r5)
/* 800ADD14 000AAC54  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
lbl_800AE13C:
/* 800AE13C 000AB07C  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
/* 800AE140 000AB080  90 83 04 E8 */	stw r4, 0x4e8(r3)
/* 800AE144 000AB084  80 8D 82 C8 */	lwz r4, gx-_SDA_BASE_(r13)
...
/* 800AE2A8 000AB1E8  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE2E0 000AB220  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE318 000AB258  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE350 000AB290  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE388 000AB2C8  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE3C0 000AB300  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE3F8 000AB338  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE430 000AB370  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
/* 800AE444 000AB384  80 6D 95 5C */	lwz r3, __cpReg-_SDA_BASE_(r13)
...
/* 800AE454 000AB394  80 6D 95 5C */	lwz r3, __cpReg-_SDA_BASE_(r13)
...
/* 800AE464 000AB3A4  80 6D 95 5C */	lwz r3, __cpReg-_SDA_BASE_(r13)
...
/* 800AE474 000AB3B4  80 6D 95 5C */	lwz r3, __cpReg-_SDA_BASE_(r13)
/* 800AE478 000AB3B8  38 00 00 05 */	li r0, 5
/* 800AE47C 000AB3BC  B0 03 00 06 */	sth r0, 6(r3)
lbl_800AE480:
/* 800AE480 000AB3C0  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
...
GXClearGPMetric:
/* 800AE490 000AB3D0  80 6D 95 5C */	lwz r3, __cpReg-_SDA_BASE_(r13)
...
GXReadPixMetric:
/* 800AE4A0 000AB3E0  81 2D 95 60 */	lwz r9, __peReg-_SDA_BASE_(r13)
...
/* 800AE4B8 000AB3F8  80 6D 95 60 */	lwz r3, __peReg-_SDA_BASE_(r13)
...
/* 800AE4D0 000AB410  80 6D 95 60 */	lwz r3, __peReg-_SDA_BASE_(r13)
...
/* 800AE4E8 000AB428  80 6D 95 60 */	lwz r3, __peReg-_SDA_BASE_(r13)
...
/* 800AE500 000AB440  80 6D 95 60 */	lwz r3, __peReg-_SDA_BASE_(r13)
...
/* 800AE518 000AB458  80 8D 95 60 */	lwz r4, __peReg-_SDA_BASE_(r13)
...
/* 800AE534 000AB474  80 6D 82 C8 */	lwz r3, gx-_SDA_BASE_(r13)
