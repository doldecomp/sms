...
/* 803619D0 0035E910  C0 02 08 70 */	lfs f0, $$21704-_SDA2_BASE_(r2)
...
/* 803619F8 0035E938  C0 02 08 74 */	lfs f0, $$21705-_SDA2_BASE_(r2)
...
/* 80361A24 0035E964  C0 22 08 78 */	lfs f1, $$21706-_SDA2_BASE_(r2)
/* 80361A28 0035E968  4B E0 B2 25 */	bl CLBRoundf$$0s$$1__Ff
/* 80361A2C 0035E96C  C0 22 08 7C */	lfs f1, $$21707-_SDA2_BASE_(r2)
/* 80361A30 0035E970  7C 7E 1B 78 */	mr r30, r3
/* 80361A34 0035E974  4B E0 B2 19 */	bl CLBRoundf$$0s$$1__Ff
/* 80361A38 0035E978  C0 22 08 80 */	lfs f1, $$21708-_SDA2_BASE_(r2)
...
/* 80361A68 0035E9A8  83 CD 8C E8 */	lwz r30, cLoadCamName-_SDA_BASE_(r13)
...
/* 80361A78 0035E9B8  80 6D A9 08 */	lwz r3, gpCamMapToolTable-_SDA_BASE_(r13)
...
/* 80361B18 0035EA58  80 8D A9 10 */	lwz r4, gpCameraOption-_SDA_BASE_(r13)
...
/* 80361B2C 0035EA6C  C8 42 08 90 */	lfd f2, $$21767-_SDA2_BASE_(r2)
...
/* 80361BA4 0035EAE4  80 8D A9 10 */	lwz r4, gpCameraOption-_SDA_BASE_(r13)
...
/* 80361BC8 0035EB08  C8 42 08 90 */	lfd f2, $$21767-_SDA2_BASE_(r2)
...
/* 80361C40 0035EB80  80 8D A9 10 */	lwz r4, gpCameraOption-_SDA_BASE_(r13)
...
/* 80361C60 0035EBA0  80 CD 98 DC */	lwz r6, gpMarioPos-_SDA_BASE_(r13)
/* 80361C64 0035EBA4  38 81 00 48 */	addi r4, r1, 0x48
/* 80361C68 0035EBA8  C0 02 08 8C */	lfs f0, $$21765-_SDA2_BASE_(r2)
/* 80361C6C 0035EBAC  80 A6 00 00 */	lwz r5, 0(r6)
/* 80361C70 0035EBB0  80 06 00 04 */	lwz r0, 4(r6)
/* 80361C74 0035EBB4  80 6D A8 D8 */	lwz r3, gpCubeCamera-_SDA_BASE_(r13)
...
/* 80361CA0 0035EBE0  80 8D A8 D8 */	lwz r4, gpCubeCamera-_SDA_BASE_(r13)
...
/* 80361CCC 0035EC0C  80 6D A9 10 */	lwz r3, gpCameraOption-_SDA_BASE_(r13)
...
/* 80361CF0 0035EC30  80 6D A9 10 */	lwz r3, gpCameraOption-_SDA_BASE_(r13)
/* 80361CF4 0035EC34  A8 03 00 10 */	lha r0, 0x10(r3)
/* 80361CF8 0035EC38  B0 03 00 12 */	sth r0, 0x12(r3)
lbl_80361CFC:
/* 80361CFC 0035EC3C  80 8D A9 10 */	lwz r4, gpCameraOption-_SDA_BASE_(r13)
...
/* 80361D10 0035EC50  C8 42 08 90 */	lfd f2, $$21767-_SDA2_BASE_(r2)
...
/* 80361D88 0035ECC8  80 8D A9 10 */	lwz r4, gpCameraOption-_SDA_BASE_(r13)
...
/* 80361DAC 0035ECEC  C8 42 08 90 */	lfd f2, $$21767-_SDA2_BASE_(r2)
...
/* 80361E24 0035ED64  80 8D A9 10 */	lwz r4, gpCameraOption-_SDA_BASE_(r13)
...
/* 80361E64 0035EDA4  80 6D A9 10 */	lwz r3, gpCameraOption-_SDA_BASE_(r13)
