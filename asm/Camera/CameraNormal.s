...
/* 8035990C 0035684C  C0 02 05 D8 */	lfs f0, $$22326-_SDA2_BASE_(r2)
...
/* 80359928 00356868  80 6D A8 B8 */	lwz r3, gpCameraMario-_SDA_BASE_(r13)
...
/* 803599B8 003568F8  C0 02 05 D8 */	lfs f0, $$22326-_SDA2_BASE_(r2)
...
lbl_80359A20:
/* 80359A20 00356960  C0 02 05 D8 */	lfs f0, $$22326-_SDA2_BASE_(r2)
...
/* 80359A8C 003569CC  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80359B68 00356AA8  C0 22 05 D8 */	lfs f1, $$22326-_SDA2_BASE_(r2)
...
/* 80359B78 00356AB8  C0 42 05 DC */	lfs f2, $$22327-_SDA2_BASE_(r2)
...
/* 80359B9C 00356ADC  80 8D 98 E4 */	lwz r4, gpMarioAngleY-_SDA_BASE_(r13)
...
lbl_80359BB8:
/* 80359BB8 00356AF8  80 6D 98 E4 */	lwz r3, gpMarioAngleY-_SDA_BASE_(r13)
...
/* 80359C08 00356B48  C8 22 05 F0 */	lfd f1, $$22333-_SDA2_BASE_(r2)
/* 80359C0C 00356B4C  90 01 00 8C */	stw r0, 0x8c(r1)
/* 80359C10 00356B50  3C 00 43 30 */	lis r0, 0x4330
/* 80359C14 00356B54  C0 42 05 E0 */	lfs f2, $$22328-_SDA2_BASE_(r2)
...
/* 80359C30 00356B70  80 0D 8D EC */	lwz r0, jmaSinShift-_SDA_BASE_(r13)
/* 80359C34 00356B74  7C 63 F8 50 */	subf r3, r3, r31
/* 80359C38 00356B78  80 8D 8D F4 */	lwz r4, jmaCosTable-_SDA_BASE_(r13)
/* 80359C3C 00356B7C  54 63 0C 3C */	rlwinm r3, r3, 1, 0x10, 0x1e
/* 80359C40 00356B80  C0 22 05 DC */	lfs f1, $$22327-_SDA2_BASE_(r2)
/* 80359C44 00356B84  7C 60 06 30 */	sraw r0, r3, r0
/* 80359C48 00356B88  C0 42 05 E4 */	lfs f2, $$22329-_SDA2_BASE_(r2)
...
/* 80359C60 00356BA0  C3 C2 05 DC */	lfs f30, $$22327-_SDA2_BASE_(r2)
...
lbl_80359C88:
/* 80359C88 00356BC8  80 6D 98 FC */	lwz r3, gpMarioFlag-_SDA_BASE_(r13)
...
lbl_80359D14:
/* 80359D14 00356C54  C0 62 05 E8 */	lfs f3, $$22330-_SDA2_BASE_(r2)
/* 80359D18 00356C58  48 00 00 0C */	b lbl_80359D24
lbl_80359D1C:
/* 80359D1C 00356C5C  80 6D A8 B8 */	lwz r3, gpCameraMario-_SDA_BASE_(r13)
...
/* 80359D30 00356C70  C0 02 05 EC */	lfs f0, $$22331-_SDA2_BASE_(r2)
...
lbl_80359E3C:
/* 80359E3C 00356D7C  C0 02 05 D8 */	lfs f0, $$22326-_SDA2_BASE_(r2)
...
/* 80359E5C 00356D9C  80 6D 98 30 */	lwz r3, gpPositionHolder-_SDA_BASE_(r13)
...
lbl_80359E98:
/* 80359E98 00356DD8  C0 02 05 D8 */	lfs f0, $$22326-_SDA2_BASE_(r2)
...
/* 80359EE4 00356E24  C8 42 05 F0 */	lfd f2, $$22333-_SDA2_BASE_(r2)
