...
/* 8009CE00 00099D40  83 ED 94 BC */	lwz r31, __AID_Callback@sda21(r13)
/* 8009CE04 00099D44  4B FF 33 C9 */	bl OSDisableInterrupts
/* 8009CE08 00099D48  93 CD 94 BC */	stw r30, __AID_Callback@sda21(r13)
...
/* 8009D23C 0009A17C  80 0D 94 C8 */	lwz r0, __AI_init_flag@sda21(r13)
...
/* 8009D2AC 0009A1EC  91 0D 94 D4 */	stw r8, lbl_80409F94@sda21(r13)
/* 8009D2B0 0009A1F0  54 A5 BA 7E */	srwi r5, r5, 9
/* 8009D2B4 0009A1F4  54 84 BA 7E */	srwi r4, r4, 9
/* 8009D2B8 0009A1F8  90 ED 94 DC */	stw r7, lbl_80409F9C@sda21(r13)
/* 8009D2BC 0009A1FC  3B E0 00 00 */	li r31, 0
/* 8009D2C0 0009A200  54 63 BA 7E */	srwi r3, r3, 9
/* 8009D2C4 0009A204  90 AD 94 E4 */	stw r5, lbl_80409FA4@sda21(r13)
/* 8009D2C8 0009A208  3C C0 CC 00 */	lis r6, 0xCC006C00@ha
/* 8009D2CC 0009A20C  90 6D 94 F4 */	stw r3, lbl_80409FB4@sda21(r13)
/* 8009D2D0 0009A210  38 60 00 01 */	li r3, 1
/* 8009D2D4 0009A214  80 06 6C 00 */	lwz r0, 0xCC006C00@l(r6)
/* 8009D2D8 0009A218  90 8D 94 EC */	stw r4, lbl_80409FAC@sda21(r13)
/* 8009D2DC 0009A21C  54 00 06 F2 */	rlwinm r0, r0, 0, 0x1b, 0x19
/* 8009D2E0 0009A220  60 00 00 20 */	ori r0, r0, 0x20
/* 8009D2E4 0009A224  93 ED 94 D0 */	stw r31, bound_32KHz@sda21(r13)
/* 8009D2E8 0009A228  93 ED 94 D8 */	stw r31, bound_48KHz@sda21(r13)
/* 8009D2EC 0009A22C  93 ED 94 E0 */	stw r31, min_wait@sda21(r13)
/* 8009D2F0 0009A230  93 ED 94 E8 */	stw r31, max_wait@sda21(r13)
/* 8009D2F4 0009A234  93 ED 94 F0 */	stw r31, buffer@sda21(r13)
...
/* 8009D330 0009A270  93 ED 94 B8 */	stw r31, __AIS_Callback@sda21(r13)
/* 8009D334 0009A274  38 83 D4 04 */	addi r4, r3, __AIDHandler@l
/* 8009D338 0009A278  93 ED 94 BC */	stw r31, __AID_Callback@sda21(r13)
/* 8009D33C 0009A27C  38 60 00 05 */	li r3, 5
/* 8009D340 0009A280  93 CD 94 C0 */	stw r30, __CallbackStack@sda21(r13)
...
/* 8009D36C 0009A2AC  90 0D 94 C8 */	stw r0, __AI_init_flag@sda21(r13)
lbl_8009D370:
...
/* 8009D3C0 0009A300  81 8D 94 B8 */	lwz r12, __AIS_Callback@sda21(r13)
...
/* 8009D444 0009A384  80 6D 94 BC */	lwz r3, __AID_Callback@sda21(r13)
/* 8009D448 0009A388  28 03 00 00 */	cmplwi r3, 0
/* 8009D44C 0009A38C  41 82 00 24 */	beq lbl_8009D470
/* 8009D450 0009A390  80 0D 94 C0 */	lwz r0, __CallbackStack@sda21(r13)
...
/* 8009D60C 0009A54C  83 AD 94 E0 */	lwz r29, min_wait@sda21(r13)
/* 8009D610 0009A550  38 00 00 01 */	li r0, 1
/* 8009D614 0009A554  83 8D 94 E4 */	lwz r28, lbl_80409FA4@sda21(r13)
...
/* 8009D640 0009A580  80 AD 94 DC */	lwz r5, lbl_80409F9C@sda21(r13)
/* 8009D644 0009A584  80 0D 94 D8 */	lwz r0, bound_48KHz@sda21(r13)
...
/* 8009D66C 0009A5AC  83 AD 94 E8 */	lwz r29, max_wait@sda21(r13)
/* 8009D670 0009A5B0  38 00 00 01 */	li r0, 1
/* 8009D674 0009A5B4  83 8D 94 EC */	lwz r28, lbl_80409FAC@sda21(r13)
