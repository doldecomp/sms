...
/* 80152960 0014F8A0  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152994 0014F8D4  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 801529A0 0014F8E0  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 801529AC 0014F8EC  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 801529B8 0014F8F8  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 801529D4 0014F914  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 801529FC 0014F93C  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152A24 0014F964  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152A4C 0014F98C  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152A70 0014F9B0  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152AB0 0014F9F0  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152AD8 0014FA18  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152B00 0014FA40  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152B48 0014FA88  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
/* 80152B4C 0014FA8C  C0 22 A1 98 */	lfs f1, $$22019-_SDA2_BASE_(r2)
...
/* 80152B9C 0014FADC  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152BCC 0014FB0C  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152C04 0014FB44  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152C10 0014FB50  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152C1C 0014FB5C  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152C28 0014FB68  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
/* 80152C2C 0014FB6C  C0 23 00 58 */	lfs f1, 0x58(r3)
/* 80152C30 0014FB70  4E 80 00 20 */	blr 

.global SMS_GetMarioHP__Fv
SMS_GetMarioHP__Fv:
/* 80152C34 0014FB74  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152C40 0014FB80  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152C6C 0014FBAC  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152C90 0014FBD0  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152CB4 0014FBF4  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152CD8 0014FC18  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152CF8 0014FC38  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152D18 0014FC58  80 6D 98 D8 */	lwz r3, gpMarioAddress-_SDA_BASE_(r13)
/* 80152D1C 0014FC5C  4E 80 00 20 */	blr 

.global SMS_GetMarioHitActor__Fv
SMS_GetMarioHitActor__Fv:
/* 80152D20 0014FC60  80 6D 98 D8 */	lwz r3, gpMarioAddress-_SDA_BASE_(r13)
...
/* 80152D34 0014FC74  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
SMS_GetYoshi__Fv:
/* 80152D4C 0014FC8C  80 6D 98 B8 */	lwz r3, gpMarioOriginal-_SDA_BASE_(r13)
...
/* 80152D58 0014FC98  81 0D 98 B8 */	lwz r8, gpMarioOriginal-_SDA_BASE_(r13)
/* 80152D5C 0014FC9C  38 A8 00 94 */	addi r5, r8, 0x94
/* 80152D60 0014FCA0  91 0D 98 D8 */	stw r8, gpMarioAddress-_SDA_BASE_(r13)
/* 80152D64 0014FCA4  39 28 00 A4 */	addi r9, r8, 0xa4
/* 80152D68 0014FCA8  38 88 00 10 */	addi r4, r8, 0x10
/* 80152D6C 0014FCAC  90 AD 98 E0 */	stw r5, gpMarioAngleX-_SDA_BASE_(r13)
/* 80152D70 0014FCB0  38 65 00 02 */	addi r3, r5, 2
/* 80152D74 0014FCB4  38 05 00 04 */	addi r0, r5, 4
/* 80152D78 0014FCB8  90 8D 98 DC */	stw r4, gpMarioPos-_SDA_BASE_(r13)
/* 80152D7C 0014FCBC  38 E9 00 04 */	addi r7, r9, 4
/* 80152D80 0014FCC0  38 C9 00 08 */	addi r6, r9, 8
/* 80152D84 0014FCC4  90 6D 98 E4 */	stw r3, gpMarioAngleY-_SDA_BASE_(r13)
/* 80152D88 0014FCC8  38 A8 00 F8 */	addi r5, r8, 0xf8
/* 80152D8C 0014FCCC  38 88 01 18 */	addi r4, r8, 0x118
/* 80152D90 0014FCD0  90 0D 98 E8 */	stw r0, gpMarioAngleZ-_SDA_BASE_(r13)
/* 80152D94 0014FCD4  38 68 08 20 */	addi r3, r8, 0x820
/* 80152D98 0014FCD8  38 08 00 E0 */	addi r0, r8, 0xe0
/* 80152D9C 0014FCDC  91 2D 98 EC */	stw r9, gpMarioSpeedX-_SDA_BASE_(r13)
/* 80152DA0 0014FCE0  90 ED 98 F0 */	stw r7, gpMarioSpeedY-_SDA_BASE_(r13)
/* 80152DA4 0014FCE4  90 CD 98 F4 */	stw r6, gpMarioSpeedZ-_SDA_BASE_(r13)
/* 80152DA8 0014FCE8  90 AD 98 F8 */	stw r5, gpMarioLightID-_SDA_BASE_(r13)
/* 80152DAC 0014FCEC  90 8D 98 FC */	stw r4, gpMarioFlag-_SDA_BASE_(r13)
