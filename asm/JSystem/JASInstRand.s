...
/* 8005A954 00057894  88 0D 90 A0 */	lbz r0, init$332-_SDA_BASE_(r13)
/* 8005A958 00057898  7C 00 07 75 */	extsb. r0, r0
/* 8005A95C 0005789C  40 82 00 18 */	bne lbl_8005A974
/* 8005A960 000578A0  38 6D 90 A4 */	addi r3, r13, oRandom$331-_SDA_BASE_
...
/* 8005A970 000578B0  98 0D 90 A0 */	stb r0, init$332-_SDA_BASE_(r13)
lbl_8005A974:
/* 8005A974 000578B4  3C 60 00 19 */	lis r3, 0x0019660D@ha
/* 8005A978 000578B8  80 8D 90 A4 */	lwz r4, oRandom$331-_SDA_BASE_(r13)
/* 8005A97C 000578BC  38 03 66 0D */	addi r0, r3, 0x0019660D@l
/* 8005A980 000578C0  C0 02 86 0C */	lfs f0, $$2346-_SDA2_BASE_(r2)
/* 8005A984 000578C4  7C 64 01 D6 */	mullw r3, r4, r0
/* 8005A988 000578C8  C0 82 86 08 */	lfs f4, $$2345-_SDA2_BASE_(r2)
/* 8005A98C 000578CC  C0 22 86 10 */	lfs f1, $$2347-_SDA2_BASE_(r2)
/* 8005A990 000578D0  3C 63 3C 6F */	addis r3, r3, 0x3c6f
/* 8005A994 000578D4  38 03 F3 5F */	addi r0, r3, -3233
/* 8005A998 000578D8  90 0D 90 A4 */	stw r0, oRandom$331-_SDA_BASE_(r13)
/* 8005A99C 000578DC  80 0D 90 A4 */	lwz r0, oRandom$331-_SDA_BASE_(r13)
