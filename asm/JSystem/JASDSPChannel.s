...
lbl_8005EF88:
/* 8005EF88 0005BEC8  80 6D 91 14 */	lwz r3, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005EF8C 0005BECC  38 00 00 01 */	li r0, 1
/* 8005EF90 0005BED0  38 63 FF FF */	addi r3, r3, -1
/* 8005EF94 0005BED4  90 6D 91 14 */	stw r3, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F060 0005BFA0  88 0D 91 1C */	lbz r0, init$145-_SDA_BASE_(r13)
...
/* 8005F070 0005BFB0  90 0D 91 18 */	stw r0, first$144-_SDA_BASE_(r13)
/* 8005F074 0005BFB4  98 0D 91 1C */	stb r0, init$145-_SDA_BASE_(r13)
lbl_8005F078:
/* 8005F078 0005BFB8  80 0D 91 18 */	lwz r0, first$144-_SDA_BASE_(r13)
/* 8005F07C 0005BFBC  2C 00 00 00 */	cmpwi r0, 0
/* 8005F080 0005BFC0  41 82 00 94 */	beq lbl_8005F114
/* 8005F084 0005BFC4  80 8D 92 00 */	lwz r4, JASDram-_SDA_BASE_(r13)
...
/* 8005F0B0 0005BFF0  90 6D 91 10 */	stw r3, DSPCH__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F0C8 0005C008  80 6D 91 10 */	lwz r3, DSPCH__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F110 0005C050  90 0D 91 18 */	stw r0, first$144-_SDA_BASE_(r13)
lbl_8005F114:
...
lbl_8005F1BC:
/* 8005F1BC 0005C0FC  80 0D 91 10 */	lwz r0, DSPCH__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F22C 0005C16C  80 8D 81 B0 */	lwz r4, smnFree__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005F230 0005C170  80 6D 91 14 */	lwz r3, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005F234 0005C174  38 A4 FF FF */	addi r5, r4, -1
/* 8005F238 0005C178  80 0D 91 10 */	lwz r0, DSPCH__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005F23C 0005C17C  38 83 00 01 */	addi r4, r3, 1
/* 8005F240 0005C180  90 AD 81 B0 */	stw r5, smnFree__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005F244 0005C184  7C 60 FA 14 */	add r3, r0, r31
/* 8005F248 0005C188  90 8D 91 14 */	stw r4, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F2C8 0005C208  80 8D 91 14 */	lwz r4, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005F2CC 0005C20C  38 04 FF FF */	addi r0, r4, -1
/* 8005F2D0 0005C210  90 0D 91 14 */	stw r0, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
lbl_8005F2D4:
...
/* 8005F2E0 0005C220  80 8D 81 B0 */	lwz r4, smnFree__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005F2E4 0005C224  38 04 00 01 */	addi r0, r4, 1
/* 8005F2E8 0005C228  90 0D 81 B0 */	stw r0, smnFree__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
lbl_8005F2EC:
...
/* 8005F30C 0005C24C  80 AD 91 10 */	lwz r5, DSPCH__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F3C0 0005C300  80 AD 91 10 */	lwz r5, DSPCH__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F4E8 0005C428  80 6D 91 14 */	lwz r3, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
/* 8005F4EC 0005C42C  38 00 00 01 */	li r0, 1
/* 8005F4F0 0005C430  38 63 FF FF */	addi r3, r3, -1
/* 8005F4F4 0005C434  90 6D 91 14 */	stw r3, smnUse__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
...
/* 8005F558 0005C498  80 0D 91 20 */	lwz r0, old_time__8JASystem-_SDA_BASE_(r13)
/* 8005F55C 0005C49C  90 6D 91 20 */	stw r3, old_time__8JASystem-_SDA_BASE_(r13)
...
/* 8005F594 0005C4D4  C8 62 86 70 */	lfd f3, $$2353-_SDA2_BASE_(r2)
/* 8005F598 0005C4D8  90 61 00 3C */	stw r3, 0x3c(r1)
/* 8005F59C 0005C4DC  C0 0D 81 B4 */	lfs f0, DSP_LIMIT_RATIO__8JASystem-_SDA_BASE_(r13)
...
lbl_8005F628:
/* 8005F628 0005C568  80 0D 91 10 */	lwz r0, DSPCH__Q28JASystem11TDSPChannel-_SDA_BASE_(r13)
