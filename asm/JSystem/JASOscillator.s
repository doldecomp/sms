...
/* 8005FECC 0005CE0C  C0 02 86 78 */	lfs f0, "@204"@sda21(r2)
...
/* 8005FF64 0005CEA4  C0 22 86 7C */	lfs f1, "@231"@sda21(r2)
...
lbl_8005FF9C:
/* 8005FF9C 0005CEDC  C0 22 86 7C */	lfs f1, "@231"@sda21(r2)
...
/* 80060008 0005CF48  C0 22 86 7C */	lfs f1, "@231"@sda21(r2)
...
/* 80060020 0005CF60  C0 02 86 7C */	lfs f0, "@231"@sda21(r2)
...
/* 80060064 0005CFA4  C0 22 86 7C */	lfs f1, "@231"@sda21(r2)
...
lbl_8006008C:
/* 8006008C 0005CFCC  C0 22 86 7C */	lfs f1, "@231"@sda21(r2)
...
/* 800600D4 0005D014  C0 02 86 78 */	lfs f0, "@204"@sda21(r2)
...
/* 8006013C 0005D07C  C0 02 86 78 */	lfs f0, "@204"@sda21(r2)
...
/* 80060198 0005D0D8  C0 02 86 80 */	lfs f0, "@260"@sda21(r2)
/* 8006019C 0005D0DC  A0 1F 00 18 */	lhz r0, 0x18(r31)
/* 800601A0 0005D0E0  EC 21 00 24 */	fdivs f1, f1, f0
/* 800601A4 0005D0E4  C0 02 86 84 */	lfs f0, "@261"@sda21(r2)
/* 800601A8 0005D0E8  54 00 04 BE */	clrlwi r0, r0, 0x12
/* 800601AC 0005D0EC  C8 42 86 88 */	lfd f2, "@263"@sda21(r2)
...
/* 800601D4 0005D114  C8 22 86 90 */	lfd f1, "@265"@sda21(r2)
...
/* 800601F4 0005D134  C0 02 86 7C */	lfs f0, "@231"@sda21(r2)
...
/* 8006020C 0005D14C  C0 02 86 78 */	lfs f0, "@204"@sda21(r2)
...
/* 800602B8 0005D1F8  CB 82 86 90 */	lfd f28, "@265"@sda21(r2)
/* 800602BC 0005D1FC  CB A2 86 88 */	lfd f29, "@263"@sda21(r2)
/* 800602C0 0005D200  C3 C2 86 80 */	lfs f30, "@260"@sda21(r2)
/* 800602C4 0005D204  C3 E2 86 84 */	lfs f31, "@261"@sda21(r2)
/* 800602C8 0005D208  C3 42 86 98 */	lfs f26, "@332"@sda21(r2)
/* 800602CC 0005D20C  C3 62 86 78 */	lfs f27, "@204"@sda21(r2)
...
/* 80060454 0005D394  C0 22 86 78 */	lfs f1, "@204"@sda21(r2)
...
lbl_8006046C:
/* 8006046C 0005D3AC  C8 02 86 A0 */	lfd f0, "@333"@sda21(r2)
...
lbl_80060508:
/* 80060508 0005D448  C0 02 86 78 */	lfs f0, "@204"@sda21(r2)
...
/* 80060518 0005D458  C0 22 86 7C */	lfs f1, "@231"@sda21(r2)
/* 8006051C 0005D45C  EC 00 10 24 */	fdivs f0, f0, f2
/* 80060520 0005D460  C0 42 86 A8 */	lfs f2, "@334"@sda21(r2)
...
/* 80060534 0005D474  C0 22 86 A8 */	lfs f1, "@334"@sda21(r2)
...
/* 80060550 0005D490  C8 22 86 90 */	lfd f1, "@265"@sda21(r2)
...
/* 80060570 0005D4B0  C0 82 86 7C */	lfs f4, "@231"@sda21(r2)
lbl_80060574:
...
/* 80060580 0005D4C0  C0 02 86 78 */	lfs f0, "@204"@sda21(r2)
