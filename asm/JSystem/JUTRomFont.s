...
/* 8003C178 000390B8  3C A0 80 37 */	lis r5, "@258"@ha
/* 8003C17C 000390BC  4C C6 31 82 */	crclr 6
/* 8003C180 000390C0  54 64 04 3E */	clrlwi r4, r3, 0x10
/* 8003C184 000390C4  38 65 0E B8 */	addi r3, r5, "@258"@l
...
/* 8003C1AC 000390EC  3C 60 80 37 */	lis r3, "@259"@ha
/* 8003C1B0 000390F0  38 63 0E D0 */	addi r3, r3, "@259"@l
...
/* 8003C330 00039270  C0 22 83 30 */	lfs f1, "@294"@sda21(r2)
...
/* 8003C350 00039290  C8 22 83 38 */	lfd f1, "@297"@sda21(r2)
...
/* 8003C384 000392C4  C8 22 83 38 */	lfd f1, "@297"@sda21(r2)
...
/* 8003C3FC 0003933C  C0 22 83 30 */	lfs f1, "@294"@sda21(r2)
...
/* 8003C464 000393A4  C8 62 83 38 */	lfd f3, "@297"@sda21(r2)
/* 8003C468 000393A8  93 E1 01 20 */	stw r31, 0x120(r1)
/* 8003C46C 000393AC  7F 23 CB 78 */	mr r3, r25
/* 8003C470 000393B0  C0 22 83 34 */	lfs f1, "@295"@sda21(r2)
...
/* 8003C4AC 000393EC  C8 22 83 38 */	lfd f1, "@297"@sda21(r2)
...
/* 8003C4FC 0003943C  C8 22 83 38 */	lfd f1, "@297"@sda21(r2)
...
/* 8003C564 000394A4  C8 C2 83 38 */	lfd f6, "@297"@sda21(r2)
...
/* 8003C57C 000394BC  C0 82 83 30 */	lfs f4, "@294"@sda21(r2)
