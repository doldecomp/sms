...
/* 80058344 00055284  80 8D 92 00 */	lwz r4, JASDram@sda21(r13)
/* 80058348 00055288  4B FB 46 FD */	bl __nwa__FUlP7JKRHeapi
/* 8005834C 0005528C  90 6D 90 84 */	stw r3, sBankArray__Q28JASystem7BankMgr@sda21(r13)
/* 80058350 00055290  57 E3 08 3C */	slwi r3, r31, 1
/* 80058354 00055294  80 8D 92 00 */	lwz r4, JASDram@sda21(r13)
/* 80058358 00055298  38 A0 00 00 */	li r5, 0
/* 8005835C 0005529C  4B FB 46 E9 */	bl __nwa__FUlP7JKRHeapi
/* 80058360 000552A0  90 6D 90 88 */	stw r3, sVir2PhyTable__Q28JASystem7BankMgr@sda21(r13)
/* 80058364 000552A4  7F C4 F3 78 */	mr r4, r30
/* 80058368 000552A8  80 6D 90 84 */	lwz r3, sBankArray__Q28JASystem7BankMgr@sda21(r13)
...
/* 80058390 000552D0  80 ED 90 88 */	lwz r7, sVir2PhyTable__Q28JASystem7BankMgr@sda21(r13)
...
/* 800583F8 00055338  80 8D 90 88 */	lwz r4, sVir2PhyTable__Q28JASystem7BankMgr@sda21(r13)
...
lbl_80058420:
/* 80058420 00055360  93 ED 90 80 */	stw r31, sTableSize__Q28JASystem7BankMgr@sda21(r13)
...
lbl_8005847C:
/* 8005847C 000553BC  80 8D 90 84 */	lwz r4, sBankArray__Q28JASystem7BankMgr@sda21(r13)
...
/* 800584A4 000553E4  80 8D 90 88 */	lwz r4, sVir2PhyTable__Q28JASystem7BankMgr@sda21(r13)
...
/* 800584BC 000553FC  80 AD 90 88 */	lwz r5, sVir2PhyTable__Q28JASystem7BankMgr@sda21(r13)
...
/* 800584E0 00055420  80 0D 90 80 */	lwz r0, sTableSize__Q28JASystem7BankMgr@sda21(r13)
...
lbl_800584F4:
/* 800584F4 00055434  80 AD 90 84 */	lwz r5, sBankArray__Q28JASystem7BankMgr@sda21(r13)
...
lbl_80058590:
/* 80058590 000554D0  80 0D 90 80 */	lwz r0, sTableSize__Q28JASystem7BankMgr@sda21(r13)
...
lbl_800585A4:
/* 800585A4 000554E4  80 6D 90 84 */	lwz r3, sBankArray__Q28JASystem7BankMgr@sda21(r13)
...
/* 8005860C 0005554C  C0 02 85 B4 */	lfs f0, "@340"@sda21(r2)
...
/* 80058620 00055560  C0 22 85 B8 */	lfs f1, "@418"@sda21(r2)
/* 80058624 00055564  D0 21 00 44 */	stfs f1, 0x44(r1)
/* 80058628 00055568  C0 02 85 B0 */	lfs f0, "@339"@sda21(r2)
...
/* 80058784 000556C4  C0 0D 81 F0 */	lfs f0, gDacRate__Q28JASystem6Kernel@sda21(r13)
...
/* 80058808 00055748  C8 42 85 C0 */	lfd f2, "@421"@sda21(r2)
/* 8005880C 0005574C  90 61 00 6C */	stw r3, 0x6c(r1)
/* 80058810 00055750  C0 02 85 BC */	lfs f0, "@419"@sda21(r2)
...
/* 80058868 000557A8  C0 22 85 B0 */	lfs f1, "@339"@sda21(r2)
/* 8005886C 000557AC  C0 02 85 B4 */	lfs f0, "@340"@sda21(r2)
...
/* 800588D8 00055818  C0 02 85 B4 */	lfs f0, "@340"@sda21(r2)
...
/* 800589A4 000558E4  C0 22 85 C8 */	lfs f1, "@435"@sda21(r2)
/* 800589A8 000558E8  C0 0D 81 F0 */	lfs f0, gDacRate__Q28JASystem6Kernel@sda21(r13)
...
/* 80058A04 00055944  C0 62 85 B4 */	lfs f3, "@340"@sda21(r2)
/* 80058A08 00055948  D0 7F 00 4C */	stfs f3, 0x4c(r31)
/* 80058A0C 0005594C  88 DF 00 00 */	lbz r6, 0(r31)
/* 80058A10 00055950  C8 42 85 C0 */	lfd f2, "@421"@sda21(r2)
/* 80058A14 00055954  90 C1 00 24 */	stw r6, 0x24(r1)
/* 80058A18 00055958  C0 02 85 BC */	lfs f0, "@419"@sda21(r2)
...
/* 80058A44 00055984  C0 22 85 B8 */	lfs f1, "@418"@sda21(r2)
/* 80058A48 00055988  D0 3F 00 68 */	stfs f1, 0x68(r31)
/* 80058A4C 0005598C  C0 02 85 B0 */	lfs f0, "@339"@sda21(r2)
...
/* 80058B38 00055A78  C8 42 85 C0 */	lfd f2, "@421"@sda21(r2)
/* 80058B3C 00055A7C  90 81 00 1C */	stw r4, 0x1c(r1)
/* 80058B40 00055A80  C0 02 85 BC */	lfs f0, "@419"@sda21(r2)
