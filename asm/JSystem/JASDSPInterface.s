...
/* 8005F7F0 0005C730  80 6D 91 28 */	lwz r3, CH_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
/* 8005F810 0005C750  80 6D 91 28 */	lwz r3, CH_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
/* 8005F844 0005C784  80 8D 92 00 */	lwz r4, JASDram@sda21(r13)
/* 8005F848 0005C788  4B FA D1 FD */	bl __nwa__FUlP7JKRHeapi
/* 8005F84C 0005C78C  90 6D 91 28 */	stw r3, CH_BUF__Q28JASystem12DSPInterface@sda21(r13)
/* 8005F850 0005C790  38 60 00 80 */	li r3, 0x80
/* 8005F854 0005C794  80 8D 92 00 */	lwz r4, JASDram@sda21(r13)
/* 8005F858 0005C798  38 A0 00 20 */	li r5, 0x20
/* 8005F85C 0005C79C  4B FA D1 E9 */	bl __nwa__FUlP7JKRHeapi
/* 8005F860 0005C7A0  90 6D 91 2C */	stw r3, FX_BUF__Q28JASystem12DSPInterface@sda21(r13)
/* 8005F864 0005C7A4  3B C0 00 00 */	li r30, 0
/* 8005F868 0005C7A8  48 00 00 20 */	b lbl_8005F888
lbl_8005F86C:
/* 8005F86C 0005C7AC  80 6D 91 2C */	lwz r3, FX_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
lbl_8005F89C:
/* 8005F89C 0005C7DC  80 0D 91 28 */	lwz r0, CH_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
lbl_8005F8C4:
/* 8005F8C4 0005C804  80 0D 91 2C */	lwz r0, FX_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
/* 8005F8E8 0005C828  80 8D 91 28 */	lwz r4, CH_BUF__Q28JASystem12DSPInterface@sda21(r13)
/* 8005F8EC 0005C82C  3C 60 80 3B */	lis r3, DSPADPCM_FILTER__Q28JASystem12DSPInterface@ha
/* 8005F8F0 0005C830  80 ED 91 2C */	lwz r7, FX_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
/* 8005F904 0005C844  80 6D 91 28 */	lwz r3, CH_BUF__Q28JASystem12DSPInterface@sda21(r13)
/* 8005F908 0005C848  38 80 60 00 */	li r4, 0x6000
/* 8005F90C 0005C84C  48 02 E6 A1 */	bl DCFlushRange
/* 8005F910 0005C850  80 6D 91 2C */	lwz r3, FX_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
/* 8005F934 0005C874  80 8D 91 2C */	lwz r4, FX_BUF__Q28JASystem12DSPInterface@sda21(r13)
...
/* 8005FBA4 0005CAE4  38 CD 81 BC */	addi r6, r13, COMP_BLOCKSAMPLES$234@sda21
/* 8005FBA8 0005CAE8  38 AD 81 C4 */	addi r5, r13, COMP_BLOCKBYTES$235@sda21
