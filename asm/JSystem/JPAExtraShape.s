...
/* 80080B98 0007DAD8  C0 02 89 18 */	lfs f0, "@1509"@sda21(r2)
...
lbl_80080BBC:
/* 80080BBC 0007DAFC  C0 02 89 1C */	lfs f0, "@1510"@sda21(r2)
lbl_80080BC0:
/* 80080BC0 0007DB00  D0 1F 00 2C */	stfs f0, 0x2c(r31)
/* 80080BC4 0007DB04  80 61 00 08 */	lwz r3, 8(r1)
/* 80080BC8 0007DB08  C0 02 89 1C */	lfs f0, "@1510"@sda21(r2)
...
/* 80080C20 0007DB60  C0 02 89 20 */	lfs f0, "@1511"@sda21(r2)
...
/* 80080C34 0007DB74  C0 02 89 20 */	lfs f0, "@1511"@sda21(r2)
...
/* 80080C60 0007DBA0  C0 02 89 20 */	lfs f0, "@1511"@sda21(r2)
...
/* 80080C74 0007DBB4  C0 02 89 20 */	lfs f0, "@1511"@sda21(r2)
...
/* 80080CA0 0007DBE0  C0 02 89 18 */	lfs f0, "@1509"@sda21(r2)
...
/* 80080CB0 0007DBF0  C0 42 89 1C */	lfs f2, "@1510"@sda21(r2)
...
lbl_80080CDC:
/* 80080CDC 0007DC1C  C0 02 89 1C */	lfs f0, "@1510"@sda21(r2)
...
/* 80080CEC 0007DC2C  C0 42 89 1C */	lfs f2, "@1510"@sda21(r2)
