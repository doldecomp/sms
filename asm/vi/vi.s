...
lbl_800996E8:
/* 800996E8 00096628  80 8D 94 40 */	lwz r4, retraceCount-_SDA_BASE_(r13)
/* 800996EC 0009662C  38 61 00 18 */	addi r3, r1, 0x18
/* 800996F0 00096630  38 04 00 01 */	addi r0, r4, 1
/* 800996F4 00096634  90 0D 94 40 */	stw r0, retraceCount-_SDA_BASE_(r13)
...
/* 80099704 00096644  81 8D 94 50 */	lwz r12, PreCB-_SDA_BASE_(r13)
/* 80099708 00096648  28 0C 00 00 */	cmplwi r12, 0
/* 8009970C 0009664C  41 82 00 10 */	beq lbl_8009971C
/* 80099710 00096650  80 6D 94 40 */	lwz r3, retraceCount-_SDA_BASE_(r13)
/* 80099714 00096654  7D 88 03 A6 */	mtlr r12
/* 80099718 00096658  4E 80 00 21 */	blrl 
lbl_8009971C:
/* 8009971C 0009665C  80 0D 94 44 */	lwz r0, flushFlag-_SDA_BASE_(r13)
/* 80099720 00096660  28 00 00 00 */	cmplwi r0, 0
/* 80099724 00096664  41 82 00 EC */	beq lbl_80099810
/* 80099728 00096668  80 0D 94 70 */	lwz r0, shdwChangeMode-_SDA_BASE_(r13)
...
lbl_8009974C:
/* 8009974C 0009668C  80 6D 94 78 */	lwz r3, shdwChanged-_SDA_BASE_(r13)
/* 80099750 00096690  38 A0 00 20 */	li r5, 0x20
/* 80099754 00096694  83 6D 94 7C */	lwz r27, lbl_80409F3C-_SDA_BASE_(r13)
...
/* 800997A0 000966E0  80 0D 94 78 */	lwz r0, shdwChanged-_SDA_BASE_(r13)
/* 800997A4 000966E4  7C 65 18 F8 */	nor r5, r3, r3
/* 800997A8 000966E8  7C 84 20 F8 */	nor r4, r4, r4
/* 800997AC 000966EC  80 6D 94 7C */	lwz r3, lbl_80409F3C-_SDA_BASE_(r13)
/* 800997B0 000966F0  7C 00 28 38 */	and r0, r0, r5
/* 800997B4 000966F4  7C 63 20 38 */	and r3, r3, r4
/* 800997B8 000966F8  90 6D 94 7C */	stw r3, lbl_80409F3C-_SDA_BASE_(r13)
/* 800997BC 000966FC  90 0D 94 78 */	stw r0, shdwChanged-_SDA_BASE_(r13)
lbl_800997C0:
/* 800997C0 00096700  80 0D 94 78 */	lwz r0, shdwChanged-_SDA_BASE_(r13)
/* 800997C4 00096704  38 80 00 00 */	li r4, 0
/* 800997C8 00096708  80 6D 94 7C */	lwz r3, lbl_80409F3C-_SDA_BASE_(r13)
...
/* 800997DC 0009671C  90 8D 94 70 */	stw r4, shdwChangeMode-_SDA_BASE_(r13)
/* 800997E0 00096720  38 60 00 01 */	li r3, 1
/* 800997E4 00096724  80 1F 01 44 */	lwz r0, 0x144(r31)
/* 800997E8 00096728  90 0D 94 80 */	stw r0, CurrTiming-_SDA_BASE_(r13)
/* 800997EC 0009672C  80 1F 01 18 */	lwz r0, 0x118(r31)
/* 800997F0 00096730  90 0D 94 84 */	stw r0, CurrTvMode-_SDA_BASE_(r13)
...
/* 80099808 00096748  90 0D 94 44 */	stw r0, flushFlag-_SDA_BASE_(r13)
/* 8009980C 0009674C  48 01 AB F1 */	bl SIRefreshSamplingRate
lbl_80099810:
/* 80099810 00096750  80 0D 94 54 */	lwz r0, PostCB-_SDA_BASE_(r13)
...
/* 80099824 00096764  81 8D 94 54 */	lwz r12, PostCB-_SDA_BASE_(r13)
/* 80099828 00096768  80 6D 94 40 */	lwz r3, retraceCount-_SDA_BASE_(r13)
/* 8009982C 0009676C  7D 88 03 A6 */	mtlr r12
/* 80099830 00096770  4E 80 00 21 */	blrl 
lbl_80099834:
/* 80099834 00096774  38 6D 94 48 */	addi r3, r13, retraceQueue-_SDA_BASE_
...
/* 80099878 000967B8  83 ED 94 54 */	lwz r31, PostCB-_SDA_BASE_(r13)
/* 8009987C 000967BC  4B FF 69 51 */	bl OSDisableInterrupts
/* 80099880 000967C0  93 CD 94 54 */	stw r30, PostCB-_SDA_BASE_(r13)
...
/* 80099B60 00096AA0  90 0D 94 58 */	stw r0, encoderType-_SDA_BASE_(r13)
...
/* 80099B80 00096AC0  93 AD 94 40 */	stw r29, retraceCount-_SDA_BASE_(r13)
/* 80099B84 00096AC4  3C 60 CC 00 */	lis r3, 0xCC002000@ha
/* 80099B88 00096AC8  38 63 20 00 */	addi r3, r3, 0xCC002000@l
/* 80099B8C 00096ACC  93 AD 94 6C */	stw r29, lbl_80409F2C-_SDA_BASE_(r13)
/* 80099B90 00096AD0  38 00 02 80 */	li r0, 0x280
/* 80099B94 00096AD4  93 AD 94 68 */	stw r29, changed-_SDA_BASE_(r13)
/* 80099B98 00096AD8  93 AD 94 7C */	stw r29, lbl_80409F3C-_SDA_BASE_(r13)
/* 80099B9C 00096ADC  93 AD 94 78 */	stw r29, shdwChanged-_SDA_BASE_(r13)
/* 80099BA0 00096AE0  93 AD 94 60 */	stw r29, changeMode-_SDA_BASE_(r13)
/* 80099BA4 00096AE4  93 AD 94 70 */	stw r29, shdwChangeMode-_SDA_BASE_(r13)
/* 80099BA8 00096AE8  93 AD 94 44 */	stw r29, flushFlag-_SDA_BASE_(r13)
...
/* 80099CE4 00096C24  B3 AD 94 5E */	sth r29, displayOffsetV-_SDA_BASE_(r13)
/* 80099CE8 00096C28  B0 0D 94 5C */	sth r0, displayOffsetH-_SDA_BASE_(r13)
...
/* 80099D50 00096C90  90 8D 94 80 */	stw r4, CurrTiming-_SDA_BASE_(r13)
/* 80099D54 00096C94  80 9C 00 00 */	lwz r4, 0(r28)
/* 80099D58 00096C98  90 8D 94 84 */	stw r4, CurrTvMode-_SDA_BASE_(r13)
/* 80099D5C 00096C9C  B0 1F 00 F4 */	sth r0, 0xf4(r31)
/* 80099D60 00096CA0  80 8D 94 80 */	lwz r4, CurrTiming-_SDA_BASE_(r13)
...
/* 80099D90 00096CD0  A8 AD 94 5C */	lha r5, displayOffsetH-_SDA_BASE_(r13)
...
/* 80099DE4 00096D24  A8 AD 94 5E */	lha r5, displayOffsetV-_SDA_BASE_(r13)
...
/* 80099EFC 00096E3C  38 6D 94 48 */	addi r3, r13, retraceQueue-_SDA_BASE_
...
/* 80099F70 00096EB0  93 8D 94 50 */	stw r28, PreCB-_SDA_BASE_(r13)
/* 80099F74 00096EB4  93 8D 94 54 */	stw r28, PostCB-_SDA_BASE_(r13)
...
/* 80099FBC 00096EFC  83 CD 94 40 */	lwz r30, retraceCount-_SDA_BASE_(r13)
/* 80099FC0 00096F00  7C 7F 1B 78 */	mr r31, r3
lbl_80099FC4:
/* 80099FC4 00096F04  38 6D 94 48 */	addi r3, r13, retraceQueue-_SDA_BASE_
/* 80099FC8 00096F08  4B FF 9C 39 */	bl OSSleepThread
/* 80099FCC 00096F0C  80 0D 94 40 */	lwz r0, retraceCount-_SDA_BASE_(r13)
...
/* 8009A1B8 000970F8  81 4D 94 68 */	lwz r10, changed-_SDA_BASE_(r13)
/* 8009A1BC 000970FC  81 8D 94 6C */	lwz r12, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A1C0 00097100  7D 4A 43 78 */	or r10, r10, r8
/* 8009A1C4 00097104  91 8D 94 6C */	stw r12, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A1C8 00097108  91 4D 94 68 */	stw r10, changed-_SDA_BASE_(r13)
...
/* 8009A1E8 00097128  80 8D 94 68 */	lwz r4, changed-_SDA_BASE_(r13)
/* 8009A1EC 0009712C  81 4D 94 6C */	lwz r10, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A1F0 00097130  7C 80 03 78 */	or r0, r4, r0
/* 8009A1F4 00097134  91 4D 94 6C */	stw r10, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A1F8 00097138  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
/* 8009A1FC 0009713C  80 05 00 00 */	lwz r0, 0(r5)
/* 8009A200 00097140  B0 09 00 26 */	sth r0, 0x26(r9)
/* 8009A204 00097144  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A208 00097148  80 8D 94 6C */	lwz r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A20C 0009714C  60 00 10 00 */	ori r0, r0, 0x1000
/* 8009A210 00097150  90 8D 94 6C */	stw r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A214 00097154  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009A224 00097164  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A228 00097168  80 8D 94 6C */	lwz r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A22C 0009716C  60 00 20 00 */	ori r0, r0, 0x2000
/* 8009A230 00097170  90 8D 94 6C */	stw r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A234 00097174  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009A250 00097190  80 6D 94 68 */	lwz r3, changed-_SDA_BASE_(r13)
/* 8009A254 00097194  80 8D 94 6C */	lwz r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A258 00097198  60 63 40 00 */	ori r3, r3, 0x4000
/* 8009A25C 0009719C  90 8D 94 6C */	stw r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A260 000971A0  90 6D 94 68 */	stw r3, changed-_SDA_BASE_(r13)
...
/* 8009A270 000971B0  80 6D 94 68 */	lwz r3, changed-_SDA_BASE_(r13)
/* 8009A274 000971B4  80 8D 94 6C */	lwz r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A278 000971B8  7C 60 03 78 */	or r0, r3, r0
/* 8009A27C 000971BC  90 8D 94 6C */	stw r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A280 000971C0  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
/* 8009A284 000971C4  80 07 00 00 */	lwz r0, 0(r7)
/* 8009A288 000971C8  B0 09 00 2A */	sth r0, 0x2a(r9)
/* 8009A28C 000971CC  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A290 000971D0  80 6D 94 6C */	lwz r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A294 000971D4  60 00 04 00 */	ori r0, r0, 0x400
/* 8009A298 000971D8  90 6D 94 6C */	stw r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A29C 000971DC  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009A2AC 000971EC  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A2B0 000971F0  80 6D 94 6C */	lwz r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A2B4 000971F4  60 00 08 00 */	ori r0, r0, 0x800
/* 8009A2B8 000971F8  90 6D 94 6C */	stw r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A2BC 000971FC  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
lbl_8009A2C0:
...
/* 8009A3D8 00097318  80 AD 94 68 */	lwz r5, changed-_SDA_BASE_(r13)
/* 8009A3DC 0009731C  3D 00 02 00 */	lis r8, 0x200
/* 8009A3E0 00097320  81 4D 94 6C */	lwz r10, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A3E4 00097324  7C A4 23 78 */	or r4, r5, r4
/* 8009A3E8 00097328  3C A0 00 40 */	lis r5, 0x40
/* 8009A3EC 0009732C  91 4D 94 6C */	stw r10, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A3F0 00097330  90 8D 94 68 */	stw r4, changed-_SDA_BASE_(r13)
/* 8009A3F4 00097334  3C 80 00 80 */	lis r4, 0x80
/* 8009A3F8 00097338  B0 0B 00 0E */	sth r0, 0xe(r11)
/* 8009A3FC 0009733C  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A400 00097340  81 4D 94 6C */	lwz r10, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A404 00097344  7C 00 4B 78 */	or r0, r0, r9
/* 8009A408 00097348  91 4D 94 6C */	stw r10, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A40C 0009734C  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
/* 8009A410 00097350  B0 CB 00 0C */	sth r6, 0xc(r11)
/* 8009A414 00097354  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A418 00097358  80 CD 94 6C */	lwz r6, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A41C 0009735C  7C 00 43 78 */	or r0, r0, r8
/* 8009A420 00097360  90 CD 94 6C */	stw r6, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A424 00097364  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
/* 8009A428 00097368  B0 6B 00 12 */	sth r3, 0x12(r11)
/* 8009A42C 0009736C  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A430 00097370  80 6D 94 6C */	lwz r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A434 00097374  7C 00 2B 78 */	or r0, r0, r5
/* 8009A438 00097378  90 6D 94 6C */	stw r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A43C 0009737C  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
/* 8009A440 00097380  B0 EB 00 10 */	sth r7, 0x10(r11)
/* 8009A444 00097384  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A448 00097388  80 6D 94 6C */	lwz r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A44C 0009738C  7C 00 23 78 */	or r0, r0, r4
/* 8009A450 00097390  90 6D 94 6C */	stw r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A454 00097394  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009A4B4 000973F4  90 0D 94 60 */	stw r0, changeMode-_SDA_BASE_(r13)
...
/* 8009A4D4 00097414  80 0D 94 8C */	lwz r0, message$332-_SDA_BASE_(r13)
...
/* 8009A4E8 00097428  90 0D 94 8C */	stw r0, message$332-_SDA_BASE_(r13)
...
/* 8009A66C 000975AC  A8 6D 94 5C */	lha r3, displayOffsetH-_SDA_BASE_(r13)
...
/* 8009A6BC 000975FC  A8 CD 94 5E */	lha r6, displayOffsetV-_SDA_BASE_(r13)
...
/* 8009A7C0 00097700  80 0D 94 58 */	lwz r0, encoderType-_SDA_BASE_(r13)
...
/* 8009A818 00097758  80 AD 94 68 */	lwz r5, changed-_SDA_BASE_(r13)
/* 8009A81C 0009775C  38 9D 00 02 */	addi r4, r29, 2
/* 8009A820 00097760  80 CD 94 6C */	lwz r6, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A824 00097764  60 A5 00 40 */	ori r5, r5, 0x40
/* 8009A828 00097768  90 CD 94 6C */	stw r6, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A82C 0009776C  90 AD 94 68 */	stw r5, changed-_SDA_BASE_(r13)
/* 8009A830 00097770  B0 1D 00 30 */	sth r0, 0x30(r29)
/* 8009A834 00097774  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009A838 00097778  80 AD 94 6C */	lwz r5, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A83C 0009777C  60 00 00 80 */	ori r0, r0, 0x80
/* 8009A840 00097780  90 AD 94 6C */	stw r5, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A844 00097784  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009A8B8 000977F8  80 8D 94 68 */	lwz r4, changed-_SDA_BASE_(r13)
/* 8009A8BC 000977FC  80 AD 94 6C */	lwz r5, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A8C0 00097800  7C 80 03 78 */	or r0, r4, r0
/* 8009A8C4 00097804  90 AD 94 6C */	stw r5, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A8C8 00097808  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009A8FC 0009783C  80 8D 94 68 */	lwz r4, changed-_SDA_BASE_(r13)
/* 8009A900 00097840  80 0D 94 6C */	lwz r0, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A904 00097844  60 00 02 00 */	ori r0, r0, 0x200
/* 8009A908 00097848  90 0D 94 6C */	stw r0, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A90C 0009784C  90 8D 94 68 */	stw r4, changed-_SDA_BASE_(r13)
...
/* 8009A950 00097890  80 CD 94 68 */	lwz r6, changed-_SDA_BASE_(r13)
/* 8009A954 00097894  80 ED 94 6C */	lwz r7, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A958 00097898  7C E0 03 78 */	or r0, r7, r0
/* 8009A95C 0009789C  90 0D 94 6C */	stw r0, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A960 000978A0  90 CD 94 68 */	stw r6, changed-_SDA_BASE_(r13)
/* 8009A964 000978A4  B1 1D 00 70 */	sth r8, 0x70(r29)
/* 8009A968 000978A8  80 CD 94 68 */	lwz r6, changed-_SDA_BASE_(r13)
/* 8009A96C 000978AC  80 0D 94 6C */	lwz r0, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A970 000978B0  60 00 00 80 */	ori r0, r0, 0x80
/* 8009A974 000978B4  90 0D 94 6C */	stw r0, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A978 000978B8  90 CD 94 68 */	stw r6, changed-_SDA_BASE_(r13)
...
/* 8009A98C 000978CC  80 CD 94 68 */	lwz r6, changed-_SDA_BASE_(r13)
/* 8009A990 000978D0  80 ED 94 6C */	lwz r7, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A994 000978D4  7C E0 03 78 */	or r0, r7, r0
/* 8009A998 000978D8  90 0D 94 6C */	stw r0, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A99C 000978DC  90 CD 94 68 */	stw r6, changed-_SDA_BASE_(r13)
lbl_8009A9A0:
...
/* 8009A9C0 00097900  81 4D 94 68 */	lwz r10, changed-_SDA_BASE_(r13)
/* 8009A9C4 00097904  3C C0 00 10 */	lis r6, 0x10
/* 8009A9C8 00097908  3C 80 00 20 */	lis r4, 0x20
/* 8009A9CC 0009790C  81 6D 94 6C */	lwz r11, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A9D0 00097910  7D 4A 1B 78 */	or r10, r10, r3
/* 8009A9D4 00097914  3C 60 00 04 */	lis r3, 4
/* 8009A9D8 00097918  91 6D 94 6C */	stw r11, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A9DC 0009791C  91 4D 94 68 */	stw r10, changed-_SDA_BASE_(r13)
...
/* 8009A9F0 00097930  81 4D 94 68 */	lwz r10, changed-_SDA_BASE_(r13)
/* 8009A9F4 00097934  81 6D 94 6C */	lwz r11, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009A9F8 00097938  7D 48 43 78 */	or r8, r10, r8
/* 8009A9FC 0009793C  91 6D 94 6C */	stw r11, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AA00 00097940  91 0D 94 68 */	stw r8, changed-_SDA_BASE_(r13)
...
/* 8009AA2C 0009796C  81 4D 94 68 */	lwz r10, changed-_SDA_BASE_(r13)
/* 8009AA30 00097970  7C 0C 00 50 */	subf r0, r12, r0
/* 8009AA34 00097974  56 08 BA 7E */	srwi r8, r16, 9
/* 8009AA38 00097978  81 6D 94 6C */	lwz r11, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AA3C 0009797C  54 00 08 3C */	slwi r0, r0, 1
/* 8009AA40 00097980  7D 49 4B 78 */	or r9, r10, r9
/* 8009AA44 00097984  91 6D 94 6C */	stw r11, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AA48 00097988  7D 00 03 78 */	or r0, r8, r0
/* 8009AA4C 0009798C  91 2D 94 68 */	stw r9, changed-_SDA_BASE_(r13)
/* 8009AA50 00097990  B0 1D 00 08 */	sth r0, 8(r29)
/* 8009AA54 00097994  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009AA58 00097998  81 0D 94 6C */	lwz r8, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AA5C 0009799C  7C 00 3B 78 */	or r0, r0, r7
/* 8009AA60 000979A0  91 0D 94 6C */	stw r8, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AA64 000979A4  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009AA7C 000979BC  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009AA80 000979C0  80 ED 94 6C */	lwz r7, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AA84 000979C4  7C 00 33 78 */	or r0, r0, r6
/* 8009AA88 000979C8  90 ED 94 6C */	stw r7, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AA8C 000979CC  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009AAA4 000979E4  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009AAA8 000979E8  80 CD 94 6C */	lwz r6, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AAAC 000979EC  7C 00 23 78 */	or r0, r0, r4
/* 8009AAB0 000979F0  90 CD 94 6C */	stw r6, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AAB4 000979F4  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009AACC 00097A0C  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009AAD0 00097A10  80 8D 94 6C */	lwz r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AAD4 00097A14  7C 00 1B 78 */	or r0, r0, r3
/* 8009AAD8 00097A18  90 8D 94 6C */	stw r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AADC 00097A1C  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009AAF4 00097A34  80 6D 94 68 */	lwz r3, changed-_SDA_BASE_(r13)
/* 8009AAF8 00097A38  3C 00 00 08 */	lis r0, 8
/* 8009AAFC 00097A3C  38 DD 01 1C */	addi r6, r29, 0x11c
/* 8009AB00 00097A40  80 8D 94 6C */	lwz r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AB04 00097A44  7C 60 03 78 */	or r0, r3, r0
/* 8009AB08 00097A48  90 8D 94 6C */	stw r4, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AB0C 00097A4C  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
...
/* 8009AB88 00097AC8  80 8D 94 68 */	lwz r4, changed-_SDA_BASE_(r13)
/* 8009AB8C 00097ACC  80 0D 94 88 */	lwz r0, FBSet-_SDA_BASE_(r13)
/* 8009AB90 00097AD0  80 AD 94 6C */	lwz r5, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AB94 00097AD4  28 00 00 00 */	cmplwi r0, 0
/* 8009AB98 00097AD8  7C A0 1B 78 */	or r0, r5, r3
/* 8009AB9C 00097ADC  90 0D 94 6C */	stw r0, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009ABA0 00097AE0  90 8D 94 68 */	stw r4, changed-_SDA_BASE_(r13)
...
/* 8009AC1C 00097B5C  80 ED 94 70 */	lwz r7, shdwChangeMode-_SDA_BASE_(r13)
/* 8009AC20 00097B60  3C 80 80 3F */	lis r4, shdwRegs@ha
/* 8009AC24 00097B64  3C A0 80 3F */	lis r5, regs@ha
/* 8009AC28 00097B68  80 CD 94 60 */	lwz r6, changeMode-_SDA_BASE_(r13)
...
/* 8009AC38 00097B78  90 CD 94 70 */	stw r6, shdwChangeMode-_SDA_BASE_(r13)
/* 8009AC3C 00097B7C  3B E5 BD C8 */	addi r31, r5, regs@l
/* 8009AC40 00097B80  3B C3 00 00 */	addi r30, r3, 0
/* 8009AC44 00097B84  90 0D 94 60 */	stw r0, changeMode-_SDA_BASE_(r13)
/* 8009AC48 00097B88  80 8D 94 78 */	lwz r4, shdwChanged-_SDA_BASE_(r13)
/* 8009AC4C 00097B8C  80 AD 94 7C */	lwz r5, lbl_80409F3C-_SDA_BASE_(r13)
/* 8009AC50 00097B90  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009AC54 00097B94  80 6D 94 6C */	lwz r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009AC58 00097B98  7C 80 03 78 */	or r0, r4, r0
/* 8009AC5C 00097B9C  7C A3 1B 78 */	or r3, r5, r3
/* 8009AC60 00097BA0  90 6D 94 7C */	stw r3, lbl_80409F3C-_SDA_BASE_(r13)
/* 8009AC64 00097BA4  90 0D 94 78 */	stw r0, shdwChanged-_SDA_BASE_(r13)
/* 8009AC68 00097BA8  48 00 00 7C */	b lbl_8009ACE4
lbl_8009AC6C:
/* 8009AC6C 00097BAC  80 6D 94 68 */	lwz r3, changed-_SDA_BASE_(r13)
/* 8009AC70 00097BB0  38 A0 00 20 */	li r5, 0x20
/* 8009AC74 00097BB4  83 6D 94 6C */	lwz r27, lbl_80409F2C-_SDA_BASE_(r13)
...
/* 8009ACC4 00097C04  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009ACC8 00097C08  7C 65 18 F8 */	nor r5, r3, r3
/* 8009ACCC 00097C0C  7C 84 20 F8 */	nor r4, r4, r4
/* 8009ACD0 00097C10  80 6D 94 6C */	lwz r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009ACD4 00097C14  7C 00 28 38 */	and r0, r0, r5
/* 8009ACD8 00097C18  7C 63 20 38 */	and r3, r3, r4
/* 8009ACDC 00097C1C  90 6D 94 6C */	stw r3, lbl_80409F2C-_SDA_BASE_(r13)
/* 8009ACE0 00097C20  90 0D 94 68 */	stw r0, changed-_SDA_BASE_(r13)
lbl_8009ACE4:
/* 8009ACE4 00097C24  80 0D 94 68 */	lwz r0, changed-_SDA_BASE_(r13)
/* 8009ACE8 00097C28  38 60 00 00 */	li r3, 0
/* 8009ACEC 00097C2C  80 8D 94 6C */	lwz r4, lbl_80409F2C-_SDA_BASE_(r13)
...
/* 8009AD04 00097C44  90 0D 94 44 */	stw r0, flushFlag-_SDA_BASE_(r13)
...
/* 8009AD54 00097C94  90 0D 94 88 */	stw r0, FBSet-_SDA_BASE_(r13)
...
VIGetRetraceCount:
/* 8009AE0C 00097D4C  80 6D 94 40 */	lwz r3, retraceCount-_SDA_BASE_(r13)
...
/* 8009AE44 00097D84  80 CD 94 80 */	lwz r6, CurrTiming-_SDA_BASE_(r13)
...
/* 8009AEC0 00097E00  80 ED 94 80 */	lwz r7, CurrTiming-_SDA_BASE_(r13)
...
/* 8009AF38 00097E78  83 ED 94 80 */	lwz r31, CurrTiming-_SDA_BASE_(r13)
...
/* 8009AF70 00097EB0  80 8D 94 80 */	lwz r4, CurrTiming-_SDA_BASE_(r13)
...
/* 8009AFD0 00097F10  80 0D 94 84 */	lwz r0, CurrTvMode-_SDA_BASE_(r13)
