...
/* 801C1990 001BE8D0  93 ED 9A 88 */	stw r31, gpMapObjPoleManager-_SDA_BASE_(r13)
...
/* 801C1B5C 001BEA9C  80 02 C8 70 */	lwz r0, $$22186-_SDA2_BASE_(r2)
...
/* 801C1CAC 001BEBEC  C0 42 C8 78 */	lfs f2, $$22279-_SDA2_BASE_(r2)
...
/* 801C1CF4 001BEC34  C0 22 C8 74 */	lfs f1, $$22263-_SDA2_BASE_(r2)
/* 801C1CF8 001BEC38  D3 A3 80 00 */	stfs f29, 0xCC008000@l(r3)
/* 801C1CFC 001BEC3C  C0 02 C8 7C */	lfs f0, $$22303-_SDA2_BASE_(r2)
...
/* 801C1DE4 001BED24  88 0D 97 CC */	lbz r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
/* 801C1DE8 001BED28  7C 00 07 75 */	extsb. r0, r0
/* 801C1DEC 001BED2C  40 82 00 28 */	bne lbl_801C1E14
/* 801C1DF0 001BED30  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
...
/* 801C1E00 001BED40  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
...
/* 801C1E10 001BED50  98 0D 97 CC */	stb r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
lbl_801C1E14:
/* 801C1E14 001BED54  88 0D 97 CD */	lbz r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
/* 801C1E18 001BED58  7C 00 07 75 */	extsb. r0, r0
/* 801C1E1C 001BED5C  40 82 00 28 */	bne lbl_801C1E44
/* 801C1E20 001BED60  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
...
/* 801C1E30 001BED70  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
...
/* 801C1E40 001BED80  98 0D 97 CD */	stb r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
lbl_801C1E44:
/* 801C1E44 001BED84  88 0D 97 CE */	lbz r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
/* 801C1E48 001BED88  7C 00 07 75 */	extsb. r0, r0
/* 801C1E4C 001BED8C  40 82 00 28 */	bne lbl_801C1E74
/* 801C1E50 001BED90  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
...
/* 801C1E60 001BEDA0  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
...
/* 801C1E70 001BEDB0  98 0D 97 CE */	stb r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
lbl_801C1E74:
/* 801C1E74 001BEDB4  88 0D 8F 8C */	lbz r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
/* 801C1E78 001BEDB8  7C 00 07 75 */	extsb. r0, r0
/* 801C1E7C 001BEDBC  40 82 00 28 */	bne lbl_801C1EA4
/* 801C1E80 001BEDC0  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
...
/* 801C1E90 001BEDD0  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
...
/* 801C1EA0 001BEDE0  98 0D 8F 8C */	stb r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
lbl_801C1EA4:
/* 801C1EA4 001BEDE4  88 0D 8F 8D */	lbz r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
/* 801C1EA8 001BEDE8  7C 00 07 75 */	extsb. r0, r0
/* 801C1EAC 001BEDEC  40 82 00 28 */	bne lbl_801C1ED4
/* 801C1EB0 001BEDF0  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
...
/* 801C1EC0 001BEE00  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
...
/* 801C1ED0 001BEE10  98 0D 8F 8D */	stb r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
lbl_801C1ED4:
/* 801C1ED4 001BEE14  88 0D 8F 8E */	lbz r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
/* 801C1ED8 001BEE18  7C 00 07 75 */	extsb. r0, r0
/* 801C1EDC 001BEE1C  40 82 00 28 */	bne lbl_801C1F04
/* 801C1EE0 001BEE20  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
...
/* 801C1EF0 001BEE30  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
...
/* 801C1F00 001BEE40  98 0D 8F 8E */	stb r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
lbl_801C1F04:
/* 801C1F04 001BEE44  88 0D 8F 8F */	lbz r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
/* 801C1F08 001BEE48  7C 00 07 75 */	extsb. r0, r0
/* 801C1F0C 001BEE4C  40 82 00 28 */	bne lbl_801C1F34
/* 801C1F10 001BEE50  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
...
/* 801C1F20 001BEE60  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
...
/* 801C1F30 001BEE70  98 0D 8F 8F */	stb r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
lbl_801C1F34:
/* 801C1F34 001BEE74  88 0D 8F 90 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
/* 801C1F38 001BEE78  7C 00 07 75 */	extsb. r0, r0
/* 801C1F3C 001BEE7C  40 82 00 28 */	bne lbl_801C1F64
/* 801C1F40 001BEE80  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
...
/* 801C1F50 001BEE90  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
...
/* 801C1F60 001BEEA0  98 0D 8F 90 */	stb r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
lbl_801C1F64:
/* 801C1F64 001BEEA4  88 0D 8F 91 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
/* 801C1F68 001BEEA8  7C 00 07 75 */	extsb. r0, r0
/* 801C1F6C 001BEEAC  40 82 00 28 */	bne lbl_801C1F94
/* 801C1F70 001BEEB0  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
...
/* 801C1F80 001BEEC0  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
...
/* 801C1F90 001BEED0  98 0D 8F 91 */	stb r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
lbl_801C1F94:
/* 801C1F94 001BEED4  88 0D 8F 92 */	lbz r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
/* 801C1F98 001BEED8  7C 00 07 75 */	extsb. r0, r0
/* 801C1F9C 001BEEDC  40 82 00 28 */	bne lbl_801C1FC4
/* 801C1FA0 001BEEE0  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
...
/* 801C1FB0 001BEEF0  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
...
/* 801C1FC0 001BEF00  98 0D 8F 92 */	stb r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
lbl_801C1FC4:
/* 801C1FC4 001BEF04  88 0D 8F 93 */	lbz r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
/* 801C1FC8 001BEF08  7C 00 07 75 */	extsb. r0, r0
/* 801C1FCC 001BEF0C  40 82 00 28 */	bne lbl_801C1FF4
/* 801C1FD0 001BEF10  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
...
/* 801C1FE0 001BEF20  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
...
/* 801C1FF0 001BEF30  98 0D 8F 93 */	stb r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
lbl_801C1FF4:
/* 801C1FF4 001BEF34  88 0D 8F 94 */	lbz r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
/* 801C1FF8 001BEF38  7C 00 07 75 */	extsb. r0, r0
/* 801C1FFC 001BEF3C  40 82 00 28 */	bne lbl_801C2024
/* 801C2000 001BEF40  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
...
/* 801C2010 001BEF50  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
...
/* 801C2020 001BEF60  98 0D 8F 94 */	stb r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
lbl_801C2024:
/* 801C2024 001BEF64  88 0D 8F 95 */	lbz r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
/* 801C2028 001BEF68  7C 00 07 75 */	extsb. r0, r0
/* 801C202C 001BEF6C  40 82 00 28 */	bne lbl_801C2054
/* 801C2030 001BEF70  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
...
/* 801C2040 001BEF80  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
...
/* 801C2050 001BEF90  98 0D 8F 95 */	stb r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
lbl_801C2054:
/* 801C2054 001BEF94  88 0D 8F 96 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
/* 801C2058 001BEF98  7C 00 07 75 */	extsb. r0, r0
/* 801C205C 001BEF9C  40 82 00 28 */	bne lbl_801C2084
/* 801C2060 001BEFA0  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
...
/* 801C2070 001BEFB0  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
...
/* 801C2080 001BEFC0  98 0D 8F 96 */	stb r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
lbl_801C2084:
/* 801C2084 001BEFC4  88 0D 8F 97 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
/* 801C2088 001BEFC8  7C 00 07 75 */	extsb. r0, r0
/* 801C208C 001BEFCC  40 82 00 28 */	bne lbl_801C20B4
/* 801C2090 001BEFD0  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
...
/* 801C20A0 001BEFE0  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
...
/* 801C20B0 001BEFF0  98 0D 8F 97 */	stb r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
lbl_801C20B4:
...
.section .ctors, "wa"  # 0x8036FBA0 - 0x8036FF80
	.incbin "baserom.dol", 0x36CD68, 0x4
