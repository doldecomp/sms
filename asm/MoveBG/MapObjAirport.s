...
/* 801BDB30 001BAA70  3C 60 80 39 */	lis r3, "@2901"@ha
/* 801BDB34 001BAA74  3B E3 F8 00 */	addi r31, r3, "@2901"@l
...
/* 801BDB7C 001BAABC  C0 02 C7 C8 */	lfs f0, "@2902"@sda21(r2)
...
/* 801BDBD8 001BAB18  3C 60 80 39 */	lis r3, "@2916"@ha
/* 801BDBDC 001BAB1C  38 83 F8 1C */	addi r4, r3, "@2916"@l
...
/* 801BDC08 001BAB48  C0 22 C7 CC */	lfs f1, "@2917"@sda21(r2)
/* 801BDC0C 001BAB4C  38 A5 00 10 */	addi r5, r5, 0x10
/* 801BDC10 001BAB50  4B F2 FB B1 */	bl "fireStartDemoCamera__12TMarDirectorFPCcPCQ29JGeometry8TVec3<f>lfbPFUlUl_lUlPQ26JDrama6TActorQ26JDrama10TFlagT<Us>"
...
/* 801BDC98 001BABD8  C0 22 C7 D0 */	lfs f1, "@2924"@sda21(r2)
...
/* 801BDCF8 001BAC38  C0 22 C7 CC */	lfs f1, "@2917"@sda21(r2)
/* 801BDCFC 001BAC3C  3C 80 80 39 */	lis r4, "@2932"@ha
/* 801BDD00 001BAC40  3C A0 80 39 */	lis r5, "@2933"@ha
...
/* 801BDD10 001BAC50  38 84 F8 30 */	addi r4, r4, "@2932"@l
/* 801BDD14 001BAC54  38 A5 F8 48 */	addi r5, r5, "@2933"@l
...
/* 801BDDBC 001BACFC  3C 60 80 39 */	lis r3, "@2948"@ha
/* 801BDDC0 001BAD00  3B E3 F8 60 */	addi r31, r3, "@2948"@l
...
/* 801BDF78 001BAEB8  3C 60 80 3F */	lis r3, "@2992"@ha
...
/* 801BDF88 001BAEC8  3B E3 68 48 */	addi r31, r3, "@2992"@l
/* 801BDF8C 001BAECC  88 0D 97 CC */	lbz r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
/* 801BDF90 001BAED0  7C 00 07 75 */	extsb. r0, r0
/* 801BDF94 001BAED4  40 82 00 28 */	bne lbl_801BDFBC
/* 801BDF98 001BAED8  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
/* 801BDF9C 001BAEDC  4B E5 0C 99 */	bl initiate__10JSUPtrListFv
/* 801BDFA0 001BAEE0  3C 60 80 0E */	lis r3, "__dt__15JSUList<5MSBgm>Fv"@ha
/* 801BDFA4 001BAEE4  38 83 6A 44 */	addi r4, r3, "__dt__15JSUList<5MSBgm>Fv"@l
/* 801BDFA8 001BAEE8  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
...
/* 801BDFB8 001BAEF8  98 0D 97 CC */	stb r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
lbl_801BDFBC:
/* 801BDFBC 001BAEFC  88 0D 97 CD */	lbz r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
/* 801BDFC0 001BAF00  7C 00 07 75 */	extsb. r0, r0
/* 801BDFC4 001BAF04  40 82 00 28 */	bne lbl_801BDFEC
/* 801BDFC8 001BAF08  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
/* 801BDFCC 001BAF0C  4B E5 0C 69 */	bl initiate__10JSUPtrListFv
/* 801BDFD0 001BAF10  3C 60 80 0E */	lis r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@ha
/* 801BDFD4 001BAF14  38 83 69 EC */	addi r4, r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@l
/* 801BDFD8 001BAF18  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
...
/* 801BDFE8 001BAF28  98 0D 97 CD */	stb r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
lbl_801BDFEC:
/* 801BDFEC 001BAF2C  88 0D 97 CE */	lbz r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
/* 801BDFF0 001BAF30  7C 00 07 75 */	extsb. r0, r0
/* 801BDFF4 001BAF34  40 82 00 28 */	bne lbl_801BE01C
/* 801BDFF8 001BAF38  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
/* 801BDFFC 001BAF3C  4B E5 0C 39 */	bl initiate__10JSUPtrListFv
/* 801BE000 001BAF40  3C 60 80 0E */	lis r3, "__dt__21JSUList<10MSSetSound>Fv"@ha
/* 801BE004 001BAF44  38 83 69 94 */	addi r4, r3, "__dt__21JSUList<10MSSetSound>Fv"@l
/* 801BE008 001BAF48  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
...
/* 801BE018 001BAF58  98 0D 97 CE */	stb r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
lbl_801BE01C:
/* 801BE01C 001BAF5C  88 0D 8F 8C */	lbz r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
/* 801BE020 001BAF60  7C 00 07 75 */	extsb. r0, r0
/* 801BE024 001BAF64  40 82 00 28 */	bne lbl_801BE04C
/* 801BE028 001BAF68  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
/* 801BE02C 001BAF6C  4B E5 0C 09 */	bl initiate__10JSUPtrListFv
/* 801BE030 001BAF70  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@ha
/* 801BE034 001BAF74  38 83 A8 0C */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@l
/* 801BE038 001BAF78  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
...
/* 801BE048 001BAF88  98 0D 8F 8C */	stb r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
lbl_801BE04C:
/* 801BE04C 001BAF8C  88 0D 8F 8D */	lbz r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
/* 801BE050 001BAF90  7C 00 07 75 */	extsb. r0, r0
/* 801BE054 001BAF94  40 82 00 28 */	bne lbl_801BE07C
/* 801BE058 001BAF98  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
/* 801BE05C 001BAF9C  4B E5 0B D9 */	bl initiate__10JSUPtrListFv
/* 801BE060 001BAFA0  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@ha
/* 801BE064 001BAFA4  38 83 A7 B4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@l
/* 801BE068 001BAFA8  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
...
/* 801BE078 001BAFB8  98 0D 8F 8D */	stb r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
lbl_801BE07C:
/* 801BE07C 001BAFBC  88 0D 8F 8E */	lbz r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
/* 801BE080 001BAFC0  7C 00 07 75 */	extsb. r0, r0
/* 801BE084 001BAFC4  40 82 00 28 */	bne lbl_801BE0AC
/* 801BE088 001BAFC8  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
/* 801BE08C 001BAFCC  4B E5 0B A9 */	bl initiate__10JSUPtrListFv
/* 801BE090 001BAFD0  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@ha
/* 801BE094 001BAFD4  38 83 A7 5C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@l
/* 801BE098 001BAFD8  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
...
/* 801BE0A8 001BAFE8  98 0D 8F 8E */	stb r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
lbl_801BE0AC:
/* 801BE0AC 001BAFEC  88 0D 8F 8F */	lbz r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
/* 801BE0B0 001BAFF0  7C 00 07 75 */	extsb. r0, r0
/* 801BE0B4 001BAFF4  40 82 00 28 */	bne lbl_801BE0DC
/* 801BE0B8 001BAFF8  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
/* 801BE0BC 001BAFFC  4B E5 0B 79 */	bl initiate__10JSUPtrListFv
/* 801BE0C0 001BB000  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@ha
/* 801BE0C4 001BB004  38 83 A7 04 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@l
/* 801BE0C8 001BB008  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
...
/* 801BE0D8 001BB018  98 0D 8F 8F */	stb r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
lbl_801BE0DC:
/* 801BE0DC 001BB01C  88 0D 8F 90 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
/* 801BE0E0 001BB020  7C 00 07 75 */	extsb. r0, r0
/* 801BE0E4 001BB024  40 82 00 28 */	bne lbl_801BE10C
/* 801BE0E8 001BB028  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
/* 801BE0EC 001BB02C  4B E5 0B 49 */	bl initiate__10JSUPtrListFv
/* 801BE0F0 001BB030  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@ha
/* 801BE0F4 001BB034  38 83 A6 AC */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@l
/* 801BE0F8 001BB038  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
...
/* 801BE108 001BB048  98 0D 8F 90 */	stb r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
lbl_801BE10C:
/* 801BE10C 001BB04C  88 0D 8F 91 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
/* 801BE110 001BB050  7C 00 07 75 */	extsb. r0, r0
/* 801BE114 001BB054  40 82 00 28 */	bne lbl_801BE13C
/* 801BE118 001BB058  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
/* 801BE11C 001BB05C  4B E5 0B 19 */	bl initiate__10JSUPtrListFv
/* 801BE120 001BB060  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@ha
/* 801BE124 001BB064  38 83 A6 54 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@l
/* 801BE128 001BB068  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
...
/* 801BE138 001BB078  98 0D 8F 91 */	stb r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
lbl_801BE13C:
/* 801BE13C 001BB07C  88 0D 8F 92 */	lbz r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
/* 801BE140 001BB080  7C 00 07 75 */	extsb. r0, r0
/* 801BE144 001BB084  40 82 00 28 */	bne lbl_801BE16C
/* 801BE148 001BB088  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
/* 801BE14C 001BB08C  4B E5 0A E9 */	bl initiate__10JSUPtrListFv
/* 801BE150 001BB090  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@ha
/* 801BE154 001BB094  38 83 A5 FC */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@l
/* 801BE158 001BB098  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
...
/* 801BE168 001BB0A8  98 0D 8F 92 */	stb r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
lbl_801BE16C:
/* 801BE16C 001BB0AC  88 0D 8F 93 */	lbz r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
/* 801BE170 001BB0B0  7C 00 07 75 */	extsb. r0, r0
/* 801BE174 001BB0B4  40 82 00 28 */	bne lbl_801BE19C
/* 801BE178 001BB0B8  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
/* 801BE17C 001BB0BC  4B E5 0A B9 */	bl initiate__10JSUPtrListFv
/* 801BE180 001BB0C0  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@ha
/* 801BE184 001BB0C4  38 83 A5 A4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@l
/* 801BE188 001BB0C8  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
...
/* 801BE198 001BB0D8  98 0D 8F 93 */	stb r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
lbl_801BE19C:
/* 801BE19C 001BB0DC  88 0D 8F 94 */	lbz r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
/* 801BE1A0 001BB0E0  7C 00 07 75 */	extsb. r0, r0
/* 801BE1A4 001BB0E4  40 82 00 28 */	bne lbl_801BE1CC
/* 801BE1A8 001BB0E8  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
/* 801BE1AC 001BB0EC  4B E5 0A 89 */	bl initiate__10JSUPtrListFv
/* 801BE1B0 001BB0F0  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@ha
/* 801BE1B4 001BB0F4  38 83 A5 4C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@l
/* 801BE1B8 001BB0F8  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
...
/* 801BE1C8 001BB108  98 0D 8F 94 */	stb r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
lbl_801BE1CC:
/* 801BE1CC 001BB10C  88 0D 8F 95 */	lbz r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
/* 801BE1D0 001BB110  7C 00 07 75 */	extsb. r0, r0
/* 801BE1D4 001BB114  40 82 00 28 */	bne lbl_801BE1FC
/* 801BE1D8 001BB118  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
/* 801BE1DC 001BB11C  4B E5 0A 59 */	bl initiate__10JSUPtrListFv
/* 801BE1E0 001BB120  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@ha
/* 801BE1E4 001BB124  38 83 A4 F4 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@l
/* 801BE1E8 001BB128  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
...
/* 801BE1F8 001BB138  98 0D 8F 95 */	stb r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
lbl_801BE1FC:
/* 801BE1FC 001BB13C  88 0D 8F 96 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
/* 801BE200 001BB140  7C 00 07 75 */	extsb. r0, r0
/* 801BE204 001BB144  40 82 00 28 */	bne lbl_801BE22C
/* 801BE208 001BB148  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
/* 801BE20C 001BB14C  4B E5 0A 29 */	bl initiate__10JSUPtrListFv
/* 801BE210 001BB150  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@ha
/* 801BE214 001BB154  38 83 A4 9C */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@l
/* 801BE218 001BB158  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
...
/* 801BE228 001BB168  98 0D 8F 96 */	stb r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
lbl_801BE22C:
/* 801BE22C 001BB16C  88 0D 8F 97 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
/* 801BE230 001BB170  7C 00 07 75 */	extsb. r0, r0
/* 801BE234 001BB174  40 82 00 28 */	bne lbl_801BE25C
/* 801BE238 001BB178  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
/* 801BE23C 001BB17C  4B E5 09 F9 */	bl initiate__10JSUPtrListFv
/* 801BE240 001BB180  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@ha
/* 801BE244 001BB184  38 83 A4 44 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@l
/* 801BE248 001BB188  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
...
/* 801BE258 001BB198  98 0D 8F 97 */	stb r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
lbl_801BE25C:
...
.global "@32@__dt__14TAirportSwitchFv"
"@32@__dt__14TAirportSwitchFv":
...
__vt__14TAirportSwitch:
  ...
  .4byte 0
  .4byte 0
  .4byte "@32@__dt__14TAirportSwitchFv"
