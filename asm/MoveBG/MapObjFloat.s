...
/* 801B5888 001B27C8  C0 02 C6 A0 */	lfs f0, $$22512@sda21(r2)
...
/* 801B59EC 001B292C  C0 02 C6 A0 */	lfs f0, $$22512@sda21(r2)
...
/* 801B5AA4 001B29E4  C0 02 C6 A0 */	lfs f0, $$22512@sda21(r2)
...
/* 801B5B50 001B2A90  88 0D 97 CC */	lbz r0, __init__smList__15JALList$$05MSBgm$$1@sda21(r13)
/* 801B5B54 001B2A94  7C 00 07 75 */	extsb. r0, r0
/* 801B5B58 001B2A98  40 82 00 28 */	bne lbl_801B5B80
/* 801B5B5C 001B2A9C  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1@sda21
...
/* 801B5B6C 001B2AAC  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1@sda21
...
/* 801B5B7C 001B2ABC  98 0D 97 CC */	stb r0, __init__smList__15JALList$$05MSBgm$$1@sda21(r13)
lbl_801B5B80:
/* 801B5B80 001B2AC0  88 0D 97 CD */	lbz r0, __init__smList__24JALList$$013MSSetSoundGrp$$1@sda21(r13)
/* 801B5B84 001B2AC4  7C 00 07 75 */	extsb. r0, r0
/* 801B5B88 001B2AC8  40 82 00 28 */	bne lbl_801B5BB0
/* 801B5B8C 001B2ACC  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1@sda21
...
/* 801B5B9C 001B2ADC  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1@sda21
...
/* 801B5BAC 001B2AEC  98 0D 97 CD */	stb r0, __init__smList__24JALList$$013MSSetSoundGrp$$1@sda21(r13)
lbl_801B5BB0:
/* 801B5BB0 001B2AF0  88 0D 97 CE */	lbz r0, __init__smList__21JALList$$010MSSetSound$$1@sda21(r13)
/* 801B5BB4 001B2AF4  7C 00 07 75 */	extsb. r0, r0
/* 801B5BB8 001B2AF8  40 82 00 28 */	bne lbl_801B5BE0
/* 801B5BBC 001B2AFC  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1@sda21
...
/* 801B5BCC 001B2B0C  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1@sda21
...
/* 801B5BDC 001B2B1C  98 0D 97 CE */	stb r0, __init__smList__21JALList$$010MSSetSound$$1@sda21(r13)
lbl_801B5BE0:
/* 801B5BE0 001B2B20  88 0D 8F 8C */	lbz r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1@sda21(r13)
/* 801B5BE4 001B2B24  7C 00 07 75 */	extsb. r0, r0
/* 801B5BE8 001B2B28  40 82 00 28 */	bne lbl_801B5C10
/* 801B5BEC 001B2B2C  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1@sda21
...
/* 801B5BFC 001B2B3C  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1@sda21
...
/* 801B5C0C 001B2B4C  98 0D 8F 8C */	stb r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1@sda21(r13)
lbl_801B5C10:
/* 801B5C10 001B2B50  88 0D 8F 8D */	lbz r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1@sda21(r13)
/* 801B5C14 001B2B54  7C 00 07 75 */	extsb. r0, r0
/* 801B5C18 001B2B58  40 82 00 28 */	bne lbl_801B5C40
/* 801B5C1C 001B2B5C  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1@sda21
...
/* 801B5C2C 001B2B6C  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1@sda21
...
/* 801B5C3C 001B2B7C  98 0D 8F 8D */	stb r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1@sda21(r13)
lbl_801B5C40:
/* 801B5C40 001B2B80  88 0D 8F 8E */	lbz r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1@sda21(r13)
/* 801B5C44 001B2B84  7C 00 07 75 */	extsb. r0, r0
/* 801B5C48 001B2B88  40 82 00 28 */	bne lbl_801B5C70
/* 801B5C4C 001B2B8C  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1@sda21
...
/* 801B5C5C 001B2B9C  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1@sda21
...
/* 801B5C6C 001B2BAC  98 0D 8F 8E */	stb r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1@sda21(r13)
lbl_801B5C70:
/* 801B5C70 001B2BB0  88 0D 8F 8F */	lbz r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1@sda21(r13)
/* 801B5C74 001B2BB4  7C 00 07 75 */	extsb. r0, r0
/* 801B5C78 001B2BB8  40 82 00 28 */	bne lbl_801B5CA0
/* 801B5C7C 001B2BBC  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1@sda21
...
/* 801B5C8C 001B2BCC  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1@sda21
...
/* 801B5C9C 001B2BDC  98 0D 8F 8F */	stb r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1@sda21(r13)
lbl_801B5CA0:
/* 801B5CA0 001B2BE0  88 0D 8F 90 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1@sda21(r13)
/* 801B5CA4 001B2BE4  7C 00 07 75 */	extsb. r0, r0
/* 801B5CA8 001B2BE8  40 82 00 28 */	bne lbl_801B5CD0
/* 801B5CAC 001B2BEC  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1@sda21
...
/* 801B5CBC 001B2BFC  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1@sda21
...
/* 801B5CCC 001B2C0C  98 0D 8F 90 */	stb r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1@sda21(r13)
lbl_801B5CD0:
/* 801B5CD0 001B2C10  88 0D 8F 91 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1@sda21(r13)
/* 801B5CD4 001B2C14  7C 00 07 75 */	extsb. r0, r0
/* 801B5CD8 001B2C18  40 82 00 28 */	bne lbl_801B5D00
/* 801B5CDC 001B2C1C  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1@sda21
...
/* 801B5CEC 001B2C2C  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1@sda21
...
/* 801B5CFC 001B2C3C  98 0D 8F 91 */	stb r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1@sda21(r13)
lbl_801B5D00:
/* 801B5D00 001B2C40  88 0D 8F 92 */	lbz r0, __init__smList__26JALList$$015JALSeModEffDist$$1@sda21(r13)
/* 801B5D04 001B2C44  7C 00 07 75 */	extsb. r0, r0
/* 801B5D08 001B2C48  40 82 00 28 */	bne lbl_801B5D30
/* 801B5D0C 001B2C4C  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1@sda21
...
/* 801B5D1C 001B2C5C  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1@sda21
...
/* 801B5D2C 001B2C6C  98 0D 8F 92 */	stb r0, __init__smList__26JALList$$015JALSeModEffDist$$1@sda21(r13)
lbl_801B5D30:
/* 801B5D30 001B2C70  88 0D 8F 93 */	lbz r0, __init__smList__26JALList$$015JALSeModPitDist$$1@sda21(r13)
/* 801B5D34 001B2C74  7C 00 07 75 */	extsb. r0, r0
/* 801B5D38 001B2C78  40 82 00 28 */	bne lbl_801B5D60
/* 801B5D3C 001B2C7C  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1@sda21
...
/* 801B5D4C 001B2C8C  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1@sda21
...
/* 801B5D5C 001B2C9C  98 0D 8F 93 */	stb r0, __init__smList__26JALList$$015JALSeModPitDist$$1@sda21(r13)
lbl_801B5D60:
/* 801B5D60 001B2CA0  88 0D 8F 94 */	lbz r0, __init__smList__26JALList$$015JALSeModVolDist$$1@sda21(r13)
/* 801B5D64 001B2CA4  7C 00 07 75 */	extsb. r0, r0
/* 801B5D68 001B2CA8  40 82 00 28 */	bne lbl_801B5D90
/* 801B5D6C 001B2CAC  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1@sda21
...
/* 801B5D7C 001B2CBC  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1@sda21
...
/* 801B5D8C 001B2CCC  98 0D 8F 94 */	stb r0, __init__smList__26JALList$$015JALSeModVolDist$$1@sda21(r13)
lbl_801B5D90:
/* 801B5D90 001B2CD0  88 0D 8F 95 */	lbz r0, __init__smList__26JALList$$015JALSeModEffFunk$$1@sda21(r13)
/* 801B5D94 001B2CD4  7C 00 07 75 */	extsb. r0, r0
/* 801B5D98 001B2CD8  40 82 00 28 */	bne lbl_801B5DC0
/* 801B5D9C 001B2CDC  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1@sda21
...
/* 801B5DAC 001B2CEC  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1@sda21
...
/* 801B5DBC 001B2CFC  98 0D 8F 95 */	stb r0, __init__smList__26JALList$$015JALSeModEffFunk$$1@sda21(r13)
lbl_801B5DC0:
/* 801B5DC0 001B2D00  88 0D 8F 96 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFunk$$1@sda21(r13)
/* 801B5DC4 001B2D04  7C 00 07 75 */	extsb. r0, r0
/* 801B5DC8 001B2D08  40 82 00 28 */	bne lbl_801B5DF0
/* 801B5DCC 001B2D0C  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1@sda21
...
/* 801B5DDC 001B2D1C  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1@sda21
...
/* 801B5DEC 001B2D2C  98 0D 8F 96 */	stb r0, __init__smList__26JALList$$015JALSeModPitFunk$$1@sda21(r13)
lbl_801B5DF0:
/* 801B5DF0 001B2D30  88 0D 8F 97 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFunk$$1@sda21(r13)
/* 801B5DF4 001B2D34  7C 00 07 75 */	extsb. r0, r0
/* 801B5DF8 001B2D38  40 82 00 28 */	bne lbl_801B5E20
/* 801B5DFC 001B2D3C  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1@sda21
...
/* 801B5E0C 001B2D4C  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1@sda21
...
/* 801B5E1C 001B2D5C  98 0D 8F 97 */	stb r0, __init__smList__26JALList$$015JALSeModVolFunk$$1@sda21(r13)
lbl_801B5E20:
...
__vt__17TMapObjFloatOnSea:
  ...
  .4byte 0
  .4byte 0
  .4byte $$232$$2__dt__17TMapObjFloatOnSeaFv
