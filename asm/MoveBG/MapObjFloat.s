...
/* 801B5888 001B27C8  C0 02 C6 A0 */	lfs f0, $$22512-_SDA2_BASE_(r2)
...
/* 801B58B4 001B27F4  3C 80 80 39 */	lis r4, $$21490@ha
...
/* 801B58C8 001B2808  3B 84 F1 98 */	addi r28, r4, $$21490@l
...
/* 801B5944 001B2884  80 6D 98 50 */	lwz r3, gpResourceManager-_SDA_BASE_(r13)
...
/* 801B5974 001B28B4  80 6D 98 50 */	lwz r3, gpResourceManager-_SDA_BASE_(r13)
...
/* 801B59EC 001B292C  C0 02 C6 A0 */	lfs f0, $$22512-_SDA2_BASE_(r2)
...
/* 801B5A30 001B2970  4B FD B0 AD */	bl emitAndScale__11TMapObjBaseCFlUcPCQ29JGeometry8TVec3$$0f$$1RCQ29JGeometry8TVec3$$0f$$1
...
/* 801B5A48 001B2988  4B FD B0 95 */	bl emitAndScale__11TMapObjBaseCFlUcPCQ29JGeometry8TVec3$$0f$$1RCQ29JGeometry8TVec3$$0f$$1
...
/* 801B5A98 001B29D8  88 0D 9A 64 */	lbz r0, init$2478-_SDA_BASE_(r13)
/* 801B5A9C 001B29DC  7C 00 07 75 */	extsb. r0, r0
/* 801B5AA0 001B29E0  40 82 00 14 */	bne lbl_801B5AB4
/* 801B5AA4 001B29E4  C0 02 C6 A0 */	lfs f0, $$22512-_SDA2_BASE_(r2)
/* 801B5AA8 001B29E8  38 00 00 01 */	li r0, 1
/* 801B5AAC 001B29EC  98 0D 9A 64 */	stb r0, init$2478-_SDA_BASE_(r13)
/* 801B5AB0 001B29F0  D0 0D 9A 60 */	stfs f0, timer$2477-_SDA_BASE_(r13)
lbl_801B5AB4:
...
/* 801B5B3C 001B2A7C  3C 60 80 3F */	lis r3, $$22557@ha
...
/* 801B5B4C 001B2A8C  3B E3 65 68 */	addi r31, r3, $$22557@l
/* 801B5B50 001B2A90  88 0D 97 CC */	lbz r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
/* 801B5B54 001B2A94  7C 00 07 75 */	extsb. r0, r0
/* 801B5B58 001B2A98  40 82 00 28 */	bne lbl_801B5B80
/* 801B5B5C 001B2A9C  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
/* 801B5B60 001B2AA0  4B E5 90 D5 */	bl initiate__10JSUPtrListFv
/* 801B5B64 001B2AA4  3C 60 80 0E */	lis r3, __dt__15JSUList$$05MSBgm$$1Fv@ha
/* 801B5B68 001B2AA8  38 83 6A 44 */	addi r4, r3, __dt__15JSUList$$05MSBgm$$1Fv@l
/* 801B5B6C 001B2AAC  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
...
/* 801B5B7C 001B2ABC  98 0D 97 CC */	stb r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
lbl_801B5B80:
/* 801B5B80 001B2AC0  88 0D 97 CD */	lbz r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
/* 801B5B84 001B2AC4  7C 00 07 75 */	extsb. r0, r0
/* 801B5B88 001B2AC8  40 82 00 28 */	bne lbl_801B5BB0
/* 801B5B8C 001B2ACC  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
/* 801B5B90 001B2AD0  4B E5 90 A5 */	bl initiate__10JSUPtrListFv
/* 801B5B94 001B2AD4  3C 60 80 0E */	lis r3, __dt__24JSUList$$013MSSetSoundGrp$$1Fv@ha
/* 801B5B98 001B2AD8  38 83 69 EC */	addi r4, r3, __dt__24JSUList$$013MSSetSoundGrp$$1Fv@l
/* 801B5B9C 001B2ADC  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
...
/* 801B5BAC 001B2AEC  98 0D 97 CD */	stb r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
lbl_801B5BB0:
/* 801B5BB0 001B2AF0  88 0D 97 CE */	lbz r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
/* 801B5BB4 001B2AF4  7C 00 07 75 */	extsb. r0, r0
/* 801B5BB8 001B2AF8  40 82 00 28 */	bne lbl_801B5BE0
/* 801B5BBC 001B2AFC  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
/* 801B5BC0 001B2B00  4B E5 90 75 */	bl initiate__10JSUPtrListFv
/* 801B5BC4 001B2B04  3C 60 80 0E */	lis r3, __dt__21JSUList$$010MSSetSound$$1Fv@ha
/* 801B5BC8 001B2B08  38 83 69 94 */	addi r4, r3, __dt__21JSUList$$010MSSetSound$$1Fv@l
/* 801B5BCC 001B2B0C  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
...
/* 801B5BDC 001B2B1C  98 0D 97 CE */	stb r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
lbl_801B5BE0:
/* 801B5BE0 001B2B20  88 0D 8F 8C */	lbz r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
/* 801B5BE4 001B2B24  7C 00 07 75 */	extsb. r0, r0
/* 801B5BE8 001B2B28  40 82 00 28 */	bne lbl_801B5C10
/* 801B5BEC 001B2B2C  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
/* 801B5BF0 001B2B30  4B E5 90 45 */	bl initiate__10JSUPtrListFv
/* 801B5BF4 001B2B34  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModEffDGrp$$1Fv@ha
/* 801B5BF8 001B2B38  38 83 A8 0C */	addi r4, r3, __dt__26JSUList$$015JALSeModEffDGrp$$1Fv@l
/* 801B5BFC 001B2B3C  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
...
/* 801B5C0C 001B2B4C  98 0D 8F 8C */	stb r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
lbl_801B5C10:
/* 801B5C10 001B2B50  88 0D 8F 8D */	lbz r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
/* 801B5C14 001B2B54  7C 00 07 75 */	extsb. r0, r0
/* 801B5C18 001B2B58  40 82 00 28 */	bne lbl_801B5C40
/* 801B5C1C 001B2B5C  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
/* 801B5C20 001B2B60  4B E5 90 15 */	bl initiate__10JSUPtrListFv
/* 801B5C24 001B2B64  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModPitDGrp$$1Fv@ha
/* 801B5C28 001B2B68  38 83 A7 B4 */	addi r4, r3, __dt__26JSUList$$015JALSeModPitDGrp$$1Fv@l
/* 801B5C2C 001B2B6C  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
...
/* 801B5C3C 001B2B7C  98 0D 8F 8D */	stb r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
lbl_801B5C40:
/* 801B5C40 001B2B80  88 0D 8F 8E */	lbz r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
/* 801B5C44 001B2B84  7C 00 07 75 */	extsb. r0, r0
/* 801B5C48 001B2B88  40 82 00 28 */	bne lbl_801B5C70
/* 801B5C4C 001B2B8C  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
/* 801B5C50 001B2B90  4B E5 8F E5 */	bl initiate__10JSUPtrListFv
/* 801B5C54 001B2B94  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModVolDGrp$$1Fv@ha
/* 801B5C58 001B2B98  38 83 A7 5C */	addi r4, r3, __dt__26JSUList$$015JALSeModVolDGrp$$1Fv@l
/* 801B5C5C 001B2B9C  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
...
/* 801B5C6C 001B2BAC  98 0D 8F 8E */	stb r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
lbl_801B5C70:
/* 801B5C70 001B2BB0  88 0D 8F 8F */	lbz r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
/* 801B5C74 001B2BB4  7C 00 07 75 */	extsb. r0, r0
/* 801B5C78 001B2BB8  40 82 00 28 */	bne lbl_801B5CA0
/* 801B5C7C 001B2BBC  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
/* 801B5C80 001B2BC0  4B E5 8F B5 */	bl initiate__10JSUPtrListFv
/* 801B5C84 001B2BC4  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModEffFGrp$$1Fv@ha
/* 801B5C88 001B2BC8  38 83 A7 04 */	addi r4, r3, __dt__26JSUList$$015JALSeModEffFGrp$$1Fv@l
/* 801B5C8C 001B2BCC  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
...
/* 801B5C9C 001B2BDC  98 0D 8F 8F */	stb r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
lbl_801B5CA0:
/* 801B5CA0 001B2BE0  88 0D 8F 90 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
/* 801B5CA4 001B2BE4  7C 00 07 75 */	extsb. r0, r0
/* 801B5CA8 001B2BE8  40 82 00 28 */	bne lbl_801B5CD0
/* 801B5CAC 001B2BEC  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
/* 801B5CB0 001B2BF0  4B E5 8F 85 */	bl initiate__10JSUPtrListFv
/* 801B5CB4 001B2BF4  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModPitFGrp$$1Fv@ha
/* 801B5CB8 001B2BF8  38 83 A6 AC */	addi r4, r3, __dt__26JSUList$$015JALSeModPitFGrp$$1Fv@l
/* 801B5CBC 001B2BFC  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
...
/* 801B5CCC 001B2C0C  98 0D 8F 90 */	stb r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
lbl_801B5CD0:
/* 801B5CD0 001B2C10  88 0D 8F 91 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
/* 801B5CD4 001B2C14  7C 00 07 75 */	extsb. r0, r0
/* 801B5CD8 001B2C18  40 82 00 28 */	bne lbl_801B5D00
/* 801B5CDC 001B2C1C  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
/* 801B5CE0 001B2C20  4B E5 8F 55 */	bl initiate__10JSUPtrListFv
/* 801B5CE4 001B2C24  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModVolFGrp$$1Fv@ha
/* 801B5CE8 001B2C28  38 83 A6 54 */	addi r4, r3, __dt__26JSUList$$015JALSeModVolFGrp$$1Fv@l
/* 801B5CEC 001B2C2C  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
...
/* 801B5CFC 001B2C3C  98 0D 8F 91 */	stb r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
lbl_801B5D00:
/* 801B5D00 001B2C40  88 0D 8F 92 */	lbz r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
/* 801B5D04 001B2C44  7C 00 07 75 */	extsb. r0, r0
/* 801B5D08 001B2C48  40 82 00 28 */	bne lbl_801B5D30
/* 801B5D0C 001B2C4C  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
/* 801B5D10 001B2C50  4B E5 8F 25 */	bl initiate__10JSUPtrListFv
/* 801B5D14 001B2C54  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModEffDist$$1Fv@ha
/* 801B5D18 001B2C58  38 83 A5 FC */	addi r4, r3, __dt__26JSUList$$015JALSeModEffDist$$1Fv@l
/* 801B5D1C 001B2C5C  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
...
/* 801B5D2C 001B2C6C  98 0D 8F 92 */	stb r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
lbl_801B5D30:
/* 801B5D30 001B2C70  88 0D 8F 93 */	lbz r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
/* 801B5D34 001B2C74  7C 00 07 75 */	extsb. r0, r0
/* 801B5D38 001B2C78  40 82 00 28 */	bne lbl_801B5D60
/* 801B5D3C 001B2C7C  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
/* 801B5D40 001B2C80  4B E5 8E F5 */	bl initiate__10JSUPtrListFv
/* 801B5D44 001B2C84  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModPitDist$$1Fv@ha
/* 801B5D48 001B2C88  38 83 A5 A4 */	addi r4, r3, __dt__26JSUList$$015JALSeModPitDist$$1Fv@l
/* 801B5D4C 001B2C8C  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
...
/* 801B5D5C 001B2C9C  98 0D 8F 93 */	stb r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
lbl_801B5D60:
/* 801B5D60 001B2CA0  88 0D 8F 94 */	lbz r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
/* 801B5D64 001B2CA4  7C 00 07 75 */	extsb. r0, r0
/* 801B5D68 001B2CA8  40 82 00 28 */	bne lbl_801B5D90
/* 801B5D6C 001B2CAC  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
/* 801B5D70 001B2CB0  4B E5 8E C5 */	bl initiate__10JSUPtrListFv
/* 801B5D74 001B2CB4  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModVolDist$$1Fv@ha
/* 801B5D78 001B2CB8  38 83 A5 4C */	addi r4, r3, __dt__26JSUList$$015JALSeModVolDist$$1Fv@l
/* 801B5D7C 001B2CBC  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
...
/* 801B5D8C 001B2CCC  98 0D 8F 94 */	stb r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
lbl_801B5D90:
/* 801B5D90 001B2CD0  88 0D 8F 95 */	lbz r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
/* 801B5D94 001B2CD4  7C 00 07 75 */	extsb. r0, r0
/* 801B5D98 001B2CD8  40 82 00 28 */	bne lbl_801B5DC0
/* 801B5D9C 001B2CDC  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
/* 801B5DA0 001B2CE0  4B E5 8E 95 */	bl initiate__10JSUPtrListFv
/* 801B5DA4 001B2CE4  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModEffFunk$$1Fv@ha
/* 801B5DA8 001B2CE8  38 83 A4 F4 */	addi r4, r3, __dt__26JSUList$$015JALSeModEffFunk$$1Fv@l
/* 801B5DAC 001B2CEC  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
...
/* 801B5DBC 001B2CFC  98 0D 8F 95 */	stb r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
lbl_801B5DC0:
/* 801B5DC0 001B2D00  88 0D 8F 96 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
/* 801B5DC4 001B2D04  7C 00 07 75 */	extsb. r0, r0
/* 801B5DC8 001B2D08  40 82 00 28 */	bne lbl_801B5DF0
/* 801B5DCC 001B2D0C  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
/* 801B5DD0 001B2D10  4B E5 8E 65 */	bl initiate__10JSUPtrListFv
/* 801B5DD4 001B2D14  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModPitFunk$$1Fv@ha
/* 801B5DD8 001B2D18  38 83 A4 9C */	addi r4, r3, __dt__26JSUList$$015JALSeModPitFunk$$1Fv@l
/* 801B5DDC 001B2D1C  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
...
/* 801B5DEC 001B2D2C  98 0D 8F 96 */	stb r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
lbl_801B5DF0:
/* 801B5DF0 001B2D30  88 0D 8F 97 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
/* 801B5DF4 001B2D34  7C 00 07 75 */	extsb. r0, r0
/* 801B5DF8 001B2D38  40 82 00 28 */	bne lbl_801B5E20
/* 801B5DFC 001B2D3C  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
/* 801B5E00 001B2D40  4B E5 8E 35 */	bl initiate__10JSUPtrListFv
/* 801B5E04 001B2D44  3C 60 80 05 */	lis r3, __dt__26JSUList$$015JALSeModVolFunk$$1Fv@ha
/* 801B5E08 001B2D48  38 83 A4 44 */	addi r4, r3, __dt__26JSUList$$015JALSeModVolFunk$$1Fv@l
/* 801B5E0C 001B2D4C  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
...
/* 801B5E1C 001B2D5C  98 0D 8F 97 */	stb r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
lbl_801B5E20:
...
param_table:
	.incbin "baserom.dol", 0x38C2F0, 0x210
$$22539:
