...
/* 801CFBC8 001CCB08  C0 02 CB 4C */	lfs f0, "@2713"@sda21(r2)
...
lbl_801CFC14:
/* 801CFC14 001CCB54  C0 22 CB 50 */	lfs f1, "@2733"@sda21(r2)
...
/* 801CFC44 001CCB84  C0 22 CB 54 */	lfs f1, "@2734"@sda21(r2)
...
/* 801CFCAC 001CCBEC  C0 02 CB 48 */	lfs f0, "@2679"@sda21(r2)
...
/* 801CFCFC 001CCC3C  C0 02 CB 58 */	lfs f0, "@2742"@sda21(r2)
/* 801CFD00 001CCC40  D0 1F 01 44 */	stfs f0, 0x144(r31)
/* 801CFD04 001CCC44  C0 02 CB 50 */	lfs f0, "@2733"@sda21(r2)
...
/* 801CFEEC 001CCE2C  C0 82 CB 5C */	lfs f4, "@2770"@sda21(r2)
...
/* 801CFFF4 001CCF34  3C 60 80 3F */	lis r3, "@2782"@ha
...
/* 801D0004 001CCF44  3B E3 71 C0 */	addi r31, r3, "@2782"@l
/* 801D0008 001CCF48  88 0D 97 CC */	lbz r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
/* 801D000C 001CCF4C  7C 00 07 75 */	extsb. r0, r0
/* 801D0010 001CCF50  40 82 00 28 */	bne lbl_801D0038
/* 801D0014 001CCF54  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
/* 801D0018 001CCF58  4B E3 EC 1D */	bl initiate__10JSUPtrListFv
/* 801D001C 001CCF5C  3C 60 80 0E */	lis r3, "__dt__15JSUList<5MSBgm>Fv"@ha
/* 801D0020 001CCF60  38 83 6A 44 */	addi r4, r3, "__dt__15JSUList<5MSBgm>Fv"@l
/* 801D0024 001CCF64  38 6D 97 A8 */	addi r3, r13, "smList__15JALList<5MSBgm>"@sda21
...
/* 801D0034 001CCF74  98 0D 97 CC */	stb r0, "__init__smList__15JALList<5MSBgm>"@sda21(r13)
lbl_801D0038:
/* 801D0038 001CCF78  88 0D 97 CD */	lbz r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
/* 801D003C 001CCF7C  7C 00 07 75 */	extsb. r0, r0
/* 801D0040 001CCF80  40 82 00 28 */	bne lbl_801D0068
/* 801D0044 001CCF84  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
/* 801D0048 001CCF88  4B E3 EB ED */	bl initiate__10JSUPtrListFv
/* 801D004C 001CCF8C  3C 60 80 0E */	lis r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@ha
/* 801D0050 001CCF90  38 83 69 EC */	addi r4, r3, "__dt__24JSUList<13MSSetSoundGrp>Fv"@l
/* 801D0054 001CCF94  38 6D 97 B4 */	addi r3, r13, "smList__24JALList<13MSSetSoundGrp>"@sda21
...
/* 801D0064 001CCFA4  98 0D 97 CD */	stb r0, "__init__smList__24JALList<13MSSetSoundGrp>"@sda21(r13)
lbl_801D0068:
/* 801D0068 001CCFA8  88 0D 97 CE */	lbz r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
/* 801D006C 001CCFAC  7C 00 07 75 */	extsb. r0, r0
/* 801D0070 001CCFB0  40 82 00 28 */	bne lbl_801D0098
/* 801D0074 001CCFB4  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
/* 801D0078 001CCFB8  4B E3 EB BD */	bl initiate__10JSUPtrListFv
/* 801D007C 001CCFBC  3C 60 80 0E */	lis r3, "__dt__21JSUList<10MSSetSound>Fv"@ha
/* 801D0080 001CCFC0  38 83 69 94 */	addi r4, r3, "__dt__21JSUList<10MSSetSound>Fv"@l
/* 801D0084 001CCFC4  38 6D 97 C0 */	addi r3, r13, "smList__21JALList<10MSSetSound>"@sda21
...
/* 801D0094 001CCFD4  98 0D 97 CE */	stb r0, "__init__smList__21JALList<10MSSetSound>"@sda21(r13)
lbl_801D0098:
/* 801D0098 001CCFD8  88 0D 8F 8C */	lbz r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
/* 801D009C 001CCFDC  7C 00 07 75 */	extsb. r0, r0
/* 801D00A0 001CCFE0  40 82 00 28 */	bne lbl_801D00C8
/* 801D00A4 001CCFE4  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
/* 801D00A8 001CCFE8  4B E3 EB 8D */	bl initiate__10JSUPtrListFv
/* 801D00AC 001CCFEC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@ha
/* 801D00B0 001CCFF0  38 83 A8 0C */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDGrp>Fv"@l
/* 801D00B4 001CCFF4  38 6D 8E FC */	addi r3, r13, "smList__26JALList<15JALSeModEffDGrp>"@sda21
...
/* 801D00C4 001CD004  98 0D 8F 8C */	stb r0, "__init__smList__26JALList<15JALSeModEffDGrp>"@sda21(r13)
lbl_801D00C8:
/* 801D00C8 001CD008  88 0D 8F 8D */	lbz r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
/* 801D00CC 001CD00C  7C 00 07 75 */	extsb. r0, r0
/* 801D00D0 001CD010  40 82 00 28 */	bne lbl_801D00F8
/* 801D00D4 001CD014  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
/* 801D00D8 001CD018  4B E3 EB 5D */	bl initiate__10JSUPtrListFv
/* 801D00DC 001CD01C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@ha
/* 801D00E0 001CD020  38 83 A7 B4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDGrp>Fv"@l
/* 801D00E4 001CD024  38 6D 8F 08 */	addi r3, r13, "smList__26JALList<15JALSeModPitDGrp>"@sda21
...
/* 801D00F4 001CD034  98 0D 8F 8D */	stb r0, "__init__smList__26JALList<15JALSeModPitDGrp>"@sda21(r13)
lbl_801D00F8:
/* 801D00F8 001CD038  88 0D 8F 8E */	lbz r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
/* 801D00FC 001CD03C  7C 00 07 75 */	extsb. r0, r0
/* 801D0100 001CD040  40 82 00 28 */	bne lbl_801D0128
/* 801D0104 001CD044  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
/* 801D0108 001CD048  4B E3 EB 2D */	bl initiate__10JSUPtrListFv
/* 801D010C 001CD04C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@ha
/* 801D0110 001CD050  38 83 A7 5C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDGrp>Fv"@l
/* 801D0114 001CD054  38 6D 8F 14 */	addi r3, r13, "smList__26JALList<15JALSeModVolDGrp>"@sda21
...
/* 801D0124 001CD064  98 0D 8F 8E */	stb r0, "__init__smList__26JALList<15JALSeModVolDGrp>"@sda21(r13)
lbl_801D0128:
/* 801D0128 001CD068  88 0D 8F 8F */	lbz r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
/* 801D012C 001CD06C  7C 00 07 75 */	extsb. r0, r0
/* 801D0130 001CD070  40 82 00 28 */	bne lbl_801D0158
/* 801D0134 001CD074  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
/* 801D0138 001CD078  4B E3 EA FD */	bl initiate__10JSUPtrListFv
/* 801D013C 001CD07C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@ha
/* 801D0140 001CD080  38 83 A7 04 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFGrp>Fv"@l
/* 801D0144 001CD084  38 6D 8F 20 */	addi r3, r13, "smList__26JALList<15JALSeModEffFGrp>"@sda21
...
/* 801D0154 001CD094  98 0D 8F 8F */	stb r0, "__init__smList__26JALList<15JALSeModEffFGrp>"@sda21(r13)
lbl_801D0158:
/* 801D0158 001CD098  88 0D 8F 90 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
/* 801D015C 001CD09C  7C 00 07 75 */	extsb. r0, r0
/* 801D0160 001CD0A0  40 82 00 28 */	bne lbl_801D0188
/* 801D0164 001CD0A4  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
/* 801D0168 001CD0A8  4B E3 EA CD */	bl initiate__10JSUPtrListFv
/* 801D016C 001CD0AC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@ha
/* 801D0170 001CD0B0  38 83 A6 AC */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFGrp>Fv"@l
/* 801D0174 001CD0B4  38 6D 8F 2C */	addi r3, r13, "smList__26JALList<15JALSeModPitFGrp>"@sda21
...
/* 801D0184 001CD0C4  98 0D 8F 90 */	stb r0, "__init__smList__26JALList<15JALSeModPitFGrp>"@sda21(r13)
lbl_801D0188:
/* 801D0188 001CD0C8  88 0D 8F 91 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
/* 801D018C 001CD0CC  7C 00 07 75 */	extsb. r0, r0
/* 801D0190 001CD0D0  40 82 00 28 */	bne lbl_801D01B8
/* 801D0194 001CD0D4  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
/* 801D0198 001CD0D8  4B E3 EA 9D */	bl initiate__10JSUPtrListFv
/* 801D019C 001CD0DC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@ha
/* 801D01A0 001CD0E0  38 83 A6 54 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFGrp>Fv"@l
/* 801D01A4 001CD0E4  38 6D 8F 38 */	addi r3, r13, "smList__26JALList<15JALSeModVolFGrp>"@sda21
...
/* 801D01B4 001CD0F4  98 0D 8F 91 */	stb r0, "__init__smList__26JALList<15JALSeModVolFGrp>"@sda21(r13)
lbl_801D01B8:
/* 801D01B8 001CD0F8  88 0D 8F 92 */	lbz r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
/* 801D01BC 001CD0FC  7C 00 07 75 */	extsb. r0, r0
/* 801D01C0 001CD100  40 82 00 28 */	bne lbl_801D01E8
/* 801D01C4 001CD104  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
/* 801D01C8 001CD108  4B E3 EA 6D */	bl initiate__10JSUPtrListFv
/* 801D01CC 001CD10C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@ha
/* 801D01D0 001CD110  38 83 A5 FC */	addi r4, r3, "__dt__26JSUList<15JALSeModEffDist>Fv"@l
/* 801D01D4 001CD114  38 6D 8F 44 */	addi r3, r13, "smList__26JALList<15JALSeModEffDist>"@sda21
...
/* 801D01E4 001CD124  98 0D 8F 92 */	stb r0, "__init__smList__26JALList<15JALSeModEffDist>"@sda21(r13)
lbl_801D01E8:
/* 801D01E8 001CD128  88 0D 8F 93 */	lbz r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
/* 801D01EC 001CD12C  7C 00 07 75 */	extsb. r0, r0
/* 801D01F0 001CD130  40 82 00 28 */	bne lbl_801D0218
/* 801D01F4 001CD134  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
/* 801D01F8 001CD138  4B E3 EA 3D */	bl initiate__10JSUPtrListFv
/* 801D01FC 001CD13C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@ha
/* 801D0200 001CD140  38 83 A5 A4 */	addi r4, r3, "__dt__26JSUList<15JALSeModPitDist>Fv"@l
/* 801D0204 001CD144  38 6D 8F 50 */	addi r3, r13, "smList__26JALList<15JALSeModPitDist>"@sda21
...
/* 801D0214 001CD154  98 0D 8F 93 */	stb r0, "__init__smList__26JALList<15JALSeModPitDist>"@sda21(r13)
lbl_801D0218:
/* 801D0218 001CD158  88 0D 8F 94 */	lbz r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
/* 801D021C 001CD15C  7C 00 07 75 */	extsb. r0, r0
/* 801D0220 001CD160  40 82 00 28 */	bne lbl_801D0248
/* 801D0224 001CD164  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
/* 801D0228 001CD168  4B E3 EA 0D */	bl initiate__10JSUPtrListFv
/* 801D022C 001CD16C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@ha
/* 801D0230 001CD170  38 83 A5 4C */	addi r4, r3, "__dt__26JSUList<15JALSeModVolDist>Fv"@l
/* 801D0234 001CD174  38 6D 8F 5C */	addi r3, r13, "smList__26JALList<15JALSeModVolDist>"@sda21
...
/* 801D0244 001CD184  98 0D 8F 94 */	stb r0, "__init__smList__26JALList<15JALSeModVolDist>"@sda21(r13)
lbl_801D0248:
/* 801D0248 001CD188  88 0D 8F 95 */	lbz r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
/* 801D024C 001CD18C  7C 00 07 75 */	extsb. r0, r0
/* 801D0250 001CD190  40 82 00 28 */	bne lbl_801D0278
/* 801D0254 001CD194  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
/* 801D0258 001CD198  4B E3 E9 DD */	bl initiate__10JSUPtrListFv
/* 801D025C 001CD19C  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@ha
/* 801D0260 001CD1A0  38 83 A4 F4 */	addi r4, r3, "__dt__26JSUList<15JALSeModEffFunk>Fv"@l
/* 801D0264 001CD1A4  38 6D 8F 68 */	addi r3, r13, "smList__26JALList<15JALSeModEffFunk>"@sda21
...
/* 801D0274 001CD1B4  98 0D 8F 95 */	stb r0, "__init__smList__26JALList<15JALSeModEffFunk>"@sda21(r13)
lbl_801D0278:
/* 801D0278 001CD1B8  88 0D 8F 96 */	lbz r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
/* 801D027C 001CD1BC  7C 00 07 75 */	extsb. r0, r0
/* 801D0280 001CD1C0  40 82 00 28 */	bne lbl_801D02A8
/* 801D0284 001CD1C4  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
/* 801D0288 001CD1C8  4B E3 E9 AD */	bl initiate__10JSUPtrListFv
/* 801D028C 001CD1CC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@ha
/* 801D0290 001CD1D0  38 83 A4 9C */	addi r4, r3, "__dt__26JSUList<15JALSeModPitFunk>Fv"@l
/* 801D0294 001CD1D4  38 6D 8F 74 */	addi r3, r13, "smList__26JALList<15JALSeModPitFunk>"@sda21
...
/* 801D02A4 001CD1E4  98 0D 8F 96 */	stb r0, "__init__smList__26JALList<15JALSeModPitFunk>"@sda21(r13)
lbl_801D02A8:
/* 801D02A8 001CD1E8  88 0D 8F 97 */	lbz r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
/* 801D02AC 001CD1EC  7C 00 07 75 */	extsb. r0, r0
/* 801D02B0 001CD1F0  40 82 00 28 */	bne lbl_801D02D8
/* 801D02B4 001CD1F4  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
/* 801D02B8 001CD1F8  4B E3 E9 7D */	bl initiate__10JSUPtrListFv
/* 801D02BC 001CD1FC  3C 60 80 05 */	lis r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@ha
/* 801D02C0 001CD200  38 83 A4 44 */	addi r4, r3, "__dt__26JSUList<15JALSeModVolFunk>Fv"@l
/* 801D02C4 001CD204  38 6D 8F 80 */	addi r3, r13, "smList__26JALList<15JALSeModVolFunk>"@sda21
...
/* 801D02D4 001CD214  98 0D 8F 97 */	stb r0, "__init__smList__26JALList<15JALSeModVolFunk>"@sda21(r13)
lbl_801D02D8:
