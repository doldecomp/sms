...
/* 801CEAA4 001CB9E4  88 0D 97 CC */	lbz r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
/* 801CEAA8 001CB9E8  90 6D 9A 98 */	stw r3, mColorUpper__17TMapObjTumblePole-_SDA_BASE_(r13)
/* 801CEAAC 001CB9EC  7C 00 07 75 */	extsb. r0, r0
/* 801CEAB0 001CB9F0  90 6D 9A 9C */	stw r3, mColorLower__17TMapObjTumblePole-_SDA_BASE_(r13)
/* 801CEAB4 001CB9F4  40 82 00 28 */	bne lbl_801CEADC
/* 801CEAB8 001CB9F8  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
...
/* 801CEAC8 001CBA08  38 6D 97 A8 */	addi r3, r13, smList__15JALList$$05MSBgm$$1-_SDA_BASE_
...
/* 801CEAD8 001CBA18  98 0D 97 CC */	stb r0, __init__smList__15JALList$$05MSBgm$$1-_SDA_BASE_(r13)
lbl_801CEADC:
/* 801CEADC 001CBA1C  88 0D 97 CD */	lbz r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
/* 801CEAE0 001CBA20  7C 00 07 75 */	extsb. r0, r0
/* 801CEAE4 001CBA24  40 82 00 28 */	bne lbl_801CEB0C
/* 801CEAE8 001CBA28  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
...
/* 801CEAF8 001CBA38  38 6D 97 B4 */	addi r3, r13, smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_
...
/* 801CEB08 001CBA48  98 0D 97 CD */	stb r0, __init__smList__24JALList$$013MSSetSoundGrp$$1-_SDA_BASE_(r13)
lbl_801CEB0C:
/* 801CEB0C 001CBA4C  88 0D 97 CE */	lbz r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
/* 801CEB10 001CBA50  7C 00 07 75 */	extsb. r0, r0
/* 801CEB14 001CBA54  40 82 00 28 */	bne lbl_801CEB3C
/* 801CEB18 001CBA58  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
...
/* 801CEB28 001CBA68  38 6D 97 C0 */	addi r3, r13, smList__21JALList$$010MSSetSound$$1-_SDA_BASE_
...
/* 801CEB38 001CBA78  98 0D 97 CE */	stb r0, __init__smList__21JALList$$010MSSetSound$$1-_SDA_BASE_(r13)
lbl_801CEB3C:
/* 801CEB3C 001CBA7C  88 0D 8F 8C */	lbz r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
/* 801CEB40 001CBA80  7C 00 07 75 */	extsb. r0, r0
/* 801CEB44 001CBA84  40 82 00 28 */	bne lbl_801CEB6C
/* 801CEB48 001CBA88  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
...
/* 801CEB58 001CBA98  38 6D 8E FC */	addi r3, r13, smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_
...
/* 801CEB68 001CBAA8  98 0D 8F 8C */	stb r0, __init__smList__26JALList$$015JALSeModEffDGrp$$1-_SDA_BASE_(r13)
lbl_801CEB6C:
/* 801CEB6C 001CBAAC  88 0D 8F 8D */	lbz r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
/* 801CEB70 001CBAB0  7C 00 07 75 */	extsb. r0, r0
/* 801CEB74 001CBAB4  40 82 00 28 */	bne lbl_801CEB9C
/* 801CEB78 001CBAB8  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
...
/* 801CEB88 001CBAC8  38 6D 8F 08 */	addi r3, r13, smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_
...
/* 801CEB98 001CBAD8  98 0D 8F 8D */	stb r0, __init__smList__26JALList$$015JALSeModPitDGrp$$1-_SDA_BASE_(r13)
lbl_801CEB9C:
/* 801CEB9C 001CBADC  88 0D 8F 8E */	lbz r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
/* 801CEBA0 001CBAE0  7C 00 07 75 */	extsb. r0, r0
/* 801CEBA4 001CBAE4  40 82 00 28 */	bne lbl_801CEBCC
/* 801CEBA8 001CBAE8  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
...
/* 801CEBB8 001CBAF8  38 6D 8F 14 */	addi r3, r13, smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_
...
/* 801CEBC8 001CBB08  98 0D 8F 8E */	stb r0, __init__smList__26JALList$$015JALSeModVolDGrp$$1-_SDA_BASE_(r13)
lbl_801CEBCC:
/* 801CEBCC 001CBB0C  88 0D 8F 8F */	lbz r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
/* 801CEBD0 001CBB10  7C 00 07 75 */	extsb. r0, r0
/* 801CEBD4 001CBB14  40 82 00 28 */	bne lbl_801CEBFC
/* 801CEBD8 001CBB18  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
...
/* 801CEBE8 001CBB28  38 6D 8F 20 */	addi r3, r13, smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_
...
/* 801CEBF8 001CBB38  98 0D 8F 8F */	stb r0, __init__smList__26JALList$$015JALSeModEffFGrp$$1-_SDA_BASE_(r13)
lbl_801CEBFC:
/* 801CEBFC 001CBB3C  88 0D 8F 90 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
/* 801CEC00 001CBB40  7C 00 07 75 */	extsb. r0, r0
/* 801CEC04 001CBB44  40 82 00 28 */	bne lbl_801CEC2C
/* 801CEC08 001CBB48  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
...
/* 801CEC18 001CBB58  38 6D 8F 2C */	addi r3, r13, smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_
...
/* 801CEC28 001CBB68  98 0D 8F 90 */	stb r0, __init__smList__26JALList$$015JALSeModPitFGrp$$1-_SDA_BASE_(r13)
lbl_801CEC2C:
/* 801CEC2C 001CBB6C  88 0D 8F 91 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
/* 801CEC30 001CBB70  7C 00 07 75 */	extsb. r0, r0
/* 801CEC34 001CBB74  40 82 00 28 */	bne lbl_801CEC5C
/* 801CEC38 001CBB78  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
...
/* 801CEC48 001CBB88  38 6D 8F 38 */	addi r3, r13, smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_
...
/* 801CEC58 001CBB98  98 0D 8F 91 */	stb r0, __init__smList__26JALList$$015JALSeModVolFGrp$$1-_SDA_BASE_(r13)
lbl_801CEC5C:
/* 801CEC5C 001CBB9C  88 0D 8F 92 */	lbz r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
/* 801CEC60 001CBBA0  7C 00 07 75 */	extsb. r0, r0
/* 801CEC64 001CBBA4  40 82 00 28 */	bne lbl_801CEC8C
/* 801CEC68 001CBBA8  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
...
/* 801CEC78 001CBBB8  38 6D 8F 44 */	addi r3, r13, smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_
...
/* 801CEC88 001CBBC8  98 0D 8F 92 */	stb r0, __init__smList__26JALList$$015JALSeModEffDist$$1-_SDA_BASE_(r13)
lbl_801CEC8C:
/* 801CEC8C 001CBBCC  88 0D 8F 93 */	lbz r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
/* 801CEC90 001CBBD0  7C 00 07 75 */	extsb. r0, r0
/* 801CEC94 001CBBD4  40 82 00 28 */	bne lbl_801CECBC
/* 801CEC98 001CBBD8  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
...
/* 801CECA8 001CBBE8  38 6D 8F 50 */	addi r3, r13, smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_
...
/* 801CECB8 001CBBF8  98 0D 8F 93 */	stb r0, __init__smList__26JALList$$015JALSeModPitDist$$1-_SDA_BASE_(r13)
lbl_801CECBC:
/* 801CECBC 001CBBFC  88 0D 8F 94 */	lbz r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
/* 801CECC0 001CBC00  7C 00 07 75 */	extsb. r0, r0
/* 801CECC4 001CBC04  40 82 00 28 */	bne lbl_801CECEC
/* 801CECC8 001CBC08  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
...
/* 801CECD8 001CBC18  38 6D 8F 5C */	addi r3, r13, smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_
...
/* 801CECE8 001CBC28  98 0D 8F 94 */	stb r0, __init__smList__26JALList$$015JALSeModVolDist$$1-_SDA_BASE_(r13)
lbl_801CECEC:
/* 801CECEC 001CBC2C  88 0D 8F 95 */	lbz r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
/* 801CECF0 001CBC30  7C 00 07 75 */	extsb. r0, r0
/* 801CECF4 001CBC34  40 82 00 28 */	bne lbl_801CED1C
/* 801CECF8 001CBC38  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
...
/* 801CED08 001CBC48  38 6D 8F 68 */	addi r3, r13, smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_
...
/* 801CED18 001CBC58  98 0D 8F 95 */	stb r0, __init__smList__26JALList$$015JALSeModEffFunk$$1-_SDA_BASE_(r13)
lbl_801CED1C:
/* 801CED1C 001CBC5C  88 0D 8F 96 */	lbz r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
/* 801CED20 001CBC60  7C 00 07 75 */	extsb. r0, r0
/* 801CED24 001CBC64  40 82 00 28 */	bne lbl_801CED4C
/* 801CED28 001CBC68  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
...
/* 801CED38 001CBC78  38 6D 8F 74 */	addi r3, r13, smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_
...
/* 801CED48 001CBC88  98 0D 8F 96 */	stb r0, __init__smList__26JALList$$015JALSeModPitFunk$$1-_SDA_BASE_(r13)
lbl_801CED4C:
/* 801CED4C 001CBC8C  88 0D 8F 97 */	lbz r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
/* 801CED50 001CBC90  7C 00 07 75 */	extsb. r0, r0
/* 801CED54 001CBC94  40 82 00 28 */	bne lbl_801CED7C
/* 801CED58 001CBC98  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
...
/* 801CED68 001CBCA8  38 6D 8F 80 */	addi r3, r13, smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_
...
/* 801CED78 001CBCB8  98 0D 8F 97 */	stb r0, __init__smList__26JALList$$015JALSeModVolFunk$$1-_SDA_BASE_(r13)
lbl_801CED7C:
